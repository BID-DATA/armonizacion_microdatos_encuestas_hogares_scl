...
egen double ymensual2 = rowtotal(ganancia_secun_imp_monto ingreso_asalariado_secun ingreso_independientes_secun), mi
...
*Si la información está en dólares se multiplica por tc_usd, Euros, luego de ser convertidos en dolares, por tc_eur_usd (promedio para los meses del cuarto trimestre de 2023)
...
replace pension_int = (pension_ext_monto*tc_chf) if  pension_ext_moneda == "CHF"
...
replace alquiler_int = (alquiler_ext_monto*tc_usd) if alquiler_ext_moneda == "USD"
...
*** ynlnm_ch ***
****************
by idh_ch, sort: egen ynlnm_ch = total(ynlnm_ci) if miembros_ci==1, missing
...
gen ptmc_ingneto1 = 0
replace ptmc_ingneto1 = 1 if pçasht_ch == 1 & gpo_ingneto1 == 1

gen ptmc_ingneto2 = 0
replace ptmc_ingneto2 = 1 if pçasht_ch == 1 & gpo_ingneto2 == 1

gen ptmc_ingneto3 = 0
replace ptmc_ingneto3 = 1 if pçasht_ch == 1 & gpo_ingneto3 == 1

gen ptmc_ingneto4 = 0
replace ptmc_ingneto4 = 1 if pçasht_ch == 1 & gpo_ingneto4 == 1
