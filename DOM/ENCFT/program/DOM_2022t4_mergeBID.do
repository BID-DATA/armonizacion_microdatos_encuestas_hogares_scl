...
import excel "`base_in'Base ENCFT 20221 - 20224", sheet("`mod'") firstrow case(lower) clear
rename *, lower
keep if trimestre == 20224
...
*DZ Dic 2020: Se filtra y se deja unicamente información para cuarto trimestre*


saveold "`base_out'",  replace


/* Update 2018, no se usan labels porque cambiÃ³ la base, ahora el gobierno solo publicarÃ¡ la ocntinua (ENCFT) y no mÃ¡s la ENFT
...
label var	eft_anio_pasado_alquiler	"recibio alquiler añ¯ °asado"
label var	eft_anio_pasado_gobierno	"recibio ayuda del gobierno añ¯ °asado"
label var	eft_anio_pasado_interes	"recibio interes añ¯ °asado"
label var	eft_anio_pasado_monto_alquiler	"monto alquiler añ¯ °asado"
label var	eft_anio_pasado_monto_gobierno	"monto ayuda gobierno añ¯ °asado"
label var	eft_anio_pasado_monto_interes	"monto interes añ¯ °asado"
label var	eft_anio_pasado_monto_ocasion	"monto ocasional añ¯ °asado"
label var	eft_anio_pasado_monto_otros	"monto otros ingresos añ¯ °asado"
label var	eft_anio_pasado_monto_pension	"monto pension añ¯ °asado"
label var	eft_anio_pasado_monto_remesas	"monto de remesas añ¯ °asado"
*label var	eft_anio_pasado_ocacional	"recibio ingreso ocasional añ¯ °asado"
label var	eft_anio_pasado_otros	"recibio otros ingresos añ¯ °asado"
label var	eft_anio_pasado_otros_esp	"otros ingresos añ¯ °asado especificar"
label var	eft_anio_pasado_pension	"recibio ing. pension añ¯ °asado"
label var	eft_anio_pasado_remesas	"recibio remesas añ¯ °asado"
label var	eft_ano	"añ¯¢
label var	eft_anos_encontrar_empleo	"añ¯ ¥n encontrar empleo"
...
label var	eft_tiempo_lab_anos	"tiempo laborando en añ¯³¢
...
label var	eft_ult_ano_aprobado	"ultimo añ¯ ¡probado"
