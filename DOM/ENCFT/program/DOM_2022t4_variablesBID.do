...
gen double pension_int = pension_ext_monto if  pension_ext == 1
...
******************
	...
	* PTMC - Programas de transferencias monetarias condicionadas:
			* 2 Programa Solidaridad: Incentivo a la Asistencia Escolar
			* 3 Incentivo a la Educación Superior, con la Tarjeta Solidaridad
			* 4 Bono Escolar Estudiante en Progreso		
			* 5 Programa Solidaridad: Superate
