...
*Si la información está en dólares se multiplica por 36.04
*Si la información está en euros se multiplica por 50.05

*Modulo Ingresos del Exterior
gen pension_int=monto_ing_pension_mes	 		    if  moneda_ing_pension_mes==1
replace pension_int=monto_ing_pension_mes*36.04   	if  moneda_ing_pension_mes==2
replace pension_int=(monto_ing_pension_mes*0.72)*36.04     if  moneda_ing_pension_mes==14
replace pension_int=. if recibio_ing_pension_mes==2

gen interes_int=monto_ing_interes_mes	 		    if  moneda_ing_interes_mes==1
replace interes_int=monto_ing_interes_mes*36.04	    if  moneda_ing_interes_mes==2
replace interes_int=(monto_ing_interes_mes*0.72)*36.04  	if  moneda_ing_interes_mes==14
...
replace otros_int=(monto_otros_ing_sem*36.04)/6	if moneda_otros_ing_sem==2
replace otros_int=((monto_otros_ing_sem*0.72)*36.04)/6	if moneda_otros_ing_sem==14
...
replace r_jul=monto_jul*36.04 	if moneda_jul==2
replace r_jul=(monto_jul*0.72)*36.04  	if moneda_jul==14

gen r_ago=monto_ago		    	if moneda_ago==0
replace r_ago=monto_ago		    if moneda_ago==1
replace r_ago=monto_ago*36.04 	if moneda_ago==2
replace r_ago=(monto_ago*0.72)*36.04 if moneda_ago==14

gen r_sep=monto_sep 	    	if moneda_sep==0
replace r_sep=monto_sep 		if moneda_sep==1
replace r_sep=monto_sep*36.04 	if moneda_sep==2
replace r_sep=(monto_sep*0.72)*36.04  	if moneda_sep==14
...
replace vivi1_ch=3 if tipo_vivienda==6 | tipo_vivienda==7 | tipo_vivienda==8 | tipo_vivienda==99
