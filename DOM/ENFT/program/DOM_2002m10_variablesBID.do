...
*local base_in  = "$ruta\survey\\`PAIS'\\`ENCUESTA'\\`ANO'\\`ronda'\data_merge\\DOM2002EA_BID.dta"
...
replace tipocontrato_ci=1 if firmo_contrato==1 & categopri_ci==3
replace tipocontrato_ci=2 if (firmo_contrato==2 | firmo_contrato==3) & categopri_ci==3
replace tipocontrato_ci=3 if firmo_contrato==0 & categopri_ci==3
label var tipocontrato_ci "Tipo de contrato segun su duracion"
label define tipocontrato_ci 1 "Permanente/indefinido" 2 "Temporal" 3 "Sin contrato/verbal" 
label value tipocontrato_ci tipocontrato_ci
*/
/*
*Mayra Sáenz - Febrero 2014. La variable correcta es tipo_contrato
* 1 Indefinido
* 2 Por un tiempo definido
* 3 Por un trabajo específico
* 4 No sabe 
gen tipocontrato_ci=. /* Hay muchos missings en tipo de contrato, solo se puede saber si tiene contrato o no */
...
* Tipo de cambio dólar 2002 (Promedio mensual de Octubre) = 17.76
...
replace pension_int=monto_ing_pension_mes*17.76   	if  moneda_ing_pension_mes==2
replace pension_int=. if recibio_ing_pension_mes==2


gen interes_int=monto_ing_interes_mes	 		    if  moneda_ing_interes_mes==1
replace interes_int=monto_ing_interes_mes*17.76    if  moneda_ing_interes_mes==2
...
replace otros_int=(monto_otros_ing_sem*17.76)/6	if moneda_otros_ing_sem==2
...
*Esta pregunta sólo aplica para los mayores de 3 años.

g asiste_ci=.
replace asiste_ci=1 if tanda_asiste!=8 & tanda_asiste!=0
replace asiste_ci=0 if tanda_asiste==8 | se_matriculo==7
