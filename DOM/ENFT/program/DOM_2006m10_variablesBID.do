...
*Si la información está en dólares se multiplica por 33.15
*Si la información está en euros se multiplica por 40.93

*Modulo Ingresos del Exterior
gen pension_int=monto_ing_pension_mes	 		    if  moneda_ing_pension_mes==1
replace pension_int=monto_ing_pension_mes*33.15   	if  moneda_ing_pension_mes==2
replace pension_int=(monto_ing_pension_mes*0.81)*33.15    if  moneda_ing_pension_mes==14
replace pension_int=. if recibio_ing_pension_mes==2

gen interes_int=monto_ing_interes_mes	 		    if  moneda_ing_interes_mes==1
replace interes_int=monto_ing_interes_mes*33.15	    if  moneda_ing_interes_mes==2
replace interes_int=(monto_ing_interes_mes*0.81)*33.15 	if  moneda_ing_interes_mes==14
...
replace otros_int=(monto_otros_ing_sem*33.15)/6	if moneda_otros_ing_sem==2
replace otros_int=((monto_otros_ing_sem*0.81)*33.15)/6	if moneda_otros_ing_sem==14
...
replace r_jul=monto_jul*33.15 	if moneda_jul==2
replace r_jul=(monto_jul*0.81)*33.15 	if moneda_jul==14

gen r_ago=monto_ago		    	if moneda_ago==0
replace r_ago=monto_ago		    if moneda_ago==1
replace r_ago=monto_ago*33.15 	if moneda_ago==2
replace r_ago=(monto_ago*0.81)*33.15 	if moneda_ago==14

gen r_sep=monto_sep 	    	if moneda_sep==0
replace r_sep=monto_sep 		if moneda_sep==1
replace r_sep=monto_sep*33.15 	if moneda_sep==2
replace r_sep=(monto_sep*0.81)*33.15 	if moneda_sep==14
...
gen byte eduui_ci = (se_matriculo == 5 | ult_nivel_alcanzado == 5 & motivo_no_asiste != 8)
replace eduui_ci = 0 if (se_matriculo == 6 | ult_nivel_alcanzado == 5 & motivo_no_asiste == 8)
...
gen byte eduuc_ci = (ult_nivel_alcanzado == 5 & motivo_no_asiste == 8 | inlist(se_matriculo, 6))
