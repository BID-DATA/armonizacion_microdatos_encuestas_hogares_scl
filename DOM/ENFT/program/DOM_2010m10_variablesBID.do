...
Versión 2012: Yessenia Loaysa
 María Laura Oliveri (MLO) - Email: mloliveri@iadb.org, lauraoliveri@yahoo.com
26 de Marzo de 2013
...
replace pension_int=monto_ing_pension_mes*36.94   	   if  moneda_ing_pension_mes==2
replace pension_int=(monto_ing_pension_mes*1.03)*36.94 if  moneda_ing_pension_mes==5
replace pension_int=(monto_ing_pension_mes*0.66)*36.94 if  moneda_ing_pension_mes==6
replace pension_int=(monto_ing_pension_mes*0.78)*36.94 if  moneda_ing_pension_mes==14
replace pension_int=. if recibio_ing_pension_mes==2

gen interes_int=monto_ing_interes_mes	 		    if  moneda_ing_interes_mes==1
replace interes_int=monto_ing_interes_mes*36.94	    if  moneda_ing_interes_mes==2
replace interes_int=(monto_ing_interes_mes*1.03)*36.94     if  moneda_ing_interes_mes==5
replace interes_int=(monto_ing_interes_mes*0.66)*36.94	    if  moneda_ing_interes_mes==6
replace interes_int=(monto_ing_interes_mes*0.78)*36.94 	if  moneda_ing_interes_mes==14
...
replace otros_int=(monto_otros_ing_sem*36.94)/6	if moneda_otros_ing_sem==2
replace otros_int=((monto_otros_ing_sem*1.03)*36.94)/6	if moneda_otros_ing_sem==5
replace otros_int=((monto_otros_ing_sem*0.66)*36.94)/6	if moneda_otros_ing_sem==6
replace otros_int=((monto_otros_ing_sem*0.78)*36.94)/6	if moneda_otros_ing_sem==14
...
replace r_jul=monto_jul*36.94 	if moneda_jul==2
replace r_jul=(monto_jul*1.03)*36.94 	if moneda_jul==5
replace r_jul=(monto_jul*0.66)*36.94 	if moneda_jul==6
replace r_jul=(monto_jul*0.78)*36.94	if moneda_jul==14

gen r_ago=monto_ago		    	if moneda_ago==0
replace r_ago=monto_ago		    if moneda_ago==1
replace r_ago=monto_ago*36.94 	if moneda_ago==2
replace r_ago=(monto_ago*1.03)*36.94 	if moneda_ago==5
replace r_ago=(monto_ago*0.66)*36.94	if moneda_ago==6
replace r_ago=(monto_ago*0.78)*36.94 	if moneda_ago==14

gen r_sep=monto_sep 	    	if moneda_sep==0
replace r_sep=monto_sep 		if moneda_sep==1
replace r_sep=monto_sep*36.94 	if moneda_sep==2
replace r_sep=(monto_sep*1.03)*36.94 	if moneda_sep==5
replace r_sep=(monto_sep*0.66)*36.94	if moneda_sep==6
replace r_sep=(monto_sep*0.78)*36.94 	if moneda_sep==14
...
// de todas las ocupaciones no solo del ingreso principal(formulario) pero aquí se las considera dentro del trabajo principal.
