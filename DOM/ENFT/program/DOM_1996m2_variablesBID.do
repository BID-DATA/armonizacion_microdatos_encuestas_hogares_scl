...
label define categopri_ci 1"Patron" 2"Cuenta propia" 0"Otro", add modify
label define categopri_ci 3"Empleado" 4" No remunerado" , add modify
...
gen rama_ci=.
replace rama_ci = 1 if (ramac>=1100 & ramac<=1721) & emp_ci==1
replace rama_ci = 2 if (ramac>=2200 & ramac<=2909) & emp_ci==1
replace rama_ci = 3 if (ramac>=3110 & ramac<=3909) & emp_ci==1
...
*tamemp_ci***
*************
*tamaest 1 "De 1 a 4 personas" 2 "De 5 a 10 personas" 3 "De 11 a 19 personas" 4 "De 20 y más personas" ///
...
gen ymensual=ingmen 	 
gen pension= ingpojm
gen pensionext= ingpojme
gen intereses= ingcapm 	
gen familiares = ingfamme
gen remesas = ingfamme 
gen otrosing=ingotrm			
gen otrosingext=ingotrme

/*

*Para ingresos se toman las variables calculadas por el Banco Central de República Dominicana.
...
***ynlm_ci***
*************
destring pension pensionext intereses  familiares remesas otrosing otrosingext, replace
egen ynlm_ci=rsum(pension pensionext intereses  familiares remesas otrosing otrosingext), missing
