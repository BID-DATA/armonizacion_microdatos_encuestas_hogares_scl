...
María Laura Oliveri (MLO) - Email: mloliveri@iadb.org, lauraoliveri@yahoo.com, 6 de Marzo de 2013
...
*Si la información está en dólares se multiplica por 38.13
...
replace pension_int=(monto_ing_pension_mes*38.13)   	if  moneda_ing_pension_mes==2
replace pension_int=(monto_ing_pension_mes*0.71)*38.13     if  moneda_ing_pension_mes==14
...
replace interes_int=monto_ing_interes_mes*38.13	    if  moneda_ing_interes_mes==2
replace interes_int=(monto_ing_interes_mes*0.71)*38.13 	if  moneda_ing_interes_mes==14
...
replace otros_int=(monto_otros_ing_sem*38.13)/6	if moneda_otros_ing_sem==2
replace otros_int=((monto_otros_ing_sem*0.71)*38.13)/6	if moneda_otros_ing_sem==14
...
replace r_jul=monto_jul*38.13 	if moneda_jul==2
replace r_jul=(monto_jul*0.71)*38.13 	if moneda_jul==14

gen r_ago=monto_ago		    	if moneda_ago==0
replace r_ago=monto_ago		    if moneda_ago==1
replace r_ago=monto_ago*38.13 	if moneda_ago==2
replace r_ago=((monto_ago*0.71)*38.13) 	if moneda_ago==14

gen r_sep=monto_sep 	    	if moneda_sep==0
replace r_sep=monto_sep 		if moneda_sep==1
replace r_sep=monto_sep*38.13 	if moneda_sep==2
replace r_sep=(monto_sep*0.71)*38.13 	if moneda_sep==14
