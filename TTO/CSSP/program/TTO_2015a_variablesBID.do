...
replace desalent_ci = 1 if (p21==7 & inlist(p25, 6, 10) & condocup_ci == 3)
...
*****************************
* La variable p29 no se encuentra disponible en la base de datos.
gen ocupa_ci=.
...
replace bano_ch=6 if toilet==1|toilet==3|toilet==4|toilet==8 |toilet==9 
