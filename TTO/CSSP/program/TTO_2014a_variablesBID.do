...
Ultima actualización: Melany Gualavisi - melanyg@iadb.org
...
* Población WDI: 1354483
* Observaciones base: 31942
* % expansión: 42.404452
gen factor_ch=42.404452
label var factor_ch "Factor de Expansion del Hogar"
gen factor_ci= 42.404452
...
*********************************
/* La variable p3O está renombrada como rindus: recoded industry
...
* rama principal
g rama_ci = .
replace rama_ci = 1 if inlist(rindus, 1, 2) & condocup_ci == 1
replace rama_ci = 2 if rindus == 4 & condocup_ci == 1
replace rama_ci = 3 if rindus == 5 & condocup_ci == 1
replace rama_ci = 4 if inlist(rindus, 3, 6) & condocup_ci == 1
...
gen aguafuente_ch = .
replace aguafuente_ch = 1  if inlist(water, 1, 2, 3)
