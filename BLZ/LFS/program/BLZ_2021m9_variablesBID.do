...
****************************
	...
	***************
	...
	replace subemp_ci = 1 if total_hrs_last_week<=30  & total_hrs_last_week != . & ea29anew == 1 & ea29bnew == 1 & emp_ci == 1  //se utiliza la pregunta:  Available for additional work
	...
	****************
	...
	replace nempleos_ci = 1 if ea19==2 & emp_ci == 1 
	replace nempleos_ci = 2 if ea19==1 & emp_ci == 1 
	...
	***************	
	...
	replace tiempoparc_ci  = (total_hrs_last_week<30  & ea29bnew == 2) if total_hrs_last_week!= 999999 &   total_hrs_last_week!=. & emp_ci == 1 
	...
	**************
	gen byte ocupa_ci=.
	replace ocupa_ci=1 if  inlist(ea21main_occ, 2, 3) & emp_ci==1 & emp_ci==1
...
****************************		
	...
	*telef_ch*
	***********
	gen telef_ch=(hh12__2==1) if hh12__2!=9
	...
	*auto_ch*
	***********
	gen auto_ch=(hh11p>1) if hh11p!=999999
	...
	*internet_ch*
	***********
	gen internet_ch=(hh13==1 | hh14==1) if hh13!=999999 & hh14!=999999
...
****************************
	...
	***********	
	...
	replace aguafuente_ch= 4 if hh7==5 				// Protected well
	replace aguafuente_ch= 7 if hh7==3 				// Another improved
	replace aguafuente_ch= 8 if hh7==8 				// Surface water
	replace aguafuente_ch= 9 if hh7==6 				// Another unimproved
	replace aguafuente_ch= 10 if hh7==7	| hh7==888888		// Unclassifiable
