...
*99= DK/NS
	...
	*********
	gen byte afro_ci = .
	replace afro_ci = 1 if (cq14 ==1 | cq14==3)
	replace afro_ci = 0 if (cq14==2 | cq14==4 | cq14==5 | cq14==6 | cq14==7 | cq14==8 | cq14==9 | cq14==99)
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = . 		  
	replace ind_ci = 1 if (cq14 ==4 | cq14==3)
	replace ind_ci = 0 if (cq14 ==1 | cq14==2 | cq14==3 | cq14==5 | cq14==6 | cq14==7 | cq14==8 | cq14==9 | cq14==99)
...
replace desalent_ci = 1 if (inlist(cq118, 10,11,12,13,14) & condocup_ci == 3)
...
*********************
gen aguared_ch=0
replace aguared_ch= 1 if h8==1 | h71==1
