...
************************************
gen relacion_ci=1 if relate==1
replace relacion_ci=2 if relate==2
replace relacion_ci=3 if relate==3
replace relacion_ci=4 if relate==4 | relate==5 | relate==6 | relate==7
replace relacion_ci=5 if relate==8
replace relacion_ci=. if relate==9 /* No sabe */
...
*menores que PET
replace condocup_ci=4 if age<14
...
*********************************************
* MGD 9/08/2014: No se conoce cuales son las catgorias
...
*****************************
gen luz_ch=.
replace luz_ch=1 if light==3 | light==4
...
********************************************
gen combust_ch=.
replace combust_ch=1 if cooking>=2 & cooking<=4 
