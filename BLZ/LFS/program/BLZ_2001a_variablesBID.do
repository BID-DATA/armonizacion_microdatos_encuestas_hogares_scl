...
*99= DK/NS
	...
	*********
	gen byte afro_ci = .
	replace afro_ci = 1 if (p04 ==1 | p04==3)
	replace afro_ci = 0 if (p04==2 | p04==4 | p04==5 | p04==6 | p04==7 | p04==8 | p04==9 | p04==99)
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = . 		  
	replace ind_ci = 1 if (p04 ==4 | p04==3)
	replace ind_ci = 0 if (p04 ==1 | p04==2 | p04==5 | p04==6 | p04==7 | p04==8 | p04==9 | p04==99)
...
replace desalent_ci = 1 if (inlist(p20, 5,6,7,8,9) & condocup_ci == 3)
...
*********************************************
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deletedlabel define pqnoasis 1"Muy joven" 2"Razones financieras" 3"Esta trabajando para pagarlo" 4"Trabaja en casa o negocio familiar" 5"Distancia a la escuela/transporte" 6"Enfermedad/inhabilidad" 7"falta de especio en la escuela" 8"Otra" 99"NS/NR"  
