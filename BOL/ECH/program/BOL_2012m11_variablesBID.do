...
*******************************************************				
	...
	*tab s2_05b, m
	...
	gen byte afro_ci = .
	replace afro_ci = 1 if s2_05b == "AFROBOLIVIANO"
	replace afro_ci = 0 if s2_05b != "AFROBOLIVIANO"
	
	*********
	*ind_ci*
	*********
	gen byte ind_ci = .
	replace ind_ci = 1 if s2_05b != "AFROBOLIVIANO" & s2_05a == 1
	replace ind_ci = 0 if s2_05b == "AFROBOLIVIANO" | s2_05a == 2 | s2_05a == 3
...
****************************
	...
	**************
	...
	destring cods5_16, replace
	
	gen ocupa_ci=.
	replace ocupa_ci=1 if ((cods5_16>=210 & cods5_16<=348) | (cods5_16>=21 & cods5_16<=34)) & emp_ci==1
	replace ocupa_ci=2 if ((cods5_16>=110 & cods5_16<=131) |  cods5_16==11) & emp_ci==1
	replace ocupa_ci=3 if ((cods5_16>=410 & cods5_16<=422) |  cods5_16==41 |  cods5_16==42) & emp_ci==1
	replace ocupa_ci=4 if ((cods5_16>=520 & cods5_16<=529) | (cods5_16>=910 & cods5_16<=911) | cods5_16==52 | cods5_16==91) & emp_ci==1
	replace ocupa_ci=5 if ((cods5_16>=510 & cods5_16<=519) | (cods5_16>=912 & cods5_16<=916)) & emp_ci==1
	replace ocupa_ci=6 if ((cods5_16>=610 & cods5_16<=621) | (cods5_16>=920 & cods5_16<=921) | cods5_16==92) & emp_ci==1
	replace ocupa_ci=7 if ((cods5_16>=710 & cods5_16<=851) | (cods5_16>=930 & cods5_16<=933) | cods5_16==71 | cods5_16==81 | cods5_16==93)& emp_ci==1
	replace ocupa_ci=8 if (cods5_16>=0 & cods5_16<=8) & emp_ci==1
