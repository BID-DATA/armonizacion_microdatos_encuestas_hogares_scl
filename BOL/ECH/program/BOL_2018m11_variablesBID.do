...
****************************
	...
	***************	
	...
	replace afiliado_ci  = 0 if s06h_59==2
	replace afiliado_ci  = 1 if s06h_59==1		
...
replace categopri_ci=3 if s06b_16==1 | s06b_16==2 | s06b_16==9
replace categopri_ci=4 if s06b_16==7
replace categopri_ci=0 if s06b_16==8
...
******************
gen categosec_ci=.
replace categosec_ci=1 if s06f_41>=4 & s06f_42<=6
replace categosec_ci=2 if s06f_41==3
replace categosec_ci=3 if s06f_41==1 | s06f_41==2 | s06f_41==9
...
***eduui_ci***
**************
gen byte eduui_ci = (inlist(s05a_06a, 71, 72, 76, 78, 79) | (s05a_05 == 2 & inlist(s05a_02a,  71, 72, 76, 78, 79) &  s05a_05a != 1)) 
...
gen byte eduuc_ci = ((s05a_05 == 2 & ((inlist(s05a_02a,  71, 72, 76, 78, 79) &  s05a_05a == 1) | inlist(s05a_02a, 73, 74, 75))) | inlist(s05a_06a, 73, 74, 75))
...
replace eduac_ci = . if inlist(s05a_06a, 80, 81) & (s05a_02a >= 71)
