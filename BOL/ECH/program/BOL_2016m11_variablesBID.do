...
replace relacion_ci=3 if  s02a_05==3 | s02a_05==4
replace relacion_ci=4 if  s02a_05>=5 &  s02a_05<=10
...
*******************************************************	
	...
	*tab s03a_2npioc, m
	...
	gen byte afro_ci = .
	replace afro_ci= 1 if s03a_2npioc == 1  
	replace afro_ci = 0 if s03a_2npioc != 1 & s03a_2 != .
	tab afro_ci, m
	...
	*********
	gen byte ind_ci = .
	replace ind_ci = 1 if s03a_2npioc != 1 & s03a_2 == 1
	replace ind_ci = 0 if s03a_2npioc == 1 | s03a_2 == 2  | s03a_2 == 3
	tab ind_ci, m
...
gen  ypensub_ci=s07a_01e0 if s07a_01e0>1 & s07a_01e0!=. 
...
replace afiliado_ci = 1 if (s06h_59b == 1 & emp_ci==1)
...
gen subemp_ci=0
replace subemp_ci=1 if (s06h_53==1 & s06h_54==1)  & horaspri_ci <= 30 & emp_ci==1
...
gen tiempoparc_ci=.
*Mod. MLO 2015, 10
replace tiempoparc_ci=(s06h_53==2 & horaspri_ci<30 & emp_ci == 1)
...
******************
gen categosec_ci=.
replace categosec_ci=1 if s06f_42>=4 & s06f_42<=6
replace categosec_ci=2 if s06f_42==3
replace categosec_ci=3 if s06f_42==1 | s06f_42==2 | s06f_42==8
replace categosec_ci=4 if s06f_42==7
...
replace nempleos_ci=2 if emp_ci==1 & s06e_40==1
...
gen longi=length(s06b_11acod)
g new_cod=substr(s06b_11acod,1,3) if longi>3
replace new_cod=s06b_11acod if longi<=3
...
gen yliquido2 = .
replace yliquido2= s06g_48a*30		if s06g_48b==1
replace yliquido2= s06g_48a*4.3		if s06g_48b==2
replace yliquido2= s06g_48a*2		if s06g_48b==3
replace yliquido2= s06g_48a			if s06g_48b==4
replace yliquido2= s06g_48a/2		if s06g_48b==5
replace yliquido2= s06g_48a/3		if s06g_48b==6
replace yliquido2= s06g_48a/6		if s06g_48b==7
replace yliquido2= s06g_48a/12		if s06g_48b==8
...
gen yhrsextr2 = .
replace yhrsextr2=s06g_49a1/12 if s06g_49a==1
...
gen yalimen2 = .
replace yalimen2=s06g_49b1/12	if s06g_49b==1
...
gen yvivien2= .
replace yvivien2=s06g_49c1/12	if s06g_49c==1
...
replace s6_112 =  s07c_08a*7.45061   if s07c_08b==2 /*euro*/
replace s6_112 =  s07c_08a*6.96		 if s07c_08b==3 /*dolar*/
replace s6_112 =  s07c_08a*0.53026   if s07c_08b==4 /*peso argentino*/
replace s6_112 =  s07c_08a*1.73215   if s07c_08b==5 /*real*/
replace s6_112 =  s07c_08a*0.00968	 if s07c_08b==6 /*peso chileno*/
...
***eduui_ci***
**************
gen byte eduui_ci = (inlist(s05a_06a, 71, 72, 76, 78) | (s05a_05 == 2 & inlist(s05a_02a,  71, 72, 76, 78) &  s05a_05a != 1)) 
...
gen byte eduuc_ci = ((s05a_05 == 2 & ((inlist(s05a_02a,  71, 72, 76, 78) &  s05a_05a == 1) | inlist(s05a_02a, 73, 74, 75))) | inlist(s05a_06a, 73, 74, 75))
...
gen eduac_ci = . 
replace eduac_ci = 1 if (inlist(s05a_02a, 71, 72, 73, 74, 75, 76, 78) | inlist(s05a_06a, 71, 72, 73, 74, 75, 76, 78) )
replace eduac_ci = 0 if (s05a_06a == 76) | (s05a_02a == 76)
replace eduac_ci = . if inlist(s05a_06a, 77, 80) & s05a_02a >= 71
...
gen asiste_ci=.
replace asiste_ci = 0 if s05a_05 == 2  
replace asiste_ci = 1 if s05a_05 == 1 
...
replace pqnoasis1_ci = 5 if s05b_11==10 | s05b_11==4
replace pqnoasis1_ci = 6 if s05b_11==2
*replace pqnoasis1_ci = 7 if s05b_11== /*No está esta categoría*/
replace pqnoasis1_ci = 8 if s05b_11==6
replace pqnoasis1_ci = 9 if s05b_11==1  | s05b_11==8 | s05b_11==13 | s05b_11==14
...
replace aguafconsumo_ch = 3 if s01a_10==10
replace aguafconsumo_ch = 4 if (s01a_10==4 | s01a_10==5 | s01a_10==6)
replace aguafconsumo_ch = 6 if s01a_10==11
replace aguafconsumo_ch = 7 if s01a_10 == 8
replace aguafconsumo_ch = 8 if s01a_10==9
replace aguafconsumo_ch = 9 if s01a_10== 7 
replace aguafconsumo_ch = 10 if s01a_10== 12
...
replace aguafuente_ch = 3 if s01a_10==10
replace aguafuente_ch = 4 if (s01a_10==4 | s01a_10==5 | s01a_10==6)
replace aguafuente_ch = 6 if s01a_10==11
replace aguafuente_ch = 7 if s01a_10 == 8
replace aguafuente_ch = 8 if s01a_10==9
replace aguafuente_ch = 9 if s01a_10== 7 
replace aguafuente_ch = 10 if s01a_10== 12
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	*******************
	...
	gen migrante_ci=(s03a_2==3) if s03a_2!=. 	
