...
****************
gen cotizando_ci=.
replace cotizando_ci=1 if s6g_52b==1 | s4a_4a==2 | s4a_4b==2
recode cotizando_ci .=0 if s6g_52b==2 & s4a_04a!=2 & s4a_4b!=2 & (condocup_ci==2 )
label var cotizando_ci "Cotizante a la Seguridad Social"

****************
*afiliado_ci****
****************
gen afiliado_ci= s6g_52b==1	| s4a_4a==2 | s4a_4b==2
