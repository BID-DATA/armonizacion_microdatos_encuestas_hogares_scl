...
recode afiliado_ci .=0  if condact1>=1 & condact1<=3
...
gen rama_ci=.
replace rama_ci=1 if (caeb_op1>=0 & caeb_op1<=1) & emp_ci==1
replace rama_ci=2 if caeb_op1==2 & emp_ci==1
replace rama_ci=3 if caeb_op1==3 & emp_ci==1
replace rama_ci=4 if caeb_op1==4 & emp_ci==1
replace rama_ci=5 if caeb_op1==5 & emp_ci==1
replace rama_ci=6 if (caeb_op1>=6 & caeb_op1<=7) & emp_ci==1 
replace rama_ci=7 if caeb_op1==8 & emp_ci==1
replace rama_ci=8 if (caeb_op1>=9 & caeb_op1<=10) & emp_ci==1
replace rama_ci=9 if (caeb_op1>=11 & caeb_op1<=16) & emp_ci==1
