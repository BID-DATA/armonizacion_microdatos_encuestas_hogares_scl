...
replace desalent_ci = 1 if (s6a_05 == 2 & inlist(s6a_10, 3, 4) & condocup_ci == 3)
...
replace afiliado_ci = 1 if (s6g_52b == 1 & emp_ci==1)
...
gen categoinac_ci = .
replace categoinac_ci = 1 if (s6a_09==3 & condocup_ci==3) // Jubilados o pensionados
replace categoinac_ci = 2 if (s6a_09==1 & condocup_ci==3) // Estudiantes
replace categoinac_ci = 3 if (s6a_09==2 & condocup_ci==3) // Quehaceres domésticos
