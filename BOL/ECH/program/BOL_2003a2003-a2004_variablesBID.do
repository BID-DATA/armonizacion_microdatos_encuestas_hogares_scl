...
* Variable encuesta original: a1_11
	* 1: Quechua; 2: Aymara; 3: Guaraní; 4: Chiquitano; 5: Mojeño;
	* 6: Otro (especifique) > a1_11b
	* 7: Ninguno;
	...
	*afro_ci*
	*********
	tab a1_11b, m // No aparece ninguna respuesta asociado al Afro
	...
	**************
	...
	replace noafroind_ci =1 if (afro_ci==0 | ind_ci==0) // Se cambia condición porque afro_ci no está disponible para el 2003
	replace noafroind_ci =0 if (afro_ci==1 | ind_ci==1)
	*replace noafroind_ci =. if (afro_ci==. | ind_ci==.) //Esto solo en el caso que se tenga ambas opciones no disponibles (Para el 2003 solo está disponible ind_ci). 
	ta noafroind_ci,m
