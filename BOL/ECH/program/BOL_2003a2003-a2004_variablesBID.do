...
*******************************************************
	...
	*********	
	gen byte ind_ci = .
	replace ind_ci = 1 if inrange(a1_11, 1,6) 
	replace ind_ci = 0 if a1_11 == 7
...
****************************
	...
	***horaspri_ci***
	***************	
	gen horas1=a4_20b2/60
	
	egen horaspri_ci=rsum(a4_20b1 horas1), missing
	replace horaspri_ci=. if a4_20b1==. & horas1==.
	replace horaspri_ci=horaspri_ci*a4_20a
	...
	***horastot_ci ***
	***************	
	gen horas2=a4_40min/60
	egen horassec=rsum(a4_40hrs horas2), missing
	replace horassec=. if a4_40hrs==. & horas2==.
	replace horassec=horassec*a4_39
	...
	***************	
	...
	replace cotizando_ci=1 if  a4_22a==1 
	recode cotizando_ci .=0 if a4_22a==2
	...
	***************	
	...
	replace afiliado_ci  = 0 if   a4_46b==2
	replace afiliado_ci  = 1 if   a4_46b==1		
	...
	**************
	gen byte pension_ci=. 
	replace pension_ci=1 if a5_01c2>0 | a5_01d2>0 | a5_01e2>0 |  a5_01f2>0 
	recode pension_ci .=0 
	...
	**pensionsub_ci**
	***************
	gen byte pensionsub_ci=1 if a5_03e1>1 & a5_03e1 !=. 
...
egen ypen_ci=rsum(a5_01c2 a5_01d2 a5_01e2 a5_01f2), missing
recode ypen_ci .=0 
...
**ypensub_ci*
*****************
destring a5_03e1, replace
gen ypensub_ci=a5_03e1/12  if  a5_03e2==1 & a5_03e1 >1 & a5_03e1 !=.
...
*******************
gen categoinac_ci = .
replace categoinac_ci = 1 if (a4_07==3 & condocup_ci==3) // Jubilados o pensionados
replace categoinac_ci = 2 if (a4_07==1 & condocup_ci==3) // Estudiantes
replace categoinac_ci = 3 if (a4_07==2 & condocup_ci==3) // Quehaceres domésticos
...
****************
gen aguared_ch = 0
replace aguared_ch = 1 if a6_16==1
replace aguared = . if a6_16==.
...
replace aguafconsumo_ch = 1 if a6_16==1
replace aguafconsumo_ch = 2 if a6_16==2
replace aguafconsumo_ch = 4 if a6_16==4
replace aguafconsumo_ch = 6 if a6_16==3
replace aguafconsumo_ch = 8 if a6_16==7
replace aguafconsumo_ch = 10 if a6_16== 6 |a6_16== 8 |a6_16==5

*****************
*aguafuente_ch*
*****************
gen aguafuente_ch = 0
replace aguafuente_ch = 1 if a6_16==1
replace aguafuente_ch = 2 if a6_16==2
replace aguafuente_ch = 4 if a6_16==4
replace aguafuente_ch = 6 if a6_16==3
replace aguafuente_ch = 8 if a6_16==7
replace aguafuente_ch = 10 if a6_16== 6 |a6_16== 8|a6_16==5

*************
*aguadist_ch*
*************
gen aguadist_ch=0
replace aguadist_ch=1 if a6_19==1
...
**************
gen aguadisp1_ch = .
replace aguadisp1 = 1 if a6_18 ==1
replace aguadisp1 = 0 if a6_18 ==2
...
*****************
gen bano_ch=6
replace bano_ch=0 if a6_21==2 
replace bano_ch=1 if a6_21==1 & a6_23 ==1
replace bano_ch=2 if a6_21==1 & a6_23 ==2
replace bano_ch=3 if a6_21==1 & a6_23 ==3
replace bano_ch=4 if a6_21==1 & a6_23 ==4
***************
***banoex_ch***
***************
gen banoex_ch =.
replace banoex_ch = 0 if a6_22==2
replace banoex_ch = 1 if a6_22==1
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if a6_21==1
...
rename cod_oc codocupa
rename cod_ac codindustria
