...
*miembros_one_ci*
*****************
gen miembros_one_ci = (inrange(s1_08,1,10))
...
replace ocupa_ci=6 if ((aux>=610 & aux<=639) | (aux>=71 & aux<=83) | aux==61 | aux==62 | aux==63 | aux==92 | aux==921) & emp_ci==1
