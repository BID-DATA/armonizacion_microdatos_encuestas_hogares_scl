...
replace civil_ci=2 		if s01a_10==2 | s01a_10==3
replace civil_ci=3 		if s01a_10==4 | s01a_10==5
...
gen tamemp_ci=.
replace tamemp_ci=1 if s04b_14>=1 & s04b_14<=5
replace tamemp_ci=2 if s04b_14>=6 & s04b_14<=49
replace tamemp_ci=3 if s04b_14>49 & s04b_14!=.
...
gen tamemp=.
replace tamemp=1 if s04b_14>=1 & s04b_14<=4
replace tamemp=2 if s04b_14>=5 & s04b_14<=14
replace tamemp=3 if s04b_14>=15 & s04b_14<=40
replace tamemp=4 if s04b_14>=41 & s04b_14!=.
...
replace cotizando_ci = 1 if (s04f_36 == 1 & emp_ci==1)
...
******************
gen categosec_ci=.
replace categosec_ci=1 if s04e_27>=4 & s04e_27<=6
replace categosec_ci=2 if s04e_27==3
replace categosec_ci=3 if s04e_27==1 | s04e_27==2 
replace categosec_ci=4 if s04e_27==7
...
replace nempleos_ci=2 if emp_ci==1 & s04d_25==1
...
gen spublico_ci=.
replace spublico_ci=1 if s04b_13==1 | s04b_13==2
replace spublico_ci=0 if (s04b_13>=3 & s04b_13<=6)
...
gen yotro_bono= .
replace yotro_bono= s05b_07aa	        if s05b_07ab==4
replace yotro_bono= s05b_07aa/12		if s05b_07ab==8
...
replace s6_112 =  s05c_10a*8.39668   if s05c_10b==2 /*euro*/
replace s6_112 =  s05c_10a*6.96		 if s05c_10b==3 /*dolar*/
replace s6_112 =  s05c_10a*0.08152   if s05c_10b==4 /*peso argentino*/
replace s6_112 =  s05c_10a*1.32060   if s05c_10b==5 /*real*/
...
*** Beneficiarios a nivel individual:
	...
	gen byte contrah_ci = (s05b_06a == 1) if !missing(s05b_06a)
	
	gen byte potrot_ci = (discap_ci == 1 | natal_ci == 1 | contrah_ci == 1)
	replace potrot_ci = . if discap_ci == . & natal_ci == . & contrah_ci == .
	
*** Montos de transferencias a nivel individual:

	// Transferencias PNC
	gen double ypnc_ci = s05a_01e0
	...
	gen double ydiscap_ci = s02a_15a if s02a_15b == 4
	replace ydiscap_ci = s02a_15a/12 if s02a_15b == 8
	gen ynatal_ci = .
	gen ycontrah_ci = .
...
gen edupub_ci=.
replace edupub_ci= 1 if s03a_09==1 & asiste_ci==1
replace edupub_ci= 0 if s03a_09==2 & asiste_ci==1
...
****************
gen aguared_ch = 0
replace aguared_ch = 1 if (s07a_10==1 | s07a_10==2)
replace aguared = . if s07a_10==.
...
replace aguafconsumo_ch = 1 if s07a_10==1|s07a_10==2
replace aguafconsumo_ch = 2 if s07a_10==3
replace aguafconsumo_ch = 4 if (s07a_10==5 | s07a_10==6)
replace aguafconsumo_ch = 5 if s07a_10==4
replace aguafconsumo_ch = 6 if s07a_10==10
replace aguafconsumo_ch = 7 if s07a_10 == 8
replace aguafconsumo_ch = 8 if s07a_10==9
replace aguafconsumo_ch = 9 if s07a_10 == 7
replace aguafconsumo_ch = 10 if s07a_10 == 11
...
*****************
gen aguafuente_ch = 0
replace aguafuente_ch = 1 if s07a_10==1|s07a_10==2
replace aguafuente_ch = 2 if s07a_10==3
replace aguafuente_ch = 4 if (s07a_10==5 | s07a_10==6)
replace aguafuente_ch = 5 if s07a_10==4
replace aguafuente_ch = 6 if s07a_10==10
replace aguafuente_ch = 7 if s07a_10 == 8
replace aguafuente_ch = 8 if s07a_10==9
replace aguafuente_ch = 9 if s07a_10 == 7
replace aguafuente_ch = 10 if s07a_10 == 11
...
*************
gen aguadist_ch=0
replace aguadist_ch=1 if s07a_10==1
replace aguadist_ch=2 if s07a_10==2
replace aguadist_ch=3 if s07a_10==3
...
*aguadisp2_ch*
**************
gen aguadisp2_ch = 1 if (s07a_11c<=3 | s07a_11a <12)
replace aguadisp2_ch = 2 if (s07a_11c>=4 & s07a_11a >= 12)
replace aguadisp2_ch = 3 if (s07a_11c==7 & s07a_11a == 24)
...
*****************
gen bano_ch=6
replace bano_ch=0 if s07a_13==5 
replace bano_ch=1 if s07a_13==1 & s07a_14==1
replace bano_ch=2 if s07a_13==1 & s07a_14==2
replace bano_ch=3 if ((s07a_13==2 | s07a_13 == 4) & s07a_14!=4) | (s07a_13==1 & s07a_14 == 3)
replace bano_ch=4 if (s07a_13==1 |s07a_13==2 |s07a_13==3) & s07a_14==4
replace bano_ch=5 if s07a_13 ==3 & s07a_14!=4

***************
***banoex_ch***
***************
gen banoex_ch =.
replace banoex_ch = 0 if s07a_15==2
replace banoex_ch = 1 if s07a_15==1
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if s07a_13!=5
...
gen combust_ch= (s07a_22==4 |  s07a_22==6)
replace combust_ch = . if s07a_22==.
...
replace des1_ch=1 if s07a_14==1 | s07a_14==2
replace des1_ch=2 if s07a_14==3
replace des1_ch=3 if s07a_14==4
...
replace des2_ch=1 if s07a_14==1 | s07a_14==2 | s07a_14==3 
replace des2_ch=2 if s07a_14==4
...
gen piso_ch=0 if s07a_09==1 
replace piso_ch=1 if  s07a_09>=2 &  s07a_09<=7 
replace piso_ch=2 if  s07a_09==8
...
gen pared_ch=0 if s07a_06==6
replace pared_ch=1 if s07a_06>=1 & s07a_06<=5
replace pared_ch=2 if s07a_06==7
...
gen techo_ch=0 if s07a_08 ==4
replace techo_ch=1 if s07a_08 >=1 & s07a_08 <=3
replace techo_ch=2 if s07a_08 ==5
...
gen resid_ch =0 if s07a_18==5 | s07a_18==6
replace resid_ch=1 if s07a_18==2 | s07a_18==4
replace resid_ch=2 if s07a_18==1 | s07a_18==3
replace resid_ch=3 if s07a_18==7
replace resid_ch=. if s07a_18==.
...
gen telef_ch = (s07a_26 == 1)
replace telef_ch = . if s07a_26   ==.
...
***internet_ch***
*****************
gen internet_ch=(s07a_28==1)
replace internet_ch = .   if  s07a_28== .
...
***vivi1_ch***
**************
gen vivi1_ch=1 if s07a_01==1
replace vivi1_ch=2 if s07a_01==3
replace vivi1_ch=3 if s07a_01==2 | (s07a_01>=4 & s07a_01<=6)
replace vivi1_ch=. if s07a_01==.
...
gen viviprop_ch=0 if s07a_02==3
replace viviprop_ch=1 if s07a_02==1
replace viviprop_ch=2 if s07a_02==2 
replace viviprop_ch=3 if s07a_02==5 | s07a_02==6 | s07a_02==7 
replace viviprop_ch=4 if s07a_02==4 | s07a_02==8
...
gen vivialq_ch= s07a_04 if s07a_04<999999
...
gen vivialqimp_ch=s07a_05 if s07a_05<999999
...
gen migantiguo5_ci=(migrante_ci==1 & inlist(s01b_11a,1,2)) if !mi(migrante_ci) & s01b_11a!=4
