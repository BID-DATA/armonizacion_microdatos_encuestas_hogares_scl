...
*******************************************************
	...
	*********
	gen byte afro_ci = .
	*replace afro_ci = 1 if s1_11b == "AFROS" // nobody answer "AFRO" in "Otro (especifique) this year"
	*replace afro_ci = 0 if s1_11b != "AFROS"
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = .
	replace ind_ci = 1 if inrange(s1_11, 1,6) 
	replace ind_ci = 0 if s1_11 == 7
...
****************************
	...
	***horaspri_ci***
	***************	
	gen horas1=s5_30min/60
	
	egen horaspri_ci=rsum(s5_30b horas1), missing
	replace horaspri_ci=. if s5_30b==. & horas1==.
	replace horaspri_ci=horaspri_ci*s5_30a
	...
	**pensionsub_ci**
	***************
	gen byte pensionsub_ci=1 if s6_05c>1 & s6_05c!=. 
...
label value tamemp_ci tamemp_ci
	...
	*bonosol hasta 2007 pago anual
	destring s6_05c, replace
	gen  ypensub_ci= s6_05c/12 if s6_05c>1 & s6_05c!=.
...
***eduui_ci***
**************
gen byte eduui_ci = ((inlist(s4_07a, 24, 25, 26, 28, 30)) | (s4_06 == 2 & (inlist(s4_02a, 24, 25, 26, 28, 30)) & s4_11 != 6))
...
***eduuc_ci***
**************
gen byte eduuc_ci = ((s4_06 == 2 & (inlist(s4_02a, 24, 25, 26, 28, 30)) & s4_11 == 6) | (s4_07a == 27) | (s4_06 == 2 & s4_02a == 27))
...
**************
gen eduac_ci = . 
replace eduac_ci = 1 if (inlist(s4_02a, 24, 25, 26, 27 ,30) | (inlist(s4_07a, 24, 25, 26, 27, 30)))
replace eduac_ci = 0 if (s4_02a == 28) | (s4_07a == 28)
replace eduac_ci = . if (inlist(s4_07a, 29, 31) &  s4_02a >= 24)
...
gen asiste_ci = .
replace asiste_ci = 1 if s4_06 == 1
