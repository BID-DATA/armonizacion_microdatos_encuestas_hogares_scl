...
*******************************************************
	...
	************
	...
	replace emp_ci = 0 if inrange(condocup_ci,2,4)
	...
	****************
	...
	replace desemp_ci = 0 if inlist(condocup_ci,1,3)
	...
	*****************
	gen desalent_ci = . 
	replace desalent_ci = 1 if condocup_ci==3 & inlist(s04a_07, 3)
	replace desalent_ci = 0 if inlist(condocup_ci,1,2,4) &  !inlist(s04a_07, 3)
	...
	****************
	...
	gen afiliado_ci = .
	replace afiliado_ci = 1 if s04f_35 == 1    // Afiliado a la Seguridad Social
