...
****************
gen cotizando_ci=.
replace cotizando_ci=1 if s04f_39==1 |  s02a_01a==2 | s02a_01b==2 
recode cotizando_ci .=0 if s04f_39==2 & s02a_01a!=2 & s02a_01b!=2 & (condocup_ci==2)
...
gen afiliado_ci= s04f_39==1	|  s02a_01a==2 | s02a_01a==2 
