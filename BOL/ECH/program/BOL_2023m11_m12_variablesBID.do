...
bys idh_ch: egen afro_ch = max(afro_jefe)
drop afro_jefe
...
bys idh_ch: egen ind_ch = max(ind_jefe)
drop ind_jefe
...
bys idh_ch: egen noafroind_ch =  max(noafroind_jefe)
drop noafroind_jefe
...
bys idh_ch: egen afroind_ch = min(afroind_jefe)
drop afroind_jefe
