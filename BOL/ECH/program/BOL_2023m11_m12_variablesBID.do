...
gen yalimen = .
replace yalimen= s04c_21a2 *30		if s04c_21a1 ==1 & s04c_21a==1 // Diario
replace yalimen= s04c_21a2 *4.3 	if s04c_21a1 ==2 & s04c_21a==1 //Semanal
...
replace yalimen= s04c_21a2 /3		if s04c_21a1 ==6 & s04c_21a==1 // Trimestral
replace yalimen= s04c_21a2 /6		if s04c_21a1 ==7 & s04c_21a==1 // Semestral
replace yalimen= s04c_21a2 /12		if s04c_21a1 ==8 & s04c_21a==1 // Anual
...
* PARTE F: INGRESO LABORAL DE LA OCUPACIÓN SECUNDARIA
* 32. Durante los últimos doce meses, ha recibido:
* B. ¿Alimentos, transporte, vestimenta?
gen yalimen2 = .
...
* C. Alimentos o regalos de otras personas que residen en este u otro lugar del país?
gen yalimento= .
...
* SECCIÓN 5 INGRESOS NO LABORALES DEL HOGAR
* PARTE B: INGRESOS POR TRANSFERENCIAS
* 6. En los últimos doce meses, ¿recibió usted…
* A. Bono de Indigencia por ceguera o Bono mensual para personas por discapacidad
gen yotro_bono2= .
