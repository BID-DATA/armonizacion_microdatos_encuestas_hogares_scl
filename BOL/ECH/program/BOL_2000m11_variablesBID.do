...
* Variable encuesta original: grupo
	...
	*********	
	gen byte ind_ci = .
	replace ind_ci = 1 if inrange(grupo, 1, 5) | grupo == 8 // El inrange cosidera los límites, excluí el 6 para que no se cruzara con el afro_ci
...
replace desalent_ci = 1 if (bus4sem == 2 & inlist(pqnobus, 3, 4) & condocup_ci == 3)
...
replace afiliado_ci = 1 if (afilafp == 1 & emp_ci==1)
...
replace vivialqimp_ch=vivialqimp_ch*6.17 if malimp==2
