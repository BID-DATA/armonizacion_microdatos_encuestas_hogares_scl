...
* Variable encuesta original: s111a
	...
	**************
	...
	replace noafroind_ci =1 if (afro_ci==0 | ind_ci==0) // Se cambia condición porque afro_ci no está disponible para el 2002
	replace noafroind_ci =0 if (afro_ci==1 | ind_ci==1)
	*replace noafroind_ci =. if (afro_ci==. | ind_ci==.) //Esto solo en el caso que se tenga ambas opciones no disponibles (Para el 2002 solo está disponible ind_ci). 
	ta noafroind_ci,m
