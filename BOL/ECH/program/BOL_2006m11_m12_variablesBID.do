...
*******************************************************
	...
	*********
	gen byte afro_ci = .
	*replace afro_ci = 1 if s1_10b == "AFROS" // nobody answer "AFRO" in "Otro (especifique) this year"
...
****************************
	...
	***horaspri_ci***
	***************	
	gen horas1=s5_27min/60
	
	egen horaspri_ci=rsum(s5_27b horas1), missing
	replace horaspri_ci=. if s5_27b==. & horas1==.
	replace horaspri_ci=horaspri_ci*s5_27a
	...
	***horastot_ci ***
	***************	
	gen horas2=s5_43b2/60
	egen horassec=rsum(s5_43b1 horas2), missing
	replace horassec=. if s5_43b1==. & horas2==.
	replace horassec=horassec*s5_43a
	...
	***************	
	...
	replace afiliado_ci  = 0 if  s5_54==2
	replace afiliado_ci  = 1 if  s5_54==1		
	...
	**pensionsub_ci**
	***************
	gen byte pensionsub_ci=1 if s6_05c1>1 & s6_05c1!=. 
...
label value tamemp_ci tamemp_ci
	...
	*****************
	...
	gen ypensub_ci=s6_05c1/12 if s6_05c2=="A" & s6_05c1>1 & s6_05c1!=. 
	replace ypensub_ci =(s6_05c1*8.1)/12 if s6_05c2=="B"  & s6_05c1>1 & s6_05c1!=. 
...
gen byte eduui_ci = ((inlist(s4_05a, 24, 25, 26, 28, 30)) | (s4_04 == 2 & (inlist(s4_02a, 24, 25, 26, 28, 30)) & S4_09 != 6))
...
gen byte eduuc_ci = ((s4_04 == 2 & (inlist(s4_02a, 24, 25, 26, 28, 30)) & S4_09 == 6) | (s4_05a == 27) | (s4_04 == 2 & s4_02a == 27))
...
gen eduac_ci = . 
replace eduac_ci = 1 if (inlist(s4_02a, 24, 25, 26, 27 ,30) | (inlist(s4_05a, 24, 25, 26, 27, 30)))
replace eduac_ci = 0 if (inlist(s4_02a, 28) | (inlist(s4_05a, 28)))
