...
gen rama_ci=.
replace rama_ci=1 if caeb_op1==0 & emp_ci==1
replace rama_ci=2 if caeb_op1==1 & emp_ci==1
replace rama_ci=3 if caeb_op1==2 & emp_ci==1
replace rama_ci=4 if (caeb_op1==3 | caeb_op1==4) & emp_ci==1
replace rama_ci=5 if caeb_op1==5 & emp_ci==1
replace rama_ci=6 if (caeb_op1>=6 & caeb_op1<=8) & emp_ci==1 
replace rama_ci=7 if caeb_op1==7 & emp_ci==1
replace rama_ci=8 if (caeb_op1>=10 & caeb_op1<=11) & emp_ci==1
replace rama_ci=9 if (caeb_op1==9 | (caeb_op1>=12 & caeb_op1<=20)) & emp_ci==1
...
replace s6_112 =  s7_09a*8.30056   	if s7_09b== "B" /*euro*/
replace s6_112 =  s7_09a*6.86		if s7_09b== "C" /*dolar*/
replace s6_112 =  s7_09a*0.81040   	if s7_09b== "D" /*peso argentino*/
replace s6_112 =  s7_09a*2.58128   	if s7_09b== "E" /*real*/
replace s6_112 =  s7_09a*0.01131	if s7_09b== "F" /*peso chileno*/
replace s6_112 =  s7_09a*2.30240   	if s7_09b== "G" /*soles*/

* se suman remesas monetarias y en especie
egen rem = rsum(s7_10 s6_112), m
