...
* 1. OCUPADOS: trabajó o realizó actividad o estuvo ausente con empleo
replace condocup_ci = 1 if s6_01 == 1
replace condocup_ci = 1 if inrange(s6_02,1,6)
replace condocup_ci = 1 if inrange(s6_03,1,7)
...
replace categopri_ci = 1 if inlist(s6_16, 4, 5, 6)

* 2. Cuenta propia
replace categopri_ci = 2 if s6_16 == 3

* 3. Empleado (incluye empleada/o del hogar)
replace categopri_ci = 3 if inlist(s6_16, 1, 2, 8)
...
replace categosec_ci = 1 if inlist(s6_36, 4, 5, 6)

* 2. Cuenta propia
replace categosec_ci = 2 if s6_36 == 3

* 3. Empleado (incluye empleada/o del hogar)
replace categosec_ci = 3 if inlist(s6_36, 1, 2, 8)
