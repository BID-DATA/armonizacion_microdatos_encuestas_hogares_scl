...
/*Poblacion*/
import spss "$ruta\REG02_EPHC_ANUAL_`ANO'_V2.sav", clear // Ingresos individuales
* Creo que hubo problemas en levantar los "labels"
...
import spss "$ruta\c0fe4-REG02_EPHC_4º Trim `ANO'.SAV", clear 
* Creo que hubo problemas en levantar los "labels"
* sale varias veces "invalid numeric value for value label"
rename *, lower
cap sort upm nvivi nhoga l02
...
keep if _merge == 3 // 16775 observaciones se mantienen
drop _merge
sort upms nvivis nhogas l02s
