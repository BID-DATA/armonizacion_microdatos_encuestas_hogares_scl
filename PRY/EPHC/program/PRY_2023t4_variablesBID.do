...
g pqnoasis=.
replace pqnoasis = 1 if inlist(ed10, 1, 2, 3)
replace pqnoasis=2 if ed10==15
replace pqnoasis=3 if inlist(ed10, 12, 13, 14)
replace pqnoasis=4 if inlist(ed10, 6, 7, 8, 9, 10, 11)
replace pqnoasis=5 if inlist(ed10, 4, 5, 17, 18)
