...
* Vigente a partir del 1ero de julio de 2018** 
gen salmm_ci= 	2112562
...
***categoinac_ci*** 
*******************
/* En esta ronda no está disponible ni a06 ni ra06ya09 equivalentes a son Razones de inactividad. 
La variable a09 no la responden todos los inactivos, por lo que sería un proxy. */
gen categoinac_ci = .
...
***ynlm_ci***
*************
/* e02tde: ingreso por ayuda familiar del exterior > Esta variable está a nivel de hogar.
   Se le asigna el valor individual a la jefatura de hogar. */
gen double e02bde = e02tde if relacion_ci == 1
replace e02bde = 0 if e02bde == .
