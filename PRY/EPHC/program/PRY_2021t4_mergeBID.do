...
import spss "$ruta\46b95reg01_ephc`ANO'.sav", clear 
...
/*Ingreso familiar*/
import spss "$ruta\fdb0cingrefam_ephc`ANO'.sav", clear
rename *, lower
...
/*Poblacion*/
import spss "$ruta\7c01ereg02_ephc`ANO'.sav", clear // Ingresos individuales
* Creo que hubo problemas en levantar los "labels"
...
keep if _merge == 3 // 16,569  observaciones se mantienen
drop _merge
sort upms nvivis nhogas l02s
