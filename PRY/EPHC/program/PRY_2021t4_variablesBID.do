...
egen double ylnmpri_ci = rsum(comida unifor alquiler), missing
...
*** Beneficiarios a nivel individual:
	...
	gen byte potrot_ci = (e02d1 == 1) if !missing(e02d1)
...
*** Montos de transferencias a nivel individual:
	...
	* Monto de las transferencias covid por persona (montos anuales & por hogar):
	gen double yotrot_ci = (ingrepytyvõde/pytyvo)/12 if e02d1 == 1 & pytyvo >= 1
