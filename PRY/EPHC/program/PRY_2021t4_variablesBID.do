...
egen double ylnmpri_ci = rowtotal(comida unifor alquiler), missing
...
*** Montos de transferencias a nivel individual:
	...
	// Otras transferencias POTROT
		* Cantidad de beneficiarios por hogar:
			gen byte f_e02d1 = (e02d1 == 1) if !missing(e02d1)
			bys idh_ch: egen pytyvo = total(f_e02d1), mi
	
	* Monto de las transferencias covid por persona (montos anuales & por hogar):
	gen double yotrot_ci = (ingrepytyvõde/pytyvo)/12 if e02d1 == 1 & pytyvo >= 1 & pytyvo != .
	drop f_e02d1 pytyvo
...
***************
	...
	* e02d1   Ingresos por bonos covid > ytransf_ci
