...
* Se mantiene desde PRY 2011 cambia el 28 de feb de 2014 a 1824055 
...
***desalent_ci***
*****************
*10/21/15 MGD: se genera la variable como en el 2009
gen desalent_ci=(a09==2) if condocup_ci==3/*Se intenta construir como en el 2009 pero no existe la variable a09*/
...
* horabco - Horas trabajadas en todas las actividades // 999 . (codificación de missings)
...
a06: razon por la que no habria podido trabajar (a diferencia de a09, a06 la responden inactivos)
           1 no quiere trabajar mas
           2 es demasiado joven
           3 se dedica exclusivamente a labores del hogar
           4 es estudiante
           5 estuvo enfermo
           6 es anciano
           7 es discapacitado
           ...
           9 es jubilado
          10 es pensionado
          11 motivos familiares
          12 otra razon
          99 nr */		  
gen categoinac_ci = .
replace categoinac_ci = 1 if ((a06==9 | a06==10) & condocup_ci==3)
...
egen ylnmpri_ci=rsum(b25), missing
replace ylnmpri_ci=. if b25==. 
...
***ynlm_ci***
*************
/* e02t1: ingreso por ayuda familiar del exterior > Esta variable está a nivel de hogar.
   Las variables a nivel individual son e02l1b1 e02l2b1 */
gen double e02_aux1 = e02l1b1 if l02 == e02l11 
gen double e02_aux2 = e02l2b1 if l02 == e02l21 
   
egen double e02bde = rsum(e02_aux1 e02_aux2)
...
replace ynlm_ci=. if e01dde1==. & e01ede1==. & e01fde1==. & e01gde1==. & e01hde1==. & e01ide1==. & e01jde1==. & e01kde1-09==. & e01lde1==. & e02bde1==.
...
replace remesas_ci = . if e02_aux1 == 99999999999 & e02_aux2 == 99999999999
gen ynlnm_ci=.
egen ytot_ci = rowtotal(ylm_ci ylnm_ci ynlm_ci ynlnm_ci)
drop e02_aux1 e02_aux2
...
***eduui_ci***
**************
gen eduui_ci = (inrange(ed0504, 1801, 2206) & ed06c == 14)
...
**************
gen eduac_ci = .
replace eduac_ci = 1 if inrange(ed0504, 2002, 2206)
replace eduac_ci = 0 if inrange(ed0504, 1801, 1904)
...
*aguafconsumo_ch*
*****************
/* v08 - Agua para beber en el hogar. El agua que más beben en el hogar proviene de…
...
v09. El agua que beben llega a su vivienda a través de….
...
replace aguafuente_ch = 1  if inlist(v06, 1, 2, 3, 4)  & inlist(v09, 1, 2) 	//red (ESSAP/SENASA/comunitaria/privada)
replace aguafuente_ch = 2  if inlist(v06, 1, 2, 3, 4) & v09 == 3  		// llave pública
...
replace aguafuente_ch = 6  if (inlist(v06, 1, 2, 3, 4) & v09 == 6)		// camion cisterna (aguatero)
replace aguafuente_ch = 7  if (inlist(v06, 1, 2, 3, 4) & inlist(v09, 4, 5, 8))  // otra mejorada
replace aguafuente_ch = 8  if v06 == 9 									 // agua superficial (tajamar/río)
replace aguafuente_ch = 10 if (inlist(v06, 7, 8, 11, 99) | (inlist(v06, 1, 2, 3, 4) & inlist(v09, 7, 8, 9)))  // pozo, manantial, otras no clasificable, NR
...
replace aguadist_ch= 3 if v09==3 
...
replace bano_ch=6 if (v13==8 | v13==3 |v13==9 |v13 ==99)  |(v12==. & jefe_ci!=.)
...
gen compu_ch=.
replace compu_ch=1 if v23a==1				//Sí tienen computadora
replace compu_ch=0 if v23a==6				//No tienen computadora
