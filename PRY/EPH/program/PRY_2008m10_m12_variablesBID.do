...
replace cotizando_ci=0 if (b10==6  | b10==. | b10==0) & (c07==6 | c07==. | c07==0)
...
*aguafconsumo_ch*
*****************
/* v10 - Agua para beber en el hogar. El agua que más beben en el hogar proviene de…
...
v11. El agua que beben llega a su vivienda a través de….
...
replace aguafconsumo_ch = 1  if inlist(v10, 1, 2, 3, 4) & inlist(v11, 1, 2)  // red, cañería privada/terreno
replace aguafconsumo_ch = 2  if inlist(v10, 1, 2, 3, 4) & v11 == 3 		// llave pública
replace aguafconsumo_ch = 3  if v10 == 11 | v11 == 6 					//agua embotellada
replace aguafconsumo_ch = 4  if inlist(v10, 5, 6) 						// pozo protegido (dentro del terreno)
replace aguafconsumo_ch = 5  if v10 == 10  								// lluvia
replace aguafconsumo_ch = 6  if v10 == 12 | v10 == 6 					// camión cisterna (aguatero)
replace aguafconsumo_ch = 7  if (v10 == 8 | ((inlist(v10, 1, 2, 3, 4) & (inlist(v11, 4, 7)))))  // otra mejorada
replace aguafconsumo_ch = 8  if v10 == 13 								// agua superficial
replace aguafconsumo_ch = 9  if inlist(v10, 7, 9) 						// pozo/manantial sin protección
replace aguafconsumo_ch = 10 if (inlist(v10, 14, 99) | v11 == 9) 		// otros, no clasificable, NR
...
replace aguafuente_ch = 1  if inlist(v06, 1, 2, 3, 4)  & inlist(v11, 1, 2) 	//red (ESSAP/SENASA/comunitaria/privada)
replace aguafuente_ch = 2  if inlist(v06, 1, 2, 3, 4) & v11 == 3  		// llave pública
...
replace aguafuente_ch = 6  if (inlist(v06, 1, 2, 3, 4) & v11 == 6)		// camion cisterna (aguatero)
replace aguafuente_ch = 7  if (inlist(v06, 1, 2, 3, 4) & inlist(v11, 4, 5, 8))  // otra mejorada
replace aguafuente_ch = 8  if v06 == 9 									 // agua superficial (tajamar/río)
replace aguafuente_ch = 10 if (inlist(v06, 7, 8, 11, 99) | (inlist(v06, 1, 2, 3, 4) & inlist(v11, 6, 7, 9)))  // pozo, manantial, otras no clasificable, NR
...
gen telef_ch=.
replace telef_ch=1 if v14a==1 //Sí cuentan con línea fija
replace telef_ch=0 if v14a==6 //No cuentan con línea fija
...
gen compu_ch=.
replace compu_ch=1 if v27a==1				//Sí tienen computadora
replace compu_ch=0 if v27a==6				//No tienen computadora
