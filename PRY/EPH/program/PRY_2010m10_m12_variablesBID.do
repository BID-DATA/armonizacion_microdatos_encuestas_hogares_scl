...
replace ynlm_ci=. if e01dde1==. & e01ede1==. & e01fde1==. & e01hde1==. & e01ide1==. & e01jde1==. & e01kde1==. & e01lde1==. & e01gde1==.
...
replace aguafconsumo_ch = 3  if v09 == 11 | v10 == 7 					//agua embotellada
...
replace aguafconsumo_ch = 7  if (v09 == 8 | ((inlist(v09, 1, 2, 3, 4) & (inlist(v10, 5, 8)))))  // otra mejorada
...
replace aguadist_ch= 2 if v10==1 | v10==4 
...
replace bano_ch=6 if (v15==8 | v15==3| v15==9) 
