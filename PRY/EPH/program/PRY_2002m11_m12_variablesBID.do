...
The following line:
gen des1_ch=.
replace des1_ch=0 if v11==0 
replace des1_ch=1 if v11==1 | v11==2 | v11==3
replace des1_ch=2 if v11==4
replace des1_ch=3 if v11==5
was replaced with
gen des1_ch=.
replace des1_ch=0 if v11==5 
replace des1_ch=1 if v11==1 | v11==3
replace des1_ch=2 if v11==4 | v11==2
...
gen lp_ci =.
replace lp_ci= 288358  if dominio==1 | dominio==2   /*area metropolitana*/
replace lp_ci= 170763 if dominio==3 | dominio==5   /*rural*/
replace lp_ci= 202165 if dominio==4  /*resto urbano*/
...
gen lpe_ci =.
replace lpe_ci= 140023  if dominio==1 | dominio==2   /*area metropolitana*/
replace lpe_ci= 99433 if dominio==3 | dominio==5   /*rural*/
replace lpe_ci= 107456 if dominio==4  /*resto urbano*/
...
gen byte desalent_ci1 = .
replace desalent_ci1 = 1 if (a13 == 6 & inlist(a14, 2, 3) & condocup_ci == 3)
replace desalent_ci1 = 0 if (desalent_ci1 != 1 & condocup_ci==3)
label var desalent_ci1 "Desalentados"
label define desalent_ci1 0"No" 1"Si", add
label value desalent_ci1 desalent_ci1
...
replace afiliado_ci = 1 if (b10==1 & emp_ci==1)
...
replace subemp_ci=1 if tothoras>=1 & tothoras<=30 & d02==1 & emp_ci==1 
...
gen categosec_ci=.
replace categosec_ci=1 if c06==5
replace categosec_ci=2 if c06==6 
replace categosec_ci=3 if c06==1 | c06==2 | c06==3 | c06==4| c06==8
replace categosec_ci=4 if c06==7
...
/*
gen ylmpri_ci=e01a if emp_ci==1 
replace ylmpri_ci=. if e01a<=0 | e01a>=999999999
replace ylmpri_ci=0 if categopri_ci==4
*/

* Modificaciones Marcela Rubio Septiembre 2014: outlier
gen ylmpri_ci=e01aimde if emp_ci==1 
replace ylmpri_ci=. if e01aimde<=0 | e01aimde>=999999999
replace ylmpri_ci=. if ylmpri_ci >= 500000000
replace ylmpri_ci=0 if categopri_ci==4
...
**<5 and no education
replace yedc=0 if ed43==0 | ed43==1001 | ed43==1002 | ed43==1003

*** preescolar o jardin o pre-primaria
replace yedc=0 if ed43==100 

*** primaria 
replace yedc=1 if ed43==201 
replace yedc=2 if ed43==202 
replace yedc=3 if ed43==203 

replace yedc=4 if ed43==204 
replace yedc=5 if ed43==205 
replace yedc=6 if ed43==206   

*** secundaria 
replace yedc=7 if ed43==301 | ed43==207
replace yedc=8 if ed43==302 | ed43==208
replace yedc=9 if ed43==303 | ed43==209 
replace yedc=10 if ed43==404 | ed43==504 | ed43==604 | ed43==1101
replace yedc=11 if ed43==405 | ed43==505 | ed43==605
replace yedc=12 if ed43==406 | ed43==506 | ed43==606

*** superior no universitario  *** 
replace yedc=13 if ed43==701 | ed43==801 
replace yedc=14 if ed43==702 | ed43==802 
replace yedc=15 if ed43==703 | ed43==803 
replace yedc=16 if ed43==704 | ed43==804

*** universitario
replace yedc=13 if ed43==901
replace yedc=14 if ed43==902
replace yedc=15 if ed43==903
replace yedc=16 if ed43==904 
replace yedc=17 if ed43==905 
replace yedc=18 if ed43==906
...
gen asiste_ci=.
replace asiste_ci=1 if ed07>=1 & ed07<=7 
replace asiste_ci=0 if ed07==8
...
***aguamejorada_ch***
*********************
g       aguamejorada_ch = 1 if (v06 >=1 & v06 <=4) 
replace aguamejorada_ch = 0 if (v06 >=5 & v06 <=7)
		
*********************
***banomejorado_ch***
*********************
g       banomejorado_ch = 1 if (v11 >=1 & v11 <=2)
replace banomejorado_ch = 0 if (v11 >=3 & v11 <=6) | v09==6
...
gen auto_ch=.
replace auto_ch=1 if automovil==9
...
gen compu_ch=v1514
replace compu_ch=1 if v1514==14

****************
**internet_ch***
****************

gen internet_ch=v1515
replace internet_ch=1 if v1515==15
****************
****cel_ch******
****************

gen cel_ch=v1504
replace cel_ch=1 if v1504==4
...
gen viviprop_ch=.
replace viviprop_ch=0 if v14==3 | v14==4 
replace viviprop_ch=1 if v14==1
replace viviprop_ch=2 if v14==2
replace viviprop_ch=3 if v14==5 | v14==6 
