...
gen lp_ci =.
replace lp_ci= 562925  if area==1  /*area urbana*/
replace lp_ci= 349375 if area==2 /*rural*/
...
gen lpe_ci =.
replace lpe_ci= 343212  if area==1  /*area urbana*/
replace lpe_ci= 243721 if area==2   /*rural*/
...
* c15 - Cuántas otras ocupaciones tuvo o tiene en últimos 7 días? // 9 NR
* c18 - Horas que habitualmente trabaja en ocupación (otras)  // 999 NR
gen byte horao = c18 if c15 == 1
replace horao = 0 if (c15 == 1 & c15 == 9) | c18 == 999
...
local var="e01dde e01ede e01fde e01gde e01hde e01ide e01jde e01kde e01lde e02a e02d"
...
egen ynlm_ci=rsum(e01dde1 e01ede1 e01fde1 e01gde1 e01hde1 e01ide1 e01jde1 e01kde1 e01lde1 e02a1 e02d1), missing
replace ynlm_ci=. if e01dde1==. & e01ede1==. & e01fde1==. & e01gde1==. & e01hde1==. & e01ide1==. & e01jde1==. & e01kde1-09==. & e01lde1==. & e02a1==. & e02d1==.
...
***remesas_ci***
*****************
egen remesas_ci= rsum(e02a1 e02d1), missing
replace remesas_ci=. if e02a1>=999999999 &  e02d1>=999999999
gen ynlnm_ci=.
...
replace aguafconsumo_ch = 10 if (inlist(v08, 14, 99) | v09 == 9) 		// otros, no clasificable, NR
...
replace bano_ch=6 if (v13==8 | v13==3| v13==9) 
...
replace resid_ch=3 if basura==8 
drop basura
