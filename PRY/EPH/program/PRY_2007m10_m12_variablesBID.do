...
***categoinac_ci*** 
******************* 
 /* Variable de inactividad: Información obtenida del diccionario, en la base está con una etiqueta distinta
a06: ¿Cuál es la razón principal por la que no habría podido empezar a trabajar? (a diferencia de a09, a06 la responden inactivos)
           0 na                     
           1 no quiso trabajar m�s  
           2 demasiado joven        
           3 labores del hogar      
           4 estudiante             
           5 enfermo                
...
***eduui_ci***
**************
gen eduui_ci = (inrange(ed54, 1601, 1906) & ed06 == 14)
...
**************
gen eduac_ci = .
replace eduac_ci = 1 if inrange(ed54, 1701, 1906)
replace eduac_ci = 0 if inrange(ed54, 1601, 1603)
...
****************
generate aguared_ch =.
replace aguared_ch = 1 if (v06==1 | v06==5 | v06==6)
replace aguared_ch = 0 if (v06==2 | v06==3 | v06==4 | v06>6)
