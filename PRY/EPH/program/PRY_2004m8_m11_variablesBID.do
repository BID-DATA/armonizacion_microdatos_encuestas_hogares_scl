...
* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted
...
gen compu_ch=.
replace compu_ch=1 if v2211==11				//Sí tienen computadora
replace compu_ch=0 if v2211==0				//No tienen computadora
