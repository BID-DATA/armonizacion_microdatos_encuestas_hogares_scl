...
g pqnoasis = . 
replace pqnoasis = 1 if inlist(s4p14, 5, 14)  
replace pqnoasis = 2 if s4p14 == 2
replace pqnoasis = 3 if inlist(s4p14, 4, 11, 12, 13)  
replace pqnoasis = 4 if inlist(s4p14, 6, 7, 8, 9) 
replace pqnoasis = 5 if inlist(s4p14, 10, 15, 3, 1) 
