...
*pensionsub_ci*
***************
/** MGR: había sido creada como missing
gen pensionsub_ci=0
replace pensionsub_ci = 1 if p5567a==1
replace pensionsub_ci = . if p5567a==.
...
* MGR: había sido creada como missing
/*
gen ypensub_ci=p5567c if p5567b==4 & pensionsub_ci==1
replace ypensub_ci=p5567c/2  if p5567b==5 & pensionsub_ci==1
replace ypensub_ci=p5567c/3  if p5567b==6 & pensionsub_ci==1
replace ypensub_ci=p5567c/6  if p5567b==7 & pensionsub_ci==1
replace ypensub_ci=p5567c/12 if p5567b==8 & pensionsub_ci==1
replace ypensub_ci=. if p5567c==.
*/
...
**salmm_ci***
*************
* MGR: INEI no ha actualizado la serie con los datos de 2014, volver a revisar en un par de semanas
* http://www.inei.gob.pe/buscador/?tbusqueda=remuneraci%C3%B3n+m%C3%ADnima+vital
gen salmm_ci= 750 /*se mantiene desde 2012*/
...
* MGR: modifico sintáxis ya que se dejaban fuera a los que indicaban opción 5 y se incluía a los missing values
gen viviprop_ch=0 if p105a==1
replace viviprop_ch=1 if p105a==2
replace viviprop_ch=2 if p105a==4
