...
gen remesas_ci= d556t2/3 if (p5563a==1 & d556t2 != 0)
...
replace pqnoasis1_ci = 9 if p313==1 | p313==10 | p313==12 | p313==13
...
ESTRATO 
Estrato Geográfico
1 Menos de 500,000 Habitantes
2 De 100,001 a 500,000 Habitantes
3 De 50,001 a 100,000 Habitantes
4 De 20,001 a 50,000 Habitantes
5 De 2,001 a 20,000 Habitantes
6 De 500 a menos de 2,000 Habitantes
7 AER Compuesto
8 AER Simple
*/
...
7 Sup. no Univ.Incomp.			1-4	---	
8 Sup.no Univ. Comp.			3-5	---		
9 Sup. Univ. Incompl.			1-6	---
10 Sup. Univ. Completa			4-7	---
11 Post -Grado Universitario		1-3	---
*/
...
replace anoest=19 if 	(p301a==11) & p301b==3 
replace anoest=20 if 	(p301a==11) & p301b==4 
...
p303 
En el 2001, ¿Estuvo matriculado en algún centro o programa de enseñanza regular?
1 Si ==> 304 ==> 305 ==>306
2 No ==> 306
. Missing value
...
p305 El resultado que obtuvo en el 2001 fue?
...
gen WENAS=0 if     (edad>=15 & edad<=64) & (p507==3 | p507==4) & (p506>=1000 & p506<=9900) & p204==1
replace WENAS=1 if (edad>=15 & edad<=64) & (p507==3 | p507==4) & (p506>=1000 & p506<=9900) & (sexo==2) & p204==1

** Target 4, Indicator: Share of women in wage employment in the non-agricultural sector (%)
* With domestic servants

gen WENASD=0 if     (edad>=15 & edad<=64) & (p507==3 | p507==4 | p507==6) & (p506>=1000 & p506<=9900) & p204==1
replace WENASD=1 if (edad>=15 & edad<=64) & (p507==3 | p507==4 | p507==6) & (p506>=1000 & p506<=9900) & (sexo==2) & p204==1
...
replace TELEPHONE=1 if p204==1 & (p1141==1|p1142==1)
...
gen DISCONN=0 if     (edad>=15 & edad<=24) & p204==1
replace DISCONN=1 if (edad>=15 & edad<=24) & (peaa==. | peaa==3) & p307!=1 & ((p549>=1 & p549<=4) | p549==9) & p204==1
