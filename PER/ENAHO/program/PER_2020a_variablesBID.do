...
gen double transltot = d556t1_e/12
...
gen byte potrot_ch = (ingtpu05 > 0 & ingtpu05 != .) | (ingtpu06 > 0 & ingtpu06 != .) | (ingtpu07 > 0 & ingtpu07 != .) | (ingtpu08 > 0 & ingtpu08 != .) | (ingtpu09 > 0 & ingtpu09 != .)
...
gen double ing_potrot_ch = (ingtpu05/12) + (ingtpu06/12) + (ingtpu07/12) + (ingtpu08/12) + (ingtpu09/12)
