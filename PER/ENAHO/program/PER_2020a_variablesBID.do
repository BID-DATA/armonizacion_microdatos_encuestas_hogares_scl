...
replace cotizando_ci = 1 if ((p419a1 <= 2 | p419a2 <= 2 | p419a3 <= 2 | p419a4 <= 2 | p419a5 <= 2) & emp_ci==1)
...
*** Beneficiarios a nivel individual:
	...
	gen byte potrot_ci = (gas_ci == 1 | mequedo_ci == 1 | indep_ci == 1 | rural_ci == 1 | universal_ci == 1)
	replace potrot_ci = . if gas_ci == . & mequedo_ci == . & indep_ci == . & rural_ci == . & universal_ci == .
...
*** Montos de transferencias a nivel individual:
	...
	gen double yindep_ci = (d55617c_e/12) if d55617c_e !=.
	gen double yrural_ci = (d55618c_e/12) if d55618c_e !=.
	gen double yuniversal_ci = (d55619c_e/12) if d55619c_e !=.
	egen double yotrot_ci = rowtotal(ygas_ci ymequedo_ci yindep_ci yrural_ci yuniversal_ci), mi
...
egen double ynlm_ci = rowtotal(divorcio pens_alim transf_hog ypen_ci ytransf_ci otras_pp otras_trans otras_e1 otras_e2 otras_e3 remesas_ci otrans_ext d557t_1 d558t_1), mi
