...
*************
/*gen pension_ci=0 
replace pension_ci=1 if (p5564c!=. | p5565c!=. | p5565c!=0 | p5564c!=0) /* A todas las per mayores de 13*/
replace pension_ci=. if p5564c==. & p5565c==.
...
***categopri_ci***
******************
* 10/20/2015 MGD: la categoria de otros "p507=7" se la clasifica como otros no como no remunerado (observación Laura Castrillo)
gen categopri_ci=.
...
gen categosec_ci=.
replace categosec_ci=0 if p517==0
...
replace rama_ci=9 if (p506>=7111 & p506<=99900) & emp_ci==1
...
*gen trac_pub = d556t1/12 if p5561a==6 | p5561a==7
...
***asispre_ci***
****************
g asispre_ci= p308a==1  // nivel inicial (sin edad)
