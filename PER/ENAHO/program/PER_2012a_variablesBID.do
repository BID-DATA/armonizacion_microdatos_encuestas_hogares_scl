...
gen tamemp_o=1 if p512b>=1 &  p512b<=9 
label var  tamemp_o "Tamaño de Empresa" 
*Empresas medianas
replace tamemp_o=2 if p512b>=10 &  p512b<=49
*Empresas grandes
replace tamemp_o=3 if p512b>=50 &  p512b<9998
...
*************
gen salmm_ci= .
replace salmm_ci=675 if mes_c>=1 & mes_c<=5 /*ene 2012-mayo 2012*/
replace salmm_ci=750 if mes_c>=6 & mes_c<=12 /*jun 2012-dic 2012*/
...
gen durades_ci=p551/4.3 /*Para el calculo, sin filtros if desemp_ci==1*/
