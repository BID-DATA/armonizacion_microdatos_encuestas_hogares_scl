...
gen double ypridbd = i524e1 /12
gen double yprijbi = i530a  /12
gen double ysecbd  = i538e1 /12
gen double ysecjbi = i541a  /12
gen double ingext  = d544t  /12

egen double ylmpri_ci=rsum(ypridbd yprijbi ingext), missing
...
gen double ylnmprid = d529t /12
gen double ylnmprii = d536  /12
gen double ylnmsecd = d540t /12
gen double ylnmseci = d543  /12

egen double ylnmpri_ci=rsum(ylnmprid ylnmprii), missing
...
***ylmsec_ci***
***************
egen double ylmsec_ci=rsum(ysecbd ysecjbi), missing
...
egen double ylnmsec_ci=rsum(ylnmsecd ylnmseci), missing
...
*** Beneficiarios a nivel individual:
	...
	gen byte potrot_ci = (gas_ci == 1 | mequedo_ci == 1 | indep_ci == 1 | rural_ci == 1 | universal_ci == 1 | ninouni_ci == 1 | contigo_ci == 1 | yanapay_ci == 1 | bonoseis_ci == 1 | alimentario_ci == 1)
	replace potrot_ci = . if gas_ci == . & mequedo_ci == . & indep_ci == . & rural_ci == . & universal_ci == . & ninouni_ci == . & contigo_ci == . & yanapay_ci == . & bonoseis_ci == . & alimentario_ci == .
...
*** Montos de transferencias a nivel individual:
	...
	gen double ymequedo_ci = (d55616c/12) if d55616c !=.
	gen double yindep_ci = (d55617c/12) if d55617c !=.
	gen double yrural_ci = (d55618c/12) if d55618c !=.
	gen double yuniversal_ci = (d55619c/12) if d55619c !=.	
	...
	egen double yotrot_ci = rowtotal(ygas_ci ymequedo_ci yindep_ci yrural_ci yuniversal_ci yninouni_ci ycontigo_ci yyanapay_ci ybonoseis_ci yalimentario_ci), mi
...
d55616c Bono me quedo en casa
d55617c Bono independiente
d55618c Bono rural
d55619c Bono familiar universal
...
gen double vivialqimp = ia01hd /12
