...
clear all
set more off
global ruta = "${surveysFolder}\\survey\PER\ENAHO\2022\a\data_orig"
global out ="${surveysFolder}\survey\PER\ENAHO\2022\a\data_merge"

*Equipamiento del hogar
use "$ruta\784-Modulo18\784-Modulo18\enaho01-2022-612.dta" , clear
...
clear
use "$ruta\784-Modulo01\784-Modulo01\enaho01-2022-100.dta", clear
keep if result==1 | result==2
sort conglome vivienda hogar
merge 1:m conglome vivienda hogar using "$ruta\784-Modulo04\784-Modulo04\enaho01a-2022-400.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\784-Modulo02\784-Modulo02\enaho01-2022-200.dta"
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\784-Modulo03\784-Modulo03\enaho01a-2022-300.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\784-Modulo05\784-Modulo05\enaho01a-2022-500.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\784-Modulo85\784-Modulo85\enaho01b-2022-2.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar  using "$ruta\784-Modulo34\784-Modulo34\sumaria-2022.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar using "$ruta\784-Modulo18\784-Modulo18\enaho01-2022-612_1.dta"
drop _merge

capture drop if p203 ==0

saveold "$out\PER_2022a.dta", replace
