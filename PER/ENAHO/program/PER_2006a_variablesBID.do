...
label define categopri_ci 0 "Otra clasifición"  1"Patron" 2"Cuenta propia" 
...
label define categosec_ci 0 "Otra clasifición" 1"Patron" 2"Cuenta propia" 
...
gen ypridbd = i524d1 /12
gen yprijbi = i530a  /12
gen ysecbd  = i538d1 /12
...
replace asiste_ci=0 if p307==2 & t313!=15
...
*pqnoasis1_ci*
**************
g       pqnoasis1_ci = 1 if t313==8
replace pqnoasis1_ci = 2 if t313==2
replace pqnoasis1_ci = 3 if t313==7 | t313==9
replace pqnoasis1_ci = 4 if t313==5
replace pqnoasis1_ci = 5 if t313==11
replace pqnoasis1_ci = 6 if t313==12
replace pqnoasis1_ci = 7 if t313==6
replace pqnoasis1_ci = 8 if t313==3 | t313==4
replace pqnoasis1_ci = 9 if t313==1 | t313==10 | t313==13 | t313==14
