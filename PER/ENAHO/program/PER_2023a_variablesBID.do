...
***************
	...
	g pqnoasis = .
	replace pqnoasis = 1 if inlist(p313, 1, 2)
	replace pqnoasis = 2 if p313 == 9
	replace pqnoasis = 3 if inlist(p313, 5, 10)
	replace pqnoasis = 4 if p313 == 7 
	replace pqnoasis = 5 if inlist(p313, 3, 4, 11)
