...
***mes***
*********
tostring fecentre, replace 
gen mes_c=real(substr(fecentre,3,2))
...
replace relacion_ci=4 if parentes>=4 & parentes<=6
replace relacion_ci=5 if parentes==8 | parentes==9
replace relacion_ci=6 if parentes==7
...
gen edad_ci=edad if edadtiem==1
replace edad_ci=0 if edadtiem==2
...
clonevar codocupa = ocprinci 
clonevar codindustria = ocpciiuu 
