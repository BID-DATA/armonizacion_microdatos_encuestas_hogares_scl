...
gen durades_ci=p551/4.3 /* Sin filtro para el calculoif desemp_ci==1*/
...
replace piso_ch=2 if p103==7 | p103==8 | p103==6
*/
gen piso_ch=0 if p103==6
replace piso_ch=1 if p103>=1 & p103<=5
...
gen persroom=nmiembros_ch/nrocuart 		/*Total de personas en el hogar/nrocuart */
