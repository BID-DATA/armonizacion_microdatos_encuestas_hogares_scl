...
replace cotizando_ci = 1 if (vd4012_fixed == 1 & condocup_ci==1)
...
***pension_ci***
**************** 
gen pension_ci = (v5004a == 1) 
replace pension_ci = . if v5004a == . /*Se les pregunta a todas las personas (jubilados, sobrevivientes, etc.)*/
...
***ylmotros_ci***
*****************
gen double ylmotros_ci=v405812
...
***ylnmotros_ci***
******************
gen double ylnmotros_ci=v405822 if edad_ci>=10
...
* PNC - Pensiones sociales no contributivas:
		* Benefício Asistencial de Prestação Continuada (v5001a) >=65
...
***ylmho_ci***
**************
gen double ylmho_ci=ylm_ci/(horaspri_ci*4.3)
