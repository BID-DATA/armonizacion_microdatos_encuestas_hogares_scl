...
replace lp_ci=153.929888804528	if region==4	& area==3	& uf==41	/*curitiba:     sur-metropolitana-paraná*/
replace lp_ci=132.663259463168	if region==2	& area==3	& uf==23	/*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lp_ci=148.866405646359	if region==1	& area==3	& uf==15	/*belem: noreste-metropolitana-pará*/
...
replace lpe_ci=76.964944402264	if region==4	& area==3	& uf==41	/*curitiba:     sur-metropolitana-paraná*/
replace lpe_ci=66.331629731584	if region==2	& area==3	& uf==23	/*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lpe_ci=74.4332028231797	if region==1	& area==3	& uf==15	/*belem: noreste-metropolitana-pará*/
