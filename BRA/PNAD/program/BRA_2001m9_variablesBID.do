...
replace lp_ci=119.8645771	if region==4	& area==3	& uf==41	/*curitiba:     sur-metropolitana-paraná*/
replace lp_ci=103.3043395	if region==2	& area==3	& uf==23	/*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lp_ci=115.9216634	if region==1	& area==3	& uf==15	/*belem: noreste-metropolitana-pará*/
...
replace lpe_ci=59.93228855	if region==4	& area==3	& uf==41	/*curitiba:     sur-metropolitana-paraná*/
replace lpe_ci=51.65216975	if region==2	& area==3	& uf==23	/*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lpe_ci=57.9608317	if region==1	& area==3	& uf==15	/*belem: noreste-metropolitana-pará*/
