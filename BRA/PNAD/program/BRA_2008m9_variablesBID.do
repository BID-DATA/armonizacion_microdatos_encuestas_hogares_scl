...
segun la fuente, el monto bpc para adultos mayores fue de 415 reales. Se encuentran beneficiarios con dicho monto*/
gen pensionsub_ci=(v1273==415)
...
http://dds.cepal.org/bdps/programa/?id=43
segun la fuente, el monto bpc para adultos mayores fue de 415 reales. Se encuentran beneficiarios con dicho monto*/
gen ypensub_ci=v1273 if v1273==415
...
*********
gen lp_ci=.				
replace lp_ci=188.813017067709	if region==4	& area==1		/*sur-urbana*/
replace lp_ci=171.884953425261	if region==4	& area==2		/*sur-rural */
replace lp_ci=192.71949322938	if region==2	& area==1		/*noreste-urbana*/
replace lp_ci=171.884953425261	if region==2	& area==2		/*noreste-rural*/
replace lp_ci=151.050413637655	if region==3	& area==1		/*sudeste-urbano*/
replace lp_ci=128.913715085458	if region==3	& area==2		/*sudeste-rural*/
replace lp_ci=197.928128221691	if region==1	& area==1		/*norte-urbano*/
replace lp_ci=173.187112255902	if region==1	& area==2		/*norte-rural */
replace lp_ci=160.165524808149	if region==5	& area==1		/*centro oeste-urbano*/
replace lp_ci=140.633143735595	if region==5	& area==2		/*centro oeste-rural */
replace lp_ci=214.856191864139	if region_c==33	& area==3		/*Rio de janeiro-metropolitano*/
replace lp_ci=182.302223409883	if region_c==33	& area==1		/*Rio de janeiro-urbano*/
replace lp_ci=164.072001019357	if region_c==33	& area==2		/*Rio de janeiro-rural*/
replace lp_ci=216.158350529654	if region_c==35	& area==3		/*Sao Paulo-metropolitano*/
replace lp_ci=191.417334563865	if region_c==35	& area==1		/*Sao paulo-urbano*/
replace lp_ci=156.259048596941	if region_c==35	& area==2		 /*Sao paulo-rural*/
replace lp_ci=186.208699571554	if region_c==53	& area==3		/*Distrito federal-metropolitana*/
replace lp_ci=239.597207829928	if region==4	& area==3	& region_c==43	/*Porto alegre: sur-metropolitana-rio grande de sul*/
replace lp_ci=197.928128221691	if region==4	& area==3	& region_c==41	/*curitiba:     sur-metropolitana-paraná*/
replace lp_ci=170.582794759746	if region==2	& area==3	& region_c==23	/*Fortaleza:    noreste-metropolitana-ceará*/
replace lp_ci=223.971303018121	if region==2	& area==3	& region_c==26	/*recife:       noreste-metropolitana-pernambuco*/
replace lp_ci=210.949715537343	if region==2	& area==3	& region_c==29	/*salvador:     noreste-metropolitana-bahia*/
replace lp_ci=167.978477263591	if region==3	& area==3	& region_c==31	/*belo horizonte:sureste-metropolitana-minas gerais*/
replace lp_ci=191.417334563865	if region==1	& area==3	& region_c==15	/*belem: noreste-metropolitana-pará*/
...
***********
gen lpe_ci=.				
replace lpe_ci=94.4065085338547	if region==4	& area==1		/*sur-urbana*/
replace lpe_ci=85.9424767126305	if region==4	& area==2		/*sur-rural */
replace lpe_ci=96.3597466146898	if region==2	& area==1		/*noreste-urbana*/
replace lpe_ci=85.9424767126305	if region==2	& area==2		/*noreste-rural*/
replace lpe_ci=75.5252068188274	if region==3	& area==1		/*sudeste-urbano*/
replace lpe_ci=64.4568575427292	if region==3	& area==2		/*sudeste-rural*/
replace lpe_ci=98.9640641108455	if region==1	& area==1		/*norte-urbano*/
replace lpe_ci=86.593556127951	if region==1	& area==2		/*norte-rural */
replace lpe_ci=80.0827624040745	if region==5	& area==1		/*centro oeste-urbano*/
replace lpe_ci=70.3165718677977	if region==5	& area==2		/*centro oeste-rural */
replace lpe_ci=107.42809593207	if region_c==33	& area==3		/*Rio de janeiro-metropolitano*/
replace lpe_ci=91.1511117049417	if region_c==33	& area==1		/*Rio de janeiro-urbano*/
replace lpe_ci=82.0360005096786	if region_c==33	& area==2		/*Rio de janeiro-rural*/
replace lpe_ci=108.079175264827	if region_c==35	& area==3		/*Sao Paulo-metropolitano*/
replace lpe_ci=95.7086672819325	if region_c==35	& area==1		/*Sao paulo-urbano*/
replace lpe_ci=78.1295242984704	if region_c==35	& area==2		 /*Sao paulo-rural*/
replace lpe_ci=93.1043497857769	if region_c==53	& area==3		/*Distrito federal-metropolitana*/
replace lpe_ci=119.798603914964	if region==4	& area==3	& region_c==43	/*Porto alegre: sur-metropolitana-rio grande de sul*/
replace lpe_ci=98.9640641108455	if region==4	& area==3	& region_c==41	/*curitiba:     sur-metropolitana-paraná*/
replace lpe_ci=85.2913973798732	if region==2	& area==3	& region_c==23	/*Fortaleza:    noreste-metropolitana-ceará*/
replace lpe_ci=111.98565150906	if region==2	& area==3	& region_c==26	/*recife:       noreste-metropolitana-pernambuco*/
replace lpe_ci=105.474857768671	if region==2	& area==3	& region_c==29	/*salvador:     noreste-metropolitana-bahia*/
replace lpe_ci=83.9892386317953	if region==3	& area==3	& region_c==31	/*belo horizonte:sureste-metropolitana-minas gerais*/
replace lpe_ci=95.7086672819325	if region==1	& area==3	& region_c==15	/*belem: noreste-metropolitana-pará*/
...
gen aux2=v9612/12
gen antiguedad_ci=v9611+aux2 if emp_ci==1
