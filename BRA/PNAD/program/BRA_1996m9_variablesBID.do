...
******************************
	...
	**********************
	...
	gen migantiguo5_ci=(migrante_ci==1 & (vivsep91==1 | (ufed91!=. & ufed91!=98) | (migrante_ci==1 & tpoufede==6) | (migrante_ci==1 & tpoufedc==4))) if migrante_ci!=. & !inrange(edad_ci,0,4)	
	...
	**********************
	...
	gen migrantiguo5_ci=(migrante_ci==1 & (vivsep91==1 | (ufed91!=. & ufed91!=98) | (migrante_ci==1 & tpoufede==6) | (migrante_ci==1 & tpoufedc==4))) if migrante_ci!=. & !inrange(edad_ci,0,4)
