...
segun la fuente, el monto bpc para adultos mayores fue de 724 reales. Se encuentran beneficiarios con dicho monto*/
gen pensionsub_ci=(v1273==724)
...
http://dds.cepal.org/bdps/programa/?id=43
segun la fuente, el monto bpc para adultos mayores fue de 724 reales. Se encuentran beneficiarios con dicho monto*/
gen ypensub_ci=v1273 if v1273==724
...
*MR: no contamos con las líneas de pobreza nacional, se genera como missing de momento, pero debe ser actualizado
...
replace cotizando_ci1=1 if (v9059==1 | v9099==1 | v9103==1 | v9120==2) & cotizando_ci1==0
label var cotizando_ci "Cotizante a la Seguridad Social"
...
replace ylnmsec_ci=. if v9985<0 | v9985>=999999995904 | v4814!=1
...
replace cuartos_ch=. if v0205==99 
...
replace vivialq_ch=. if v0208>=999999999 | vivialq_ch<0
