...
*Modificación Mayra Sáenz - 12/10/2014  uf string, label define add modify
destring uf, replace 
...
replace lp_ci=  245.40  	if region==4	& area==3	& region_c==41 /*curitiba:     sur-metropolitana-paraná*/
replace lp_ci=  234.10  	if region==4	& area==1            /*sur-urbana*/	
replace lp_ci=  213.11  	if region==4	& area==2            /*sur-rural */	
replace lp_ci=  211.50   	if region==2	& area==3	& region_c==23 /*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lp_ci=  237.33  	if region==1	& area==3	& region_c==15 /*belem: noreste-metropolitana-pará*/
...
replace lpe_ci=  122.70  	if region==4	& area==3	& region_c==41	/*curitiba:     sur-metropolitana-paraná*/
replace lpe_ci=  117.05  	if region==4	& area==1		/*sur-urbana*/
replace lpe_ci=  106.56  	if region==4	& area==2		/*sur-rural */
replace lpe_ci=  105.75  	if region==2	& area==3	& region_c==23	/*Fortaleza:    noreste-metropolitana-ceará*/
...
replace lpe_ci=  118.67  	if region==1	& area==3	& region_c==15	/*belem: noreste-metropolitana-pará*/
