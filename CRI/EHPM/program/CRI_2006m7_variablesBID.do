...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =   60206 if zona_c==1
replace lp_ci =   45973 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =   24589 if zona_c==1
replace lpe_ci =   20438 if zona_c==0
...
* 2006 junio (fuente OIT-CEPAL observatorio de la crisis)115743.00
* 2015 MGD cambio por datos oficiales M. Trabajo segun zona urbana y rural
gen salmm_ci=112694 if zona_c==0
replace salmm_ci=155520 if zona_c==1 	
...
replace rama_ci=9 if (c17>=74120 & c17<=99999) & emp_ci==1
...
En 2006 no se codifica secundaria técnica ignorada 39
