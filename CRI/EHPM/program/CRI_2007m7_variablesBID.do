...
***** La varaible c05 se encuentra en el formulario de la encuesta pero no se encuentra en la BD *****.
***** El código mantiene como población de referencia a las personas inactivas (condocup_ci == 3) *****.
gen byte desalent_ci = .
replace desalent_ci = 1 if (inlist(c10, 4,5) & condocup_ci == 3)
...
replace cotizando_ci = 1 if ((b07>=1 & b07<=4) & emp_ci==1)
