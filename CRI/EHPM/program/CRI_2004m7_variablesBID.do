...
replace rama_ci=8 if (c17>=65110 & c17<=74120) & emp_ci==1
replace rama_ci=9 if (c17>=74130 & c17<=99000) & emp_ci==1
...
****************
gen aguared_ch=0
replace aguared_ch=1 if (abagua <= 4 & (v10==1 | v10==2) )
...
replace aguafconsumo_ch = 1 if (v10==1 | v10==2) & abagua<=4
...
gen aguafuente_ch = .
replace aguafuente_ch = 1 if (v10==1 | v10==2) & abagua<=4
...
************
gen sinbano_ch = 0
replace sinbano_ch = 3 if servsani==5
