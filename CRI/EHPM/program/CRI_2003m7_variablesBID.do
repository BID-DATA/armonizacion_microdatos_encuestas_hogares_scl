...
gen civil_ci=.
replace civil_ci=1 if b17==6
replace civil_ci=2 if b17==1 | b17==2
replace civil_ci=3 if b17==3| b17==4
replace civil_ci=4 if b17==5
...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =   30828 if zona_c==1
...
gen lpe_ci = .
replace lpe_ci =  14141 if zona_c==1
replace lpe_ci =  12270 if zona_c==0
...
* 2003 junio (fuente OIT-CEPAL observatorio de la crisis) 81530.00
...
replace rama_ci=9 if (c17>=74210 & c17<=99000) & emp_ci==1
...
gen edupub_ci=.
replace edupub_ci=1 if b12==1 | b12==2
replace edupub_ci=0 if b12==3
...
replace aguafconsumo_ch = 10 if v11==5|v11==5
...
replace aguafuente_ch = 10 if v11==5|v11==5
