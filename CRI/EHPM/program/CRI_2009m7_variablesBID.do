...
replace desalent_ci = 1 if (c05 == 2 & inlist(c10, 4,5) & condocup_ci == 3)
...
replace cotizando_ci = 1 if (((b07>=1 & b07<=4) | b073==1) & emp_ci==1)
...
replace afiliado_ci = 1 if((b07>0 & b07<99) & emp_ci==1)
...
gen categoinac_ci = .
replace categoinac_ci = 1 if (c08 == 1 & condocup_ci==3)
...
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted4  "problemas de acceso al sistema escolar" 5  "embarazo o matrimonio" 6  "enfermedad o discapacidad" ///
