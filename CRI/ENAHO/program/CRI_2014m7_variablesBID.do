...
Fecha última modificación: 14 de Agosto de 2015
...
TNCG: Trabajador no Calificado Genéricos ¢266,942.69 
...
Lic: Licenciado Universitario ¢583,633.64 
...
1/1/2013 8,944.51	9,738.68	9,926.53	11,896.82	266,942.69	287,547.21	302,535.49	322,146.60	345,221.00	397,010.24	428,785.90	486,344.70	583,633.64
*/

* 2016 MG: Para el salario promedio se tomaron los 4 salarios genericos+el promedio de los 4 salarios agricolass.  a 07/2014
...
replace eduuc_ci=1 if a14>=55 & a14<59 // cinco anios o mas de universitaria, o postgrados
replace eduuc_ci=1 if a14>59 & a14<=89
...
replace eduac_ci=1 if a14>=71 & a14<=89 // especialidad, maestria y doctorados.
