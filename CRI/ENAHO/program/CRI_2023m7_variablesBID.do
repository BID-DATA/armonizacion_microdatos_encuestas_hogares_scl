...
Encuesta: ENAHO
Ronda: m7
Creación: Febrero de 2022
Última versión: Marzo 14 2023
Fecha última modificación:  Mayo 8 2024 - Jillie Chang Kcomt (SCL)
SCL/SCL - IADB
****************************************************************************/
...
gen ynlnm_ci = tnm
replace ynlnm_ci= . if (ithn == 99999999 | ithn == .)
...
replace aedu_ci =. if aedu_ci ==999 //missing values
********************************************************************************************************************************
