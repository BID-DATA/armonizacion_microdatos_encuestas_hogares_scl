...
replace sinbano_ch = 2 if v1k1_excre>= 1 & v1k1_excre<=3 & v1k_servic==4
...
gen internet_ch = 0
replace internet_ch = 1 if ((h5_in_fija == 1 & h5_in_mov == 2) | (h5_in_fija == 2 & h5_in_mov == 1) | (h5_in_fija == 1 & h5_in_mov == 1))
replace internet_ch = 0 if (h5_in_fija == 2 & h5_in_mov == 2)
...
lab val p7 p7
lab var p7b "Ha repetido algún grado?"
lab def p7b 1 "Sí" 2 "No" 3 "Nunca ha asistido"
lab val p7b p7b
...
replace nivel = 4 if p6 >= 41 & p6 <= 44 // Superior no universitaria
replace nivel = 5 if p6 >= 51 & p6 <= 57 // Superior universitaria
replace nivel = 6 if p6 >= 61 & p6 <= 64 // Post-grado
...
replace aniosaprobados = p6 - 40 if p6 >= 41 & p6 <= 44 
replace aniosaprobados = p6 - 50 if p6 >= 51 & p6 <= 57 
replace aniosaprobados = p6 - 60 if p6 >= 61 & p6 <= 64 
...
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deletedlabel define pqnoasis 1 "No se ofrece el nivel o grado escolar en la comunidad" 2 "Tiene que Trabajar" 3 "Falta de recurso económico" 4 "Tiene que ayudar en quehaceres doméstico." 5 "Falta de interés" 6 "Embarazo" 7 "Enfermedad" 8 "No tiene la edad para ingresar" 9 "Esta muy distante de su vivienda" 10 "Ya se graduó" 11 "Se casó o unió" 12 "Otros"
* Line of code with indicator pqnoasis_ci was deleted
**************
*pqnoasis1_ci*
**************
...
* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted*solo para personas de 5 a 17 años 
