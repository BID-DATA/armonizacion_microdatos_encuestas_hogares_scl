...
gen nivel = . 
replace nivel = 0 if p6 >= 1 & p6 <= 3 // ningun grado, prescolar, especial 
...
replace nivel = 7 if p6 >= 71 & p6 <= 73 // Maestria
...
gen aniosaprobados = . 
replace aniosaprobados = 0 if p6 >= 1 & p6 <= 3 
...
replace aniosaprobados = p6 - 70 if p6 >= 71 & p6 <= 73 
