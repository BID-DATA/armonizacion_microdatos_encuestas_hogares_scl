...
*label var p4o_texto "¿Cuál es su país de origen?"
...
*******************************************************
	...
	*Pregunta: ¿Se considera usted negro(a) o afrodescendiente? (p4f) 1- SI, 2- NO
	gen byte afro_ci = . 	  
	replace afro_ci = 1 if p4f == 1 
	replace afro_ci = 0 if p4f == 2 
	...
	*Pregunta: ¿Se considera usted indígena? (p4d) 1- SI, 2- NO	
	gen byte ind_ci = .
	replace ind_ci = 1 if p4d == 1
	replace ind_ci = 0 if p4d == 2
...
* Line of code with indicator edus2i_ci was deleted* Line of code with indicator edus2i_ci was deleted* Line of code with indicator edus2i_ci was deleted*pongo primaria y secundaria, como equivalente a basica y media
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen migantiguo5_ci=(migrante_ci==1 & (p4p_cuando==1 | (p4p_anio<2014 & p4p_cuando==2))) if migrante_ci!=. & !inrange(edad_ci,0,4) & p4p_cuando!=3
