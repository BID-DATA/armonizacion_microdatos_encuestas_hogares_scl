...
lab val p5 p5
lab var p5_tipo "Que tipo de Escuela"
lab def p5_tipo 3 "Pública" 4 "Privada"
lab val p5_tipo p5_tipo
lab var p6 "Qué grado aprobó?"
lab var p7 "Sabe leer y escribir?"
lab def p7 1 "Sí" 2 "No"
lab val p7 p7

* Código de variable igual a cero que no está en cuestionario va a missing:
replace p5 = . if p5 == 0
replace p5_tipo = . if p5_tipo == 0
...
replace nivel = 4 if p6 >= 41 & p6 <= 45 // Superior no universitaria
replace nivel = 5 if p6 >= 51 & p6 <= 57 // Superior universitaria
...
replace aniosaprobados = p6 - 40 if p6 >= 41 & p6 <= 45 
replace aniosaprobados = p6 - 50 if p6 >= 51 & p6 <= 57 
...
* Line of code with indicator repite_ci was deleted* Line of code with indicator repite_ci was deleted* No hay pregunta p7b en 2015.
...
* PAN 2014-2015: http://www.mitradel.gob.pa/portal/page/portal/PG_Relaciones_Publicas/COMUNICADO2 Se mantiene igual
...
* Fuente 2015: http://www.mef.gob.pa/es/informes/Documents/Actualizacion%20de%20las%20lineas%20de%20pobreza%20-%202015.pdf
gen lp_ci =.
replace lp_ci= 140.52 if zona_c==1 
replace lp_ci= 105.26 if zona_c==0
...
* Fuente 2015: http://www.mef.gob.pa/es/informes/Documents/Actualizacion%20de%20las%20lineas%20de%20pobreza%20-%202015.pdf
gen lpe_ci =.
replace lpe_ci= 69.33 if zona_c==1 
replace lpe_ci= 59.25 if zona_c==0
...
replace afiliado_ci = 1 if (inlist(p4_ssocial, 1, 2) & emp_ci==1)
