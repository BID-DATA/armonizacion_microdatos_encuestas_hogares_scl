...
****idh_ch*****
***************
egen idh_ch=group(provin distrito estrato upm nrobol)
...
***zona***
**********
*La base no dispone de la variable área.
gen byte zona_c=.
...
replace nempleos_ci=1 if emp_ci==1 & otrotrj==2
replace nempleos_ci=2 if emp_ci==1 & otrotrj==1 
...
clonevar codindustria=ramaactv
clonevar codocupa=ocupacio
