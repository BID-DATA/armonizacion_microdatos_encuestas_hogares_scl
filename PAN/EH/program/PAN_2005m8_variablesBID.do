...
************************************************************************************************
Modificación identificador de hogar: Mayo 28 de 2010. Problema con las llaves para identificar
el hogar. En la sección idh_ch se ejecuta la nueva programación pero queda guardada para
...
gen condocup_ci=.
replace condocup_ci=1 if p10_18>= 1 & p10_18<= 5 
replace condocup_ci=2 if  (p10_18>=6 & p10_18<=8)  //| p10_18==1: Son otros inactivos
...
replace desalent_ci = 1 if (p10_18 == 9 & condocup_ci == 3)
...
Empleado(a) del Servicio doméstico?. 05
Empleado(a) de la Comisión del
Canal o Sitios de Defensa?............. 06
Por cuenta propia?............................ 07
Patrono(a) (dueño(a))?....................... 08
Trabajador(a) familiar?...................... 09 
Miembro de una Cooperativa de Producción?................................... 10
...
***nempleos_ci***
*****************
* MGD 09/2016: se reemplazó por missing, porque p44 está mal y se genera un salto  en la serie
gen nempleos_ci=.
...
gen lp_ci =.
replace lp_ci= 66.28 if areareco==1 & dist==1 /* Cdad. Panamá*/
...
gen lpe_ci =.
replace lpe_ci= 32.18 if areareco==1 & dist==1 /* Cdad. Panamá*/
...
replace afiliado_ci = 1 if ((p4a == 3 | p4a == 5) & emp_ci==1)
...
/* si se usa afiliado, se restringiendo a ocupados solamente*/
* David Cornejo Febrero 2023: modificando en base a la variable cotizante es missing
...
replace categoinac_ci=1 if p10_18==11 & condocup_ci==3
*Estudiantes
replace categoinac_ci=2 if p10_18==12 & condocup_ci==3
*Quehaceres del Hogar
replace categoinac_ci=3 if p10_18==13 & condocup_ci==3
*Otra razon
