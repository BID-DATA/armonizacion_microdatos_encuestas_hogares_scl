...
****************************
	...
	* 1 = asiste a un centro educativo
	replace asiste_ci = 1 if i43_activity == 5

	* 0 = no asiste
	replace asiste_ci = 0 if inlist(i43_activity, 1,2,3,4,6,7)

	* missing
	replace asiste_ci = . if i43_activity == 9
...
****************************
	...
	* 1..10 = categorías JMP para fuente general | . = no está
	...
	replace aguafuente_ch = 10 if inlist(water_supply,4,9) | missing(water_supply) 
