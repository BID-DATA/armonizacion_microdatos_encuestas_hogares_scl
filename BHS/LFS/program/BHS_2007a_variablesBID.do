...
*	idh_ch
******************************
egen idh_ch= concat(island sup_dist enum_dist hhno)
...
replace desalent_ci = 1 if (i_q32==4 & condocup_ci == 3)
...
*******************
gen categoinac_ci = .
replace categoinac_ci = 1 if  (i_q29 ==6 & condocup_ci==3)
...
***ylmpri_ci***
***************
recode i_q51a (99999999=.) (100000000000=.) (99999999999=.)
...
***ylmsec_ci***
***************
recode i_q51b (99999999=.) (100000000000=.) (99999999999=.)
recode i_q52b (999999=.) (99999999999=.)
...
***ylmotros_ci***
*****************
recode i_q52d (999999=.) (99999999999=.)
...
replace internet_ch=0 if h_q6==2 | h_q5==2
