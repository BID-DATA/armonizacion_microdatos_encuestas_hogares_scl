...
***factor_ci***
***************
* MGD 04/2016: Creación de un fcator de expansión alternagtivo que incluya a toda la población ya que el factor solo esta generado para activos.
* Población: 377841
* Observaciones: 5668
*g factor_ci= 377841/5668
...
*************
gen tamemp_ci=.
replace tamemp_ci = 1 if i67_wrk_business==1 | i67_wrk_business==2
replace tamemp_ci = 2 if i67_wrk_business==3 | i67_wrk_business==4
replace tamemp_ci = 3 if i67_wrk_business==5
...
replace desalent_ci = 1 if (i46_not_looking==4 & condocup_ci == 3)
...
replace afiliado_ci = 1 if (i42a_insurance == 1 & emp_ci==1)
...
*******************
gen categoinac_ci = .
replace categoinac_ci = 1 if  (i43_activity ==6 & condocup_ci==3)
...
***************
*Asalariados
recode i78a1_main_job (99999999999=.)
recode  i77a_first (99999999999=.)
/*g main_job= i78a1_main_job
replace main_job= i78a1_main_job*365 if i78_often_paid==1
replace main_job= i78a1_main_job*24.3 if i78_often_paid==3
replace main_job= i78a1_main_job*52.1 if i78_often_paid==2
replace main_job= i78a1_main_job if i78_often_paid==4
*/
egen ylmpri_aux=rsum(i78a1_main_job i77a_first), m 
...
recode  i78a2_second_job (99999999999=.)
recode i77b_second (99999999999=.)
/*g second_job= i78a2_second_job
replace second_job= i78a2_second_job*365 if i78_often_paid==1
replace second_job= i78a2_second_job*24.3 if i78_often_paid==3
replace second_job= i78a2_second_job*52.1 if i78_often_paid==2
replace second_job= i78a2_second_job if i78_often_paid==4
*/
egen ylmsec_aux= rsum(i78a2_second_job i77b_second), m
...
***ylmotros_ci***
*****************
recode   i78b2_sources (99999999999=.)
/*g oth_job= i78b2_sources
replace oth_job= i78b2_sources*365 if i78_often_paid==1
replace oth_job= i78b2_sources*24.3 if i78_often_paid==3
replace oth_job= i78b2_sources*52.1 if i78_often_paid==2
replace oth_job= i78b2_sources if i78_often_paid==4*/
gen ylmotros_ci=  i78b2_sources/12
