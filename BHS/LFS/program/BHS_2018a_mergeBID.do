...
global ruta = "${surveysFolder}\\survey\\BHS\LFS\\2018\\a\\data_orig"
...
use  "$ruta\Bahamas_LFS_`ANO'_housing_3.dta", clear
sort island hhno  
...
use "$ruta\Bahamas_LFS_`ANO'_individual_3.dta", clear
