...
replace desalent_ci = 1 if (i43_not_looking==4 & condocup_ci == 3)
...
replace afiliado_ci = 1 if (i39a_insurance == 1 & emp_ci==1)
...
*******************
gen categoinac_ci = .
replace categoinac_ci = 1 if  (i40_activity ==6 & condocup_ci==3)
