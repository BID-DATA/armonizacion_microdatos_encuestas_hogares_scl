...
*	idh_ch
******************************
egen idh_ch= concat(island sup_dist enum_dist_no household_no)
...
*************
gen ine01=island
replace ine01 = 3 if inlist(island,11,14)
...
*afiliado_ci****
****************
gen afiliado_ci=(i39a_insurance==1)	
...
*************
gen tamemp_ci=.
replace tamemp_ci = 1 if i60_wrk_business==1 | i60_wrk_business==2
replace tamemp_ci = 2 if i60_wrk_business==3 | i60_wrk_business==4
replace tamemp_ci = 3 if i60_wrk_business==5
...
***desalent_ci***
*****************
gen desalent_ci=(emp_ci==0 & ( i43_not_looking==4))
...
***horaspri_ci***
*****************
gen horaspri_ci=i24a_main_job
replace horaspri_ci=. if emp_ci==0
replace horaspri_ci=. if i24a_main_job==.
...
egen horastot_ci= rsum(horaspri_ci i24b_other_job ) if emp_ci==1  
...
gen subemp_ci=0
replace subemp_ci=1 if horaspri_ci<=30 & emp_ci==1 & i28_available >=1 & i28_available <=6 
...
******************
gen categopri_ci=.
replace categopri_ci=1 if i30_category==5
replace categopri_ci=2 if i30_category==6
replace categopri_ci=3 if i30_category>=1 & i30_category<=4
replace categopri_ci=4 if i30_category==7
...
gen tipocontrato_ci=.
replace tipocontrato_ci=1 if i31_contract==1 & i32_duration==2 & categopri_ci==3
replace tipocontrato_ci=2 if i31_contract==1 & i32_duration==1 & categopri_ci==3
replace tipocontrato_ci=3 if i31_contract==2 & categopri_ci==3
...
gen nempleos_ci=.
replace nempleos_ci=1 if i22_paid_jobs==2
replace nempleos_ci=2 if i22_paid_jobs==3
...
***spublico_ci***
*****************
gen spublico_ci=1 if ((i30_category==1 | i30_category==2) & condocup_ci==1)
...
**************
gen ocupa_ci=.
replace ocupa_ci=1 if ((i53_occupation>=2111 & i53_occupation<=3522))& emp_ci==1
replace ocupa_ci=2 if ((i53_occupation>=1111 & i53_occupation<=1439)) & emp_ci==1
replace ocupa_ci=3 if ((i53_occupation>=4110 & i53_occupation<=4419))& emp_ci==1
replace ocupa_ci=4 if ((i53_occupation>=5200 & i53_occupation<=5249) | (i53_occupation>=9500 & i53_occupation<=9520)) & emp_ci==1
replace ocupa_ci=5 if ((i53_occupation>=5110 & i53_occupation<=5169) | (i53_occupation>=5310 & i53_occupation<=5419) | (i53_occupation>=9110 & i53_occupation<=9129) | (i53_occupation>=9610 & i53_occupation<=9711)) & emp_ci==1
replace ocupa_ci=6 if ((i53_occupation>=6110 & i53_occupation<=6349) | (i53_occupation>=9211 & i53_occupation<=9216)) & emp_ci==1
replace ocupa_ci=7 if ((i53_occupation>=7111 & i53_occupation<=8350) | (i53_occupation>=9310 & i53_occupation<=9412))& emp_ci==1
...
gen rama_ci=.
replace rama_ci=1 if (i55_business_act>=113 & i55_business_act<=399) & emp_ci==1
replace rama_ci=2 if i55_business_act>=510 & i55_business_act<=999 & emp_ci==1
replace rama_ci=3 if i55_business_act>=1000 & i55_business_act<=3399 & emp_ci==1
replace rama_ci=4 if i55_business_act>=3500 & i55_business_act<=3999 & emp_ci==1
replace rama_ci=5 if i55_business_act>=4100 & i55_business_act<=4399 & emp_ci==1
replace rama_ci=6 if ((i55_business_act>=4500 & i55_business_act<=4799) | (i55_business_act>=5500 & i55_business_act<=5699)) & emp_ci==1
replace rama_ci=7 if i55_business_act>=4900 & i55_business_act<=5399 & emp_ci==1
replace rama_ci=8 if (i55_business_act>=6400 & i55_business_act<=6899) & emp_ci==1
replace rama_ci=9 if ((i55_business_act>=5800 & i55_business_act<=6399) | (i55_business_act>=6900 & i55_business_act<=9999)) & emp_ci==1
...
* Variable categorica
gen durades_ci=.
replace durades= 0.5  if i48_how_long_lon ==1
replace durades= 2    if i48_how_long_lon ==2
replace durades= 4.5  if i48_how_long_lon ==3
replace durades= 9    if i48_how_long_lon ==4
replace durades= 12   if i48_how_long_lon ==5
...
***categoinac_ci***
*******************
gen categoinac_ci =1 if (i40_activity ==6 & condocup_ci==3)
replace categoinac_ci = 2 if  (i40_activity ==5 & condocup_ci==3)
replace categoinac_ci = 3 if  (i40_activity ==4 & condocup_ci==3)
replace categoinac_ci = 4 if  (i40_activity ==7 | i40_activity ==3) & condocup_ci==3
...
***************
*Asalariados
recode i71a_main_job (9999999/99999999999=.)
recode  i70a_first (9999999/99999999999=.)
egen ylmpri_aux=rsum(i71a_main_job i70a_first), m 
...
recode  i71b_second_job (9999999/99999999999=.)
recode i70b_second (9999999/99999999999=.)
egen ylmsec_aux= rsum(i71b_second_job i70b_second), m
...
***ylmotros_ci***
*****************
recode   i71d_sources (99999999999=.)
gen ylmotros_ci=  i71d_sources/12
...
replace compu_ch=0 if computer==0
...
gen vivi1_ch=.
replace vivi1_ch=1 if (dewlling==1 | dewlling==2)
replace vivi1_ch=2 if dewlling==3
replace vivi1_ch=3 if (dewlling==4 | dewlling==5)
...
/*_____________________________________________________________________________________________________*/
  ...
  afro_ci ind_ci noafroind_ci afroind_ci afro_ch ind_ch noafroind_ch afroind_ch dis_ci disWG_ci dis_ch BHS_dis_ci /// Diversidad
