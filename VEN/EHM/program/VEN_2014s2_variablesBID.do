...
Fecha última modificación: Marzo 2016
...
replace horastot_ci=pp37 if pp37>=0 
...
replace cotizando_ci1=1 if (pp56c==1 ) & cotizando_ci1==0 /*solo a emplead@s y asalariad@s, difiere con los otros paises*/
...
// pp25c contiene un valor no numerico, forzamos destring
destring pp25c, replace force
