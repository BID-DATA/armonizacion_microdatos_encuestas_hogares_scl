 ...
 */
gen salmm_ci=.
replace salmm_ci=4000/1000 if zona_c==1 /*en Bs: me parecen q estan muy altos! */
replace salmm_ci=2500/1000 if zona_c==0 
...
gen categopri_ci=.
replace categopri_ci=1 if p27==4
replace categopri_ci=2 if p27==3 
replace categopri_ci=3 if p27==1 | p27==2  
replace categopri_ci=4 if p27==5
...
**********************************
	...
	***luz_ch***
	************
	* Esta variable corresponde a alumbrad, sin embargo el 80% de los individuos están categorizados con 0, código que no 
	* consta en el manual.
	gen luz_ch=.
...
*Para evitar errores en Sociometro se renombra casado
rename casado casado_1
