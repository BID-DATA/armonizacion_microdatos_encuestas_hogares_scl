...
replace desalent_ci = 1 if (inlist(tmhp39, 1, 3) & condocup_ci == 3)
...
replace afiliado_ci = 1 if ((tmhp47ss==4 | cmhp25a ==1 | cmhp25b ==2 | pmhp60a==1) & emp_ci==1)
...
replace cotizando_ci = 1 if (tmhp47ss == 4 & emp_ci==1)
...
gen byte aedu_ci=.
replace aedu_ci=0                  if emhp28n==1 | emhp28n==2      // Ninguno | Preescolar
replace aedu_ci=emhp28a            if emhp28n==3                   // Primaria
replace aedu_ci=emhp28a+6          if emhp28n==4                   // Media
replace aedu_ci=(11+(0.5*emhp28s)) if (emhp28n==5 | emhp28n==6)    // Técnico (TSU) | Universitario
replace aedu_ci=(16+(0.5*emhp28s)) if emhp28n==7                   // Posgrado
label variable aedu_ci "Años de Educacion"

//Note: emhp28a contains grades approved in years, this applies for primaria and media.
...
***asispre_ci**
***************
gen asispre_ci=(asiste_ci==1 & emhp28n==2)
