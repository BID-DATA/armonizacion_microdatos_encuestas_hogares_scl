...
replace desalent_ci = 1 if (inlist(tp42, 1, 3) & condocup_ci == 3)
...
replace afiliado_ci = 1 if ((tp50ss==6 | sp20==1 | sp20==2 | pp61ss==1) & emp_ci==1)
...
replace cotizando_ci = 1 if (tp50ss==6 & emp_ci==1)
...
replace asiste_ci = 0 if ep32 == 2 | ep32 == 3
...
/*
Nota: ep30s se reporta en grados semestrales, 
por ello se corrige por 0.5
*/

recode ep30a ep30n ep30s (99=.) (98=.)

gen byte aedu_ci=.
replace aedu_ci=0 if ep30n == 1 | ep30n == 2 // Ninguno, Prescolar
replace aedu_ci= ep30a if ep30n == 3	// Primaria
replace aedu_ci= ep30a + 6 if ep30n == 4 // Media
...
***eduui_ci***
**************
gen eduui_ci = inlist(ep30n, 5, 6) & ep32 == 1 | inlist(ep30n, 5, 6) & ep34 != 1
...
***eduuc_ci***
***************
gen byte eduuc_ci = (inlist(ep30n, 5, 6) & ep34 == 1) | ep30n == 7
...
**************
gen eduac_ci=.
replace eduac_ci = 1 if inlist(ep30n, 6, 7)
replace eduac_ci = 0 if ep30n == 5
...
***asispre_ci**
***************
g asispre_ci = (asiste_ci == 1 & ep30n == 2)
