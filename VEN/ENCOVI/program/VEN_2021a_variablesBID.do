...
****************************
* Mod. 5/2022 Agustina Thailinger
...
* Line of code with indicator edusi_ci was deleted* Line of code with indicator edusi_ci was deletedreplace edusi=. if aedu_ci==.
* Line of code with indicator edusi_ci was deleted
**************
* Line of code with indicator edusc_ci was deleted**************
* Line of code with indicator edusc_ci was deleted* Line of code with indicator edusc_ci was deleted* Line of code with indicator edusc_ci was deletedreplace edusc=. if aedu_ci==.
* Line of code with indicator edusc_ci was deleted
**************
***eduui_ci***
**************
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	*******************
	...
	gen migrantiguo5_ci = .
	label var migrantiguo5_ci "=1 si es migrante"
