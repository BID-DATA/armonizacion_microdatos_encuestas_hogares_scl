...
label value region_BID_c region_BID_c
	...
	* Modificación Alvaro Altamirano
...
tostring idp_ci, replace
	...
	***************
	...
	clonevar estrato_ci=plan_muestreo
...
*******************************************************
	...
	* AJAM: http://www.ecuadorencifras.gob.ec/documentos/web-inec/POBREZA/2017/Diciembre/Reporte%20pobreza%20y%20desigualdad%20_dic17.pdf
	gen lp_ci = 84.49
...
*************
gen aguadist_ch=0
replace aguadist_ch=1 if vi16c==1
replace aguadist_ch=2 if vi16c==2
replace aguadist_ch=3 if vi16c==3
...
gen aguatrat_ch =9
	...
	****************
	gen combust_ch=0
	replace combust_ch=1 if  vi10==1 | vi10==3 
	...
	*************
	...
	replace des2_ch=1 if vi13==1 | vi13==2 | vi13==3 | vi13==4
	...
	*****************
	gen viviprop_ch=.
	replace viviprop_ch = 0 if vi08==1 | vi08==2
	replace viviprop_ch = 1 if vi08==4	
	replace viviprop_ch = 2 if vi08==3
	replace viviprop_ch = 3 if vi08>=5 & vi08<.
