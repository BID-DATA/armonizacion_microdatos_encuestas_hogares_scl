...
*******************************************************
	...
	****Pregunta: p15 (1 indígena, 2 afroecuatoriano, 3 negro, 4 mulato, 5 montubio, 6 mestizo, 7 blanco, 8 otro) (adiciona categorías afroecuatoriano y montubio) 
	...
	gen byte afro_ci = . 
	replace afro_ci = 1 if pe15 == 2 | pe15 == 3 | pe15 == 4
	replace afro_ci = 0 if pe15 != 2 & pe15 != 3 & pe15 != 4 & pe15 != .
...
gen aguatrat_ch =9
	...
	*************
	...
	replace piso_ch=1 	if vi04a==5| vi04a==6 | vi04a==8 	
	...
	*Modificación Mayra Sáenz Agosto 2013. Se excluye a los que declaran 99 en vi06, que son los que no informan.
	...
	*****************
	gen internet_ch=0
	replace internet_ch=1 if eq1901==1 
	replace internet_ch=. if eq1901==. 
