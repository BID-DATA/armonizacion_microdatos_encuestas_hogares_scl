...
gen ypen_ci=ingjub/1265.285 if ingjub>0 & ingjub!=. & ingjub<9999999
...
*/
	...
	*Modificacion MGD 06/18/2014 solo horas de actividad principal.
	gen subemp_ci=0
	replace subemp_ci=1 if (ratmeh1>=3 & ratmeh1<=8 ) & horaspri_ci<=30 & emp_ci==1
	...
	*****************
	...
	/*
	*En 1991 se categoriza la variable número de trabajos como
	numtrab:
           1 ninguno
           2 uno
           3 mas de uno
	...
	*****************
	/*
	*Para el año 1991 se utiliza la variable pertrabn, la cual toma los siguientes valores:
	pertrabn:
           1 menos de 6
           2 6 a 14
           3 de 15 a 35
		   4
           9 no informa
	No existe la variable que proporciona el número de empleados en valores absolutos.
		   
	*/
	
	gen firmapeq_ci=.
	replace firmapeq_ci=1 if (pertrabn==1)
	replace firmapeq_ci=0 if (pertrabn==2 | pertrabn==3 | pertrabn==4)
...
*tamemp_ci
	...
	gen tamemp_ci=1 if pertrabn==1
label var  tamemp_ci "Tamaño de Empresa" 
*Empresas medianas
replace tamemp_ci=2 if pertrabn==2 | pertrabn==3
*Empresas grandes
replace tamemp_ci=3 if pertrab==4
...
g formal_1=formal_ci
	...
	****************
	...
	gen durades_ci=tiembus if tiembus!=98
...
foreach var of varlist ingobr ingpat ingalq ingjub ///
ingotr ingrl {
...
----------------------------------------------------------------------------------------------------------
ingobr          long   %12.0g                 ingresos como obrero o empleado
...
label var tcylmpri_ci "Identificador de top-code del ingreso de la actividad principal"
	...
	* Tipo de cambio Noviembre 1991. Dólar (compra) = 1265.285
    * Fuente: Banco Central del Ecuador (BCE), 2013.
	
	egen ylm_ci1= rsum(ingobr ingpat) 
	gen ylm_ci= (ylm_ci1/1265.285)
	replace ylm_ci=. if ingpat==. & ingobr==. 
