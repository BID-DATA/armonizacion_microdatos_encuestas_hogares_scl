...
* Base de hogares
import spss "`base_in'\enemdu_viv_hog_201912.sav", clear
...
* Base de personas
import spss "`base_in'\enemdu_persona_201912.sav", clear
...
*****************************************************************************/
merge m:1 id_vivienda id_hogar using "`base_in'\hogares.dta"
duplicates report id_vivienda id_hogar id_persona
