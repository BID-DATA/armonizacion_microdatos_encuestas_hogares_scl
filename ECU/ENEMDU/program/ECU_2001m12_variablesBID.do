...
*******************************************************
	...
	*afro_ci*
	*********
	gen byte afro_ci = . // El cuestionario tiene la pregunta sobre etnicidad, pero las opciones de respuesta no son claras. Hay 6 opciones de respuesta, pero solo 5 valores numericos asignados. 
...
*ypen_ci*
*************
gen ypen_ci=pe66a if pension_ci==1
replace ypen_ci=. if pe66a==999999 
replace ypen_ci=. if pe66a==0
...
label var pea_ci "Población Económicamente Activa"
	...
	*Modificado Mayra Sáenz - Agosto 2013
	/*
              ...
              4    Patron o socio
              5    Cuenta propia
              6    Trab. fam. no remunerado
              7    trab. agrop. a sueldo
              8    Jornalero agropecuario
              9    Patro o socio de la finca
             10    Trab. agrop. cta. propia
             11    Trab. fam. agrop. no remunerado
             12    Empleado domestico
...
/*
	...
	* Ultima actualizacion MGD 4/16/2014
	...
	replace rama_ci = 6 if (rama>=5010 & rama<=5559) & emp_ci==1
	...
	*Modificación Mayra Sáenz - Agosto 2013
	...
	replace antiguedad_ci=. if pe44 ==99
...
foreach var of varlist pe58 pe59a pe60 pe61 pe62a  pe63 ///
 pe65a pe66a pe67a pe68a pe69a {
...
replace `var'=. if `var'== 999992
	...
	***************
	...
	egen ylmpri_ci = rsum(pe58 pe59a pe60 pe61) 
	replace ylmpri_ci =. if pe58==. & pe59a==. & pe60==. & pe61==. 
...
label var tcylmpri_ci "Identificador de top-code del ingreso de la actividad principal"
	...
	***ynlm_ci***
	*************
	replace pe69a = pe69a/100 if pe69a>=1000 & pe69a!=.
	replace pe69a = pe69a/10 if pe69a>=100 & pe69a<=900
	egen ynlm_ci=rsum(pe65a pe66a pe67a pe68a pe69a)
	replace ynlm_ci = . if pe65a==. & pe66a==. & pe67a==. & pe68a==. & pe69a==. 
...
*Mod Ivan B./EDU 2015,12.
	...
	replace aedu_ci = .   			if nivinst==2 // Centro de alfabetización - Educación para adulto
	replace aedu_ci = 0   			if nivinst==3 // Jardin de infantes
	replace aedu_ci= anoinst-1 		if nivinst==4 // Primaria
...
gen aguatrat_ch =9
	...
	* Modificaciones Marcela Rubio Septiembre 2014
	...
	replace piso_ch=1 	if vi02==1 | vi02==2 | vi02==3 	
	replace piso_ch=2 	if vi02==4 | vi02==5 | vi02==6
	...
	**************
	...
	gen resid_ch =0    if vi11==1 | vi11==2
	replace resid_ch=1 if vi11==4
	replace resid_ch=2 if vi11==3
	replace resid_ch=3 if vi11==5
	replace resid_ch=. if vi11==.
	...
	**************
	...
	gen telef_ch=.
	replace telef_ch =1 if vi10==1
	replace telef_ch =0 if vi10==2
	...
	*************
	...
	gen auto_ch=0
	replace auto_ch=1 if eq0112==1
	replace auto_ch=. if eq0112==.
	...
	**************
	...
	gen compu_ch=0
	replace compu_ch=1 if eq0104==1
	replace compu_ch=. if eq0104==.
	...
	*****************
	...
	replace viviprop_ch=3 if vi01==4 | vi01==5
