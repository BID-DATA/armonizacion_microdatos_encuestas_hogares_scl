...
*gen ypen_ci=ingjub
* MGD12/17/2015: faltaba dividir por el tipo de cambio
gen ypen_ci=ingjub/16867 if ingjub>0 & ingjub!=. & ingjub<99999999
...
g formal_1=formal_ci
	...
	****************
	...
	gen durades_ci=tiembus if tiembus!=88
...
ingpat	long	%12.0g		ingresos como patrono o
				cuenta propia
ingasg	long	%12.0g		ingresos como asalariado
				de gobierno
ingepv	long	%12.0g		ingreso asalariado
				empresa privada
ingdom	long	%12.0g		ingreso como empleada doméstica



ingjub	long	%12.0g		ingresos por jubilación o
				pensión
ingalq	long	%12.0g		ingreso por alquileres,
				rentas o intereses
...
*/
	...
	*El año 1999 la ENEMDU no levanta informacion de vivienda (no existe este modulo)
