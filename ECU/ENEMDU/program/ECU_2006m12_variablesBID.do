...
tostring idp_ci, replace
	...
	**************
	...
	gen civil_ci=.
	replace civil_ci= 1 if pe13c==6
	replace civil_ci= 2 if pe13c==1 | pe13c==5
	replace civil_ci= 3 if pe13c==2 | pe13c==3
	replace civil_ci= 4 if pe13c==4
...
****condocup_ci*
****************
/*gen gesbuscatra = (pe30a<9 | pe30b<9)
*2014, 01 MLO cambio del limite de edad de condocup_ci a 5+
gen condocup_ci=.
...
label var pea_ci "Población Económicamente Activa"
	...
	***************
	/*
	gen subemp_ci=0
	replace subemp_ci=1 if (hormas==1) & horastot_ci<=30 & emp_ci==1
...
* Line of code with indicator edusc_ci was deleted* Line of code with indicator edusc_ci was deleted* Line of code with indicator edusc_ci was deleted
	...
	***eduui_ci***
	**************
	gen byte eduui_ci = (inlist(nivinst, 8, 9) & pe10a1 == 2)
	...
	***eduuc_ci***
	***************
	gen byte eduuc_ci = ((inlist(nivinst, 8, 9) & pe10a1 == 1) | nivinst == 10)
...
* Line of code with indicator pqnoasis_ci was deleted	**************
    recode pe08 (13=17)	// JV: No tiene opción "Falta de recursos tecnológicos". Recoded accordingly
...
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted	
    ...
    **************
    ...
    replace pqnoasis1_ci = 5 if pe08 == 8  | pe08 == 12 | pe08 == 15
    replace pqnoasis1_ci = 6 if pe08 == 2
    replace pqnoasis1_ci = 7 if pe08 == 1 
    replace pqnoasis1_ci = 8 if pe08 == 10 | pe08 == 13
    replace pqnoasis1_ci = 9 if pe08 == 4 | pe08 == 6 | pe08 == 14 | pe08 == 16 | pe08 == 17
...
gen aguatrat_ch =9
	...
	* Modificaciones Marcela Rubio Septiembre 2014
	...
	replace piso_ch=1 	if vi03==1 | vi03==2 | vi03==3 	
	replace piso_ch=2 	if vi03==4 | vi03==5 | vi03==6
	...
	*/
	...
	replace piso_ch=0 	if vi03==6
	replace piso_ch=1 	if vi03==1 | vi03==2 | vi03==3 	
	replace piso_ch=2 	if vi03==4 | vi03==5 | vi03==7
	label var piso_ch "Materiales de construcción del piso"  
	label def piso_ch 0"Piso de tierra" 1"Materiales permanentes" 2"Otros materiales"
	label val piso_ch piso_ch
	...
	**************
	...
	generat resid_ch=0 if vi11==1 | vi11==2
	...
	**************
	...
	replace telef_ch=0 if vi1415a ==2
