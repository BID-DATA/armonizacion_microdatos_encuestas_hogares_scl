...
*gen ypen_ci=ingjub
* MGD 12/17/2015: faltaba divir para el tipo de cambio
gen ypen_ci=ingjub/3510 if ingjub>0 & ingjub!=. & ingjub<9999999
...
label value tipocontrato_ci tipocontrato_ci
	...
	***nempleos_ci***
	*****************
	*En 1996 se categoriza la variable número de trabajos como
	/*
	numtrab:
           3 ninguno
           4 uno
...
*Ingrl se construye en base a los ingresos anteriores, por eso no se la toma en cuenta.
