...
*****************
gen aguafuente_ch = 0
replace aguafuente_ch = 1 if vi16==1 | vi16==2
replace aguafuente_ch = 2 if vi16==3
replace aguafuente_ch = 5 if vi16==8
replace aguafuente_ch = 6 if vi16==5
replace aguafuente_ch = 8 if vi16==7
replace aguafuente_ch = 10 if (vi16==6|vi16==9|vi16==4)
...
*****************
gen bano_ch=6
replace bano_ch=0 if vi15==5
replace bano_ch=1 if vi15==1
replace bano_ch=2 if vi15==2
replace bano_ch=3 if vi15==3 
replace bano_ch=6 if vi15==4
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if vi15!=5
