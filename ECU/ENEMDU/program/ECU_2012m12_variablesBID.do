...
gen tamemp_o=.
replace tamemp_o=1 if (p47b>=1 & p47b<=9)
replace tamemp_o=2 if p47b>=10 & p47b<50
replace tamemp_o=3 if (p47b>=50 & p47b!=.)
...
label var tcylmpri_ci "Identificador de top-code del ingreso de la actividad principal"
	...
	**************
	...
	label def pqnoasis_ci 1"edad" 2"terminó sus estudios" 3"falta recursos económicos" 4"fracaso escolar" 5"por trabajo" 6"temor maestros" 7"enfermedad o discapacidad" 8"quehaceres del hogar" 9"familia no permite" 10"no hay establecimientos educativos" 11"no está interesado" 12"por embarazo" 13"por falta de cupo" 14"Temor a los compañeros" 15"Cuidar a los hijos" 16"Falta de recursos tecnologicos" 17"Otra razón" 
...
gen aguatrat_ch =9
	...
	*******************
	...
	gen migrante_ci=(p15aa0==3) if p15aa0!=.
