...
label var pea_ci "Población Económicamente Activa"
	...
	***** El código mantiene como población de referencia a las personas inactivas (condocup_ci == 3) *****.
	...
	replace desalent_ci = 1 if ((bustrama == 11 & (motnobus == 6 | motnobus == 7)) & condocup_ci == 3)
...
gen aguatrat_ch =9
	...
	*************
	...
	replace piso_ch=1 	if vi04a>=1 & vi04a<=4
	...
	***pared_ch***
	**************
	gen pared_ch=0 		if vi05a==5 |vi05a==6 
	replace pared_ch=1	if vi05a>=1 & vi05a<=4
	replace pared_ch=2	if vi05a==7
	...
	***techo_ch***
	**************
	gen techo_ch=0 		if  vi03a==5 
	replace techo_ch=1	if  vi03a>=1 & vi03a<=4
	replace techo_ch=2	if  vi03a==6	
	label var techo_ch "Materiales de construcción del techo"
	label def techo_ch 0"No permanentes" 1"Permanentes" 2"Otros materiales: naturales, otros"
	...
	*Se excluye a los que declaran 99 en vi05, que son los que no informan.
	...
	*Se excluye a los que declaran 99 en vi06, que son los que no informan.
	...
	**************
	gen compu_ch=0
	replace compu_ch=1 if eq0401==1
	replace compu_ch=. if eq0401==.
	...
	*****************
	gen internet_ch=0
	replace internet_ch=1 if eq1601==1 
	replace internet_ch=. if eq1601==. 
	...
	************
	gen cel_ch=0
	replace cel_ch=1 if s701a==1 
	replace cel_ch=. if s701a==. 
	...
	*****************
	...
	replace viviprop_ch=3 if  vi14>=5 &  vi14<=7
