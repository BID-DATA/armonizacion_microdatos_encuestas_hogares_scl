...
* MGR Febrero 2016
egen idh_ch = group(codusu ciudad) 
...
*miembros_one_ci*
*****************
gen miembros_one_ci = inrange(h08,1,9)
...
replace ocupa_ci = 6 if (p20>=611 & p20<=679) & emp_ci==1 																									
...
replace cotizando_ci = 1 if (inlist(benef2, 11, 12, 14) & emp_ci==1)
