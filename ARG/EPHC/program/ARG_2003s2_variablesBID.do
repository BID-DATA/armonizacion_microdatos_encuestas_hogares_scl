...
**
	...
	* region_c *
	************
*Modificación Mayra Sáenz - Junio 2014: Se sigue la sintaxis de ARG 2003 s2
gen region_c=.
...
*/
	...
	*ser estas. ESTO SE DEBE DISCUTIR 
	...
	/* MGR Jul, 2015: se corrige sintáxis 
...
* Line of code with indicator edusc_ci was deletedreplace aedu_ci=14 	if aedu_ci==. & eduui_ci==1
...
* ARG 2003 - IISem
*2015 MGD: promedio de julio a diciembre
gen salmm_ci= 275	/*350*/
