...
tostring idp_ci, replace
	...
	*gen anio_c=ano4
	/*yl: se debe generar esta variable "anio_c" manualmente ya que este semestre esta conformado por 
	      el 4to trimestre del año 2007 y el 1er trimestre del 2008.*/
...
*Note: se debe considerar pp07i tambien?
	...
	*************
	...
	gen nempleos_ci=1 if pp03c==1
	replace nempleos_ci=2 if pp03c==2
...
*********
capture drop lp_ci
gen lp_ci = 309.16 if trimestre==2
replace lp_ci= 315.04 if trimestre==1
...
gen lpe_ci = 143.57 if trimestre==2
replace lpe_ci= 145.71 if trimestre==1
...
* ARG 2007 - IVTrim
* 2015 MGD: Promedio del semestre
gen salmm_ci= 	973
