...
g tamemp_o=1 if (pp04c >=1 & pp04c <= 6)
replace tamemp_o=2 if (pp04c >=7 & pp04c <= 8)
replace tamemp_o=3 if (pp04c >=9 & pp04c <= 12)

label var tamemp_o "# empleados en la empresa segun rangos_OECD"
label define tamemp_o 1 "[1-9]" 2 "[10-50]" 3 "{50y mas]"
