...
*Nota: Se deberia incrementar la categoria 4 "hay poco trabajo en esta epoca del anio"
*/
...
replace nempleos_ci=2 if pp03d>1
...
*Nota: A los empleados e independientes se les esta dejando un maximo de 5 anios de antiguedad.
...
*salmm_ci*
**********
*** se ituliza el último incremento del año: 
*Salario mínimo fijado en enero 2024
*https://www.argentina.gob.ar/normativa/nacional/resoluci%C3%B3n-17-2024-407686/texto
* fuente oficial
