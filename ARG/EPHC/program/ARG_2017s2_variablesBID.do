...
*SGR: En la versiÃ³n 2017 no estÃ¡ en string la variable.
...
**************************** 
	...
	*ln_ci***
	*********
	gen ln_ci =  17223/3.49
	
	*********
	*lpe_ci***
	*********
	gen lpe_ci =  6665/3.30

* https://www.indec.gob.ar/uploads/informesdeprensa/eph_pobreza_02_17.pdf pÃ¡gina 9. Canasta Basica y Total promedio del hogar/Tamaño promedio del hogar pobre en adulto equivalente
