...
/*	* en esta base no esta bien la variable intensi
gen tot=pp3e_tot+pp3f_tot
gen aux=1 if pp03g==1 & tot<30 & estado==1 &intensi>=1 & intensi<3
gen subemp_ci=.
replace subemp_ci=1 if aux==1
recode subemp_ci .=0 if intensi==3 | intensi==4 | intensi==5
replace subemp_ci=0 if intensi==3
tab subemp_ci
drop aux*/
...
* Mod. 8/2015 Ivan Bonacelli EDU/SLC
   *Ajustando variables
	...
	replace ch12=. if ch12==99 | ch12==9 // Missing a educación especial 
