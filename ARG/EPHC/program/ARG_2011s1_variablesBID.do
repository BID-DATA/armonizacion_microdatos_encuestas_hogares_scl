...
label value ocupa_ci ocupa_ci
	...
	*rama_ci*
	*********
	* 2014, 12 MLO cambio la clasificacion a CAES 01 y por lo tanto debe cambiarse la codificacion 
replace pp04b_caes="9999" if pp04b_caes=="Z   " 
replace pp04b_caes="9999" if pp04b_caes=="C   "
destring pp04b_caes, replace

gen rama_ci = .
replace rama_ci = 1 if (pp04b_caes==1)|(pp04b_caes>=101 &  pp04b_caes<=300)
replace rama_ci = 2 if (pp04b_caes>=500 & pp04b_caes<=900) 
replace rama_ci = 3 if (pp04b_caes>=1000 & pp04b_caes<=3300) |  pp04b_caes==10 |  pp04b_caes==19  |  pp04b_caes==20 |  pp04b_caes==21 |  pp04b_caes==26
replace rama_ci = 4 if (pp04b_caes>=3500 & pp04b_caes<=3900) |  pp04b_caes==35 
replace rama_ci = 5 if (pp04b_caes==4000)
replace rama_ci = 6 if (pp04b_caes>=4500 & pp04b_caes<4900) | pp04b_caes==48 | (pp04b_caes>=5500 & pp04b_caes<=5602)
replace rama_ci = 7 if (pp04b_caes>=4900 & pp04b_caes<=5300) | pp04b_caes==49
replace rama_ci = 8 if (pp04b_caes>=6400 & pp04b_caes<=6800) 
replace rama_ci = 9 if (pp04b_caes>=5800 & pp04b_caes<=6300) |(pp04b_caes>=6900 &  pp04b_caes<=9900) | pp04b_caes==85 | pp04b_caes==63 | pp04b_caes==61  | pp04b_caes==58
replace rama_ci = 0 if pp04b_caes==9999
...
* 2014, 12 MLO cambio la clasificacion y por lo tanto debe cambiarse la codificacion (pendiente)
* pp04b_caes	
*aunque para 2011 aun estan ambas clasificaciones disponibles en la base
...
egen ypen_ci=rsum(v2_m aguinpen)
