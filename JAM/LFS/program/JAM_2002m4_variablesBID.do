...
Round: Abril, 2002
Autores:
Generacion de nuevas variables LMK : Yessenia Loayza (yessenial@iadb.org / desloay@hotmail.com)
...
*  factor de expansión  *
*************************
** No hay factor de expansión al 2002
** POBLACION DA JAMAICA AL 2002 = 2664984 **


gen pop = _N
gen factor_ch=round((2664984/pop))
drop pop
...
***************************
*Existe la variable ur2 y ur3, pero ninguna suma
* el total de observaciones en la base.
gen zona_c=.
...
*lp_ci***
*********
*destring UR2, replace
gen lp_ci=.
/*50640.40 if UR2==1
replace lp_ci=48262.30 if UR2==2
replace lp_ci=44940.10 if UR2==3
...
gen lpe_ci=.
/*31591.49 if UR2==1
replace lpe_ci=31086.23 if UR2==2
replace lpe_ci=30787.13 if UR2==3
label var lpe_ci "Linea de pobreza extrema local (Adulto Equivalente)"*/

*********
*salmm_ci***
*********
gen salmm_ci=1800*4.3
...
replace condocup_ci=3 if (q21>=4 & q21<=9) & (q24==1 & q25>=3 & q25<=9) | q24==2
replace condocup_ci=3 if (q21>=5 & q21<=6) & q22==.
replace condocup_ci=4 if edad_ci<14
label define condocup_ci 1"ocupados" 2"desocupados" 3"inactivos" 4"menor de PET"
label value condocup_ci condocup_ci
label var condocup_ci "Condicion de ocupacion utilizando definicion del pais"
...
replace rama_ci=2 if (q39m>=1500 & q39m<=1999) & emp_ci==1
...
replace rama_ci=6 if (q39m>=6000 & q39m<=6799) & emp_ci==1
replace rama_ci=7 if (q39m>=7000 & q39m<=7399) & emp_ci==1
replace rama_ci=8 if (q39m>=8000 & q39m<=8399) & emp_ci==1
...
*Jamaica No se puede generar con los siguientes intervalos:
*Pequeña 1 a 5, Mediana 6 a 50, Grande Más de 50, porque la variable vine con categor'ias distintas.
