...
*  factor de expansión  *
*************************
** No hay factor de expansión 1995
** POBLACION DA JAMAICA  1995 = 2,533,704 **


gen pop = _N
gen factor_ch=round((2533704/pop))
drop pop
...
*********
gen lp_ci=.
*gen lp_ci=28410.37 if area==1
*replace lp_ci=27076.22 if area==2
*replace lp_ci=25212.41 if area==3
...
drop rama1
*/
recode q39m (719=7190) (312=3120) (311=3110) (212=2120) (1314=134) (1122=112)
g rama_ci=.
replace rama_ci=1 if (q39m>=100 & q39m<=900)
replace rama_ci=2 if (q39m>=1500 & q39m<=1899)
replace rama_ci=3 if (q39m>=2000 & q39m<=3499) 
replace rama_ci=4 if (q39m>=4000 & q39m<=4299) 
replace rama_ci=5 if (q39m>=5000 & q39m<=5599) 
replace rama_ci=6 if (q39m>=6000 & q39m<=6700) 
replace rama_ci=7 if (q39m>=7000 & q39m<=7299) 
replace rama_ci=8 if (q39m>=8000 & q39m<=8299) 
replace rama_ci=9 if (q39m>=8300 & q39m<=9900) 
...
*subemp_ci*
***********
* Nota MGD 7/30/2014: la variable de horas no tiene cruce con la variable de condicion de ocupacion- problema de la base.
* Por esta razon se genera con missing
g subemp_ci=.
/*
...
gen tiempoparc_ci=1 if q33<30 & q35==3
