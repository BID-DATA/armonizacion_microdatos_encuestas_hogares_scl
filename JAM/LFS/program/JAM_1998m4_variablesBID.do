...
*  factor de expansión  *
*************************
/* Modificado Mayra Sàenz Agosto 2013. Con este factor de expansión la población llega a  256000070614 individuos, cuando la población de 
Jamaica al año 1998 fue de 2560432 habitantes (PennWorldTable 7.1, 2013).
Por lo tanto es necesario cambiar las ponderaciones de la misma manera que se trabajó en el año 2002. 
*/
** POBLACION DA JAMAICA AL 1998 =2560432 **
destring rfact, replace
qui sum rfact
scalar pob=r(sum)
gen pop=rfact*(2560432/pob)
sum pop
ret list
gen factor_ch=pop 
drop pop
...
*lp_ci***
*********
gen lp_ci=38764.09 if ur==1
replace lp_ci=36943.73 if ur==2
replace lp_ci=34400.68 if ur==3
...
*********
gen lpe_ci=. if ur==1
replace lpe_ci=. if ur==2
replace lpe_ci=. if ur==3
