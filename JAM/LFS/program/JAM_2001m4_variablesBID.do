...
*lp_ci***
*********
gen lp_ci=47293.70 if ur1==1
replace lp_ci=45072.80 if ur1==2
replace lp_ci=41970.20 if ur1==3
label var lp_ci "Linea de pobreza local (Adulto Equivalente)"

*********
*lpe_ci***
*********
gen lpe_ci=29503.70 if ur1==1
replace lpe_ci=29031.80 if ur1==2
replace lpe_ci=28752.50 if ur1==3
