...
gen durades_ci=(1+4.3)/2/4.3 if q41==1
...
*antiguedad_ci*
***************
* NOTA mgd 09/25/2014: Problemas con la variable original, no coincide con la tendencia de anios anteriores ni posteriores.
* Se prefiere dejarla como missing
gen antiguedad_ci=.
...
gen condocup_ci =.
*Ocupado*
replace condocup_ci=1 if q211==1 | q211==2 |  q22==1  | q23==1 
*Desocupado*
...
gen emp_ci=1 if q211==1 |  q211==2 |  q22==1  | q23==1 
