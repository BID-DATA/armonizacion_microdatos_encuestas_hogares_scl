...
egen idh_ch = group(enum parish constit enumdis dwell hhld)
...
/*
recode q323a(9999999=.)
gen ylm_ci=.

replace ylm_ci=q323a if q323b==4
replace ylm_ci=q323a*4.2 if q323b==1
replace ylm_ci=q323a/12 if q323b==7
label var ylm_ci "Ingreso laboral monetario total"
*/

* Modificaciones Marcela Rubio Septiembre 2014: corrección outliers
...
replace ylm_ci=q323a*4.2 if q323b==1
replace ylm_ci=q323a/12 if q323b==7
replace ylm_ci = . if ylm_ci>200000
label var ylm_ci "Ingreso laboral monetario total"
...
******************************
 recode q323c(9999999=.)
gen ynlm_ci=.
replace ynlm_ci=q323c if q323d==4
replace ynlm_ci=q323c*4.2 if q323d==1
replace ynlm_ci=q323c/12 if q323d==7
...
*2014, 01 MLO cambio del limite de edad de condocup_ci a 10+
*Ocupado*
gen condocup_ci=1 if activlw==1 | activlw==2 |  worklw==1  | abswrklw==1 
*Desocupado*
replace condocup_ci=2 if (activlw==3 | (q43>=1 & q43<=2) | q44==3 | q44==6 | (q41>=1 & q41<=5) |  (q42 >=1 & q42 <=7)) & condocup_ci==.
*Inactivo*
...
gen condocup_ci =.
replace condocup_ci=1 if activlw==1 | activlw==2 |  worklw==1  | abswrklw==1 
replace condocup_ci=2 if condocup_ci!=1 & (((worklw==2  | abswrklw==2 ) & activlw==3) | (wntwrklw==1 & (notwrklw==1 | notwrklw==2)))  
...
gen emp_ci=1 if activlw==1 |  activlw==2 |  worklw==1  | abswrklw==1 
...
replace categoinac_ci = 2 if (activlw == 5 & condocup_ci==3)
replace categoinac_ci = 3 if (activlw == 4 & condocup_ci==3)
...
*/
g rama_ci=.
replace rama_ci=1 if (q39>=100 & q39<=900) & emp_ci==1
replace rama_ci=2 if (q39>=1500 & q39<=1899) & emp_ci==1
replace rama_ci=3 if (q39>=2000 & q39<=3499) & emp_ci==1
replace rama_ci=4 if (q39>=4000 & q39<=4299) & emp_ci==1
replace rama_ci=5 if (q39>=5000 & q39<=5599) & emp_ci==1
replace rama_ci=6 if (q39>=6000 & q39<=6399) & emp_ci==1
replace rama_ci=7 if (q39>=7000 & q39<=7299) & emp_ci==1
replace rama_ci=8 if (q39>=8000 & q39<=8299) & emp_ci==1
replace rama_ci=9 if (q39>=8300 & q39<=9900) & emp_ci==1

/* Intento de codificacion segun CIIU REV. 3. MGD 04/29/2014
g rama_ci=.
replace rama_ci=1 if (q39>=111 & q39<=311) & emp_ci==1
replace rama_ci=2 if (q39>=1010 & q39<=1429) & emp_ci==1
replace rama_ci=3 if (q39>=1510 & q39<=3720) & emp_ci==1
replace rama_ci=4 if (q39>=4010 & q39<=4200) & emp_ci==1
replace rama_ci=5 if (q39>=4510 & q39<=4550) & emp_ci==1
replace rama_ci=6 if (q39>=5010 & q39<=5590) & emp_ci==1
replace rama_ci=7 if (q39>=6010 & q39<=6420) & emp_ci==1
replace rama_ci=8 if (q39>=6510 & q39<=7020) & emp_ci==1
replace rama_ci=9 if (q39>=7111 & q39<=9900) & emp_ci==1
*/
...
* Modificaciones Marcela Rubio Septiembre 2014: corrección en sintaxis

* primaria para ocupados, desocupados e inactivos
gen aedu_ci = .
replace aedu_ci = 0 if q319==0 | q421==0 | q514==0 | q319==1 | q421==1 | q514==1  
replace aedu_ci = 1 if q319==2 | q421==2 | q514==2  
replace aedu_ci = 2 if q319==3 | q421==3 | q514==3  
replace aedu_ci = 3 if q319==4 | q421==4 | q514==4  
replace aedu_ci = 4 if q319==5 | q421==5 | q514==5  
replace aedu_ci = 5 if q319==6 | q421==6 | q514==6  
replace aedu_ci = 6 if q319==7 | q421==7 | q514==7 
*secundaria para ocupados, desocupados e inactivos
replace aedu_ci = 7 if q319==8 | q421==8 | q514==8 | q320==2 |  q422==2  | q515==2
replace aedu_ci = 8 if q320==3 |  q422==3  | q515==3
replace aedu_ci = 9 if q320==4 |  q422==4  | q515==4
replace aedu_ci = 10 if q320==5 |  q422==5  | q515==5
replace aedu_ci = 11 if q320==6 |  q422==6  | q515==6
*no hay pregunta sobre educación superior en cuestionario
...
afro_ci ind_ci noafroind_ci afroind_ci afro_ch ind_ch noafroind_ch afroind_ch dis_ci disWG_ci dis_ch JAM_dis_ci /// Diversidad
