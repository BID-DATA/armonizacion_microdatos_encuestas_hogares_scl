...
*2014, 09 Mayra Sáenz el identificador de hogares no está bien definido.
*revisar el ingreso del hogar que se produce con este identificador. Se obtiene el mismo valor para 
*todos los hogares.
****************************************************************************/
...
*Se debe revisar, pues no existe la variable enum como en la base de 1990 ronda m5
*Con la sintaxis anterior se generaban más de 2000 miembros por hogar. Ahora el máximo es 14.
egen idh_ch = concat(par const edno dwell hhld indv)
****************************
...
gen condocup_ci =.
*Ocupado*
replace condocup_ci=1 if q211==1 | q211==2 |  q221==1  | q231==1 
*Desocupado*
...
*durades_ci*
************
gen durades_ci=(1+4.3)/2 if q41==1
...
replace antiguedad_ci=(1+4.3)/2 if q310==1
replace antiguedad_ci=(1+3)/2 if q310==2
replace antiguedad_ci=(3+6)/2 if q310==3
replace antiguedad_ci=(6+9)/2 if q310==4
replace antiguedad_ci=(9+12)/2 if q310==5
replace antiguedad_ci=(12+24)/2 if q310==6
...
gen categoinac_ci=.
*gen categoinac_ci=1 if q211==4
label var  categoinac_ci "Condición de Inactividad" 
*Estudiantes
*replace categoinac_ci=2 if q211==5
*Quehaceres del Hogar
*replace categoinac_ci=3 if q211==
*Otra razon
*replace categoinac_ci=4 if q211==6 | q211==7
...
gen emp_ci=1 if q211==1 |  q211==2 |  q221==1  | q231==1 
