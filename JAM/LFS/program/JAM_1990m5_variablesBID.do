...
*********
gen lp_ci=.
*gen lp_ci=5431.69 if area==1
*replace lp_ci=5176,60 if area==2
*replace lp_ci=4820,27 if area==3
...
replace rama_ci=2 if (q39>=1100 & q39<=1900) & emp_ci==1
replace rama_ci=3 if (q39>=2000 & q39<=3999) & emp_ci==1
replace rama_ci=4 if (q39>=4000 & q39<=4999) & emp_ci==1
replace rama_ci=5 if (q39>=5000 & q39<=5999) & emp_ci==1
replace rama_ci=6 if (q39>=6000 & q39<=6999) & emp_ci==1
replace rama_ci=7 if (q39>=7000 & q39<=7999) & emp_ci==1
replace rama_ci=8 if (q39>=8000 & q39<=8999) & emp_ci==1
replace rama_ci=9 if (q39>=9000 & q39<=9900) & emp_ci==1
...
gen categoinac_ci=1 if activlw==4
label var  categoinac_ci "Condición de Inactividad" 
*Estudiantes
replace categoinac_ci=2 if activlw==5
*Otra razon
replace categoinac_ci=4 if activlw==6 | activlw==9
...
*secundari para ocupados, desocupados e inactivos
