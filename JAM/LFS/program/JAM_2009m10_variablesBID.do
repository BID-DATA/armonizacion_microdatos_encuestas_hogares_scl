...
Encuesta: LFS
Round: Octubre, 2009
Autores: (yessenial@iadb.org / desloay@hotmail.com)
...
*lp_ci***
*********
gen lp_ci=110099.56 if urcode==1
...
gen aedu_ci=.
replace aedu_ci=q320a if q320<9
replace aedu_ci=q321a if q321a>0 & q321a<9

replace aedu_ci=q421a if q421<9
