...
* Modificaciones Marcela Rubio Septiembre 2014: removiendo outliers
...
replace ylmpri_ci=q325a*4.2 if q325ap==1
replace ylmpri_ci=q325a/12 if q325ap==7
replace ylmpri_ci = . if ylmpri_ci>500000
...
replace ylm_ci=q325a*4.2 if q325ap==1
replace ylm_ci=q325a/12 if q325ap==7
replace ylm_ci = . if ylm_ci> 500000
...
*********
gen lp_ci=.
*gen lp_ci=104736.56 if urcode==1 /*Me parece q es inconsistente con el salario mínimo y la línea de pobreza*/
*calculada.
...
/* Salario generado por el consultor
*********
*salmm_ci***
*********
gen salmm_ci=3700
