...
*  factor de expansión  *
*************************
** No hay factor de expansión para 1996, así que se genera uno dividiendo obs y población
** POBLACION DA JAMAICA 1996 = 2,558,630**


gen pop = _N
gen factor_ch=round((2558630/pop))
drop pop
...
replace rama_ci=7 if (q39m>=7000 & q39m<=7299) & emp_ci==1
replace rama_ci=8 if (q39m>=8000 & q39m<=8299) & emp_ci==1
replace rama_ci=9 if (q39m>=8300 & q39m<=9900) & emp_ci==1
