...
***************************
*Las variables de zona (ur) que constan en la base son vectores de valores perdidos.
gen zona_c=.
**********************************
* país***************************
...
*********
gen lp_ci=.
*gen lp_ci=44453 if area==1
*replace lp_ci=42365.50 if area==2
*replace lp_ci=39449.20 if area==3
...
*********
gen lpe_ci=.
*gen lpe_ci=25823.30 if area==1
*replace lpe_ci=25410.30 if area==2
*replace lpe_ci=25165.80 if area==3
