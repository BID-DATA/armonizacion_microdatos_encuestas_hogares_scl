...
***************************
destring ur, replace
gen zona_c=1 if ur == 1 | ur == 2
replace zona_c = 0 if ur ==3
...
* MGD 9/19/2016: se genera como missing porque son diferentes las categorías y se genera un salto.
...
destring q21 q22 q23 q25 q24 q43 q44, replace
*Se modifico segun la edad minima de la encuesta de 14 anios y la sintaxis. MGD 06/10/2014
gen condocup_ci =.
replace condocup_ci=1 if q21==1 | q21==2 |  q22==1  | q23==1
...
* Cesante *
***********
* MGD 12/18/2015: solo contestan los inactivos, por eso se genera como missing
g cesante_ci=.
...
*********
destring ur, replace
gen lp_ci=41400 if ur==1
replace lp_ci=39455.90 if ur==2
replace lp_ci=36739.90 if ur==3
label var lp_ci "Linea de pobreza local (Adulto Equivalente)"

*********
*lpe_ci***
*********
gen lpe_ci=25823.30 if ur==1
replace lpe_ci=25410.30 if ur==2
replace lpe_ci=25165.80 if ur==3
label var lpe_ci "Linea de pobreza extrema local (Adulto Equivalente)"

*********
*salmm_ci***
*********
gen salmm_ci=1200*4.3
...
*/
g rama_ci=.
replace rama_ci=1 if (q39m==0) & emp_ci==1
replace rama_ci=2 if (q39m==1000) & emp_ci==1
replace rama_ci=3 if (q39m>=2000 & q39m<=3000) & emp_ci==1
replace rama_ci=4 if (q39m==4000) & emp_ci==1
replace rama_ci=5 if (q39m==5000) & emp_ci==1
replace rama_ci=6 if (q39m==6000) & emp_ci==1
replace rama_ci=7 if (q39m==7000) & emp_ci==1
replace rama_ci=8 if (q39m==8000) & emp_ci==1
replace rama_ci=9 if (q39m==9000) & emp_ci==1
...
afro_ci ind_ci noafroind_ci afroind_ci afro_ch ind_ch noafroind_ch afroind_ch dis_ci disWG_ci dis_ch JAM_dis_ci ///
