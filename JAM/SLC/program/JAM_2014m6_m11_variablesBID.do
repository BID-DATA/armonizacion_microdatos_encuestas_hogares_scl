...
label define mes_c 6"JUN" 7"JUL" 8"AUG" 9"SEP" 10"OCT" 11"NOV" 12"DIC"
...
*Modificacion Daniela Zuluaga- Enero 2018 Population 2014= 2862000

sum finwght
scalar pob=r(sum)
gen pop=finwght*(2862000/pob)
...
replace spublico=. if (m10==. | m10==45 | m10==98)
...
replace b21= . if (b21==97 | b21==98 | b21==99)
...
gen edupre_ci= (aedu_ci==1 & b21==1)
replace edupre_ci=. if aedu_ci==. & b21==.
...
gen tecnica_ci=(b1==9 | b21==10)
replace tecnica_ci=. if (b1==. & b21==.)
...
gen distance = .
replace distance = i33_1*1000 if i33_2 ==1
replace distance = i33_1 if i33_2 ==2
...
gen combust_ch=(i45==1 | i45==2)
replace combust_ch=. if i45==.
...
g resid_ch =.
replace resid_ch=0 if (i43==1 | i43==2 | i43==3)
replace resid_ch=1 if (i43==4 | i43==5)
replace resid_ch=2 if (i43==6 | i43==7 | i43==8 | i43==9)
...
gen telef_ch  =(i38_1==1)
replace telef_ch=. if i38_1==.
...
g compu_ch  = (i40==1 | i40==2 | i40==3 | i40==4)
replace compu_ch=. if i40==.
...
gen internet_ch =(i41==1)
replace internet_ch=. if i41==.

**********
* cel_ch *
**********

gen cel_ch  =(i38_2==1 | i38_3==1)
