...
*Modificacion María Reyes Retana - Agosto 2022 Population 2019= 2,948,000

sum finwght
scalar pob=r(sum)
gen pop=finwght*(2948000/pob)
...
****************
gen pension_ci=.
replace pension_ci=1 if (d9a==1 | d9b==1 |d9c==1 | d9d==1)
replace pension_ci=0 if (d9a==2 & d9b==2 & d9c==2 & d9d==2)
...
gen refrig_ch=.
*se puede generar con j, pero tiene problemas pegar la base
************
* freez_ch *
************
