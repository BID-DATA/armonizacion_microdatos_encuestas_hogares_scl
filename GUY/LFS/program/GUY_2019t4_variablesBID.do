...
replace desalent_ci = 1 if (q2_14 == 2 & inlist(q2_17, 9, 10) & condocup_ci == 3)
...
gen tiempoparc_ci=(q3_02<=30 & q3_11==2) 
...
destring q3_29, replace force
gen byte cotizando_ci = . 
replace cotizando_ci = 1 if ((q3_26==1 | inlist(q3_29, 1, 2)) & emp_ci==1)
