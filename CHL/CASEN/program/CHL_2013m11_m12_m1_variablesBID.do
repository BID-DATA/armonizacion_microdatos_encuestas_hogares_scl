...
s34. ¿Tiene Ud. alguna de las siguientes condiciones permanentes y/o de larga duración?
...
gen dis_ch=. 
	...
	*ISOalpha3_dis_ci*
	******************
/*s34t1=> s31. ¿Tiene Ud. alguna de las siguientes condiciones permanentes
...
9. Sin dato */
gen byte CHL_dis_ci =.
replace  CHL_dis_ci =0 if s34t1==7
replace  CHL_dis_ci =. if s34t1==9
replace  CHL_dis_ci =1 if s34t1>=1 & s34t1<=6
...
label val rama_ci rama_ci
		...
		**************
/* Nota:
yopraj = ingreso ocupacion principal
...
* ylnmpri_ci   * 
**************** 
*https://observatorio.ministeriodesarrollosocial.gob.cl/storage/docs/casen/2013/CEPAL_Informe_Medicion_Ingresos_Encuesta_Casen_2013(Metodologia_Tradicional).pdf
...
***eduui_ci***
**************
gen byte eduui_ci = inlist(e6a, 11, 12) & e6c == 2
...
***eduuc_ci****
***************
gen byte eduuc_ci = (inlist(e6a, 11, 12) & e6c == 1) | e6a == 13
...
*tipopen_ci*****
****************
*https://observatorio.ministeriodesarrollosocial.gob.cl/storage/docs/casen/2013/Libro_de_Codigos_Casen_2013_Base_Principal_Metodologia_Nueva.pdf
...
*Es la Jubilación o Pensión de Vejez. JANET PORRAS. 24/11/25
...
*SE AHNADIO LA CAT. "CON CONTRATO" SEGUN METODOLOGIA. JANET PORRAS. 26/11/12 
gen     tipocontrato_ci=.
replace tipocontrato_ci=0 if ((o17==1 | o17==2) & o16==9) & categopri_ci==3
...
**pension_ci*
*************
*AJUSTADO A LOS QUE REPORTAN EN LA VARIABLE instpen_ci. JANET PORRAS. 24/11/25
gen pension_ci=1 if y27ai<9 & y27ai !=.
recode pension_ci .=0 
...
*y2009aj: Monto pension basica solidaria de vejez
*y2010aj: Monto pension basica solidaria de invalidez
*y2601aj: aporte previsional solidario de vejez
*y2602aj: aporte previsional solidario de invalidez
*SE AGREGO LOS APORTES PREVISIONALES POR VEJEZ E INVALIDEZ. JANET PORRAS. 26/11/12 
egen auxpens=rsum(y2009aj y2010aj y2601aj y2602aj), missing
...
*Si no se especifica el pais de la madre se considera missing. JANET PORRAS. 26/11/25	
	...
	replace   migrante_ci=. if (r1b==3 & r1b_p_cod=="") | (r1b==3 & r1b_p_cod==999)
...
*JANET PORRAS. 26/11/25	 
   ...
   *replace  tipo_bienestar = 2
	...
	* pobre_ine_ci *
	****************
*pobreza_mt: situacion de pobreza, metodo tradicional
*pobreza_mn: situacion de pobreza, metodo nuevo
*LA VARIABLE ESTA EN LA BASE. JANET PORRAS. 26/11/25	

	gen byte pobre_ine_ci= . 
	replace  pobre_ine_ci= 0 if pobreza_mn==3
	replace  pobre_ine_ci= 1 if pobreza_mn<3
...
/* Calculo  POBREZA 
	...
	gen persindo = 	cond(nucleo!= 0,1,0) /*personas en el hogar si considerar servicio doméstico(miembros del hogar)*/
...
*/
gen persindo = 	cond(nucleo!= 0,1,0)
gen nae = persindo^0.7	
gen yae = round(ytotcorh / nae)	
