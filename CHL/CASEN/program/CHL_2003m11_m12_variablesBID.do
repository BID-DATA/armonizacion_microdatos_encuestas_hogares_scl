...
replace desalent_ci = 1 if (o3 == 2 & o6 == 8 & condocup_ci == 3)
...
gen ylmsec_ci=. // No hace falta condiciones
...
******************
*No hay variables de ingreso laboral no monetario
gen ylnmotros_ci=. // No hace falta condiciones
...
*yautaj1: Ingreso autónomo 
*ysubaj1: Subsidios monetarios en el hogar
gen yautaj1=yautaj
gen ysubaj1=ysubaj
gen negylm=-ylm_ci
...
gen ynlnm_ci=. // No hace falta condiciones
...
gen remesas_ci=. // No hace falta condiciones
...
*****************
/*	ypasaj: Pensión Asistencial (pesos por mes)
	yasaj : Aportes solidarios */
...
replace cotizando_ci = 1 if (inrange(o28, 1, 5) & emp_ci==1)
...
replace afiliado_ci = 1 if (inrange(o28, 1, 6) & emp_ci==1)
