...
replace desalent_ci = 1 if (o3 == 2 & o7 == 8 & condocup_ci == 3)
...
egen auxpens=rsum(ypasaj), missing
...
replace cotizando_ci = 1 if (inrange(o17, 1, 5) & emp_ci==1)
...
replace afiliado_ci = 1 if (inrange(o17, 1, 6) & emp_ci==1)
