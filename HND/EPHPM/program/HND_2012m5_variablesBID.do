...
*horaspri_ci*
*************
gen horaspri_ci=ce430
replace horaspri_ci=. if horaspri_ci>168

************
*horastot_ci
************
gen horassec_ci=ce455
replace horassec_ci=. if ce455>168
...
****************
gen categosec_ci=.
replace categosec_ci=1 if (ce457==6 | ce457==7 | ce457==10 | ce457==11)
replace categosec_ci=2 if (ce457==4 | ce457==5 | ce457==8 | ce457==9)
replace categosec_ci=3 if (ce457>=1 & ce457<=3)
replace categosec_ci=4 if (ce457==12| ce457==13)
...
replace tiempoparc_ci=1 if horastot<30 & ce474==2
label var tiempoparc_ci "Trabajadores a medio tiempo"

*************
*nempleos_ci*
*************
generat nempleos_ci=1 if ce449==2
replace nempleos_ci=2 if ce449==1
replace nempleos_ci=. if emp_ci==0
/*
**************
*firmpapeq_ci*
**************
gen firmapeq_ci=0 if (ce431_cantidad>5 & ce431_cantidad<99999)
replace firmapeq_ci=1 if (ce431_cantidad<=5 & ce431_cantidad!=0)
*/
...
replace ce425cod = "0" + ce425cod if length(ce425cod)==6
...
replace  rama_ci=6 if (ce428cod>=5010000 & ce428cod<=5939057) & emp_ci==1
...
*****************
/*
   1. Contrato indiviudal temporal |        816       14.61       14.62
2. Contrato individual permanente/acuer |      2,526       45.21       59.84
                  3. Contrato colectivo |         19        0.34       60.18
                      4. Acuerdo verbal |      2,198       39.34       99.52
                 9. No sabe/no responde 
*/
/*
gen tipocontrato_ci=.
replace tipocontrato_ci= 1 if ce433==2 |ce433==3
replace tipocontrato_ci= 2 if ce433==1
replace tipocontrato_ci= 3 if ce433==4
*/
...
gen cesante_ci=ce412 if ce412==1 & condocup_ci==2
...
*egen ypen_ci=rsum(oih1_lps oih2_lps), missing
...
*gen ypensub_ci=oih10>0
*Modificación Mayra Sáenz - Febrero 2014
*Se genera ceros con la sintaxis anterior.
...
generat lp_ci=2806.8 if zona_c==1
replace lp_ci=1465.2 if zona_c==0
...
gen lpe_ci =.
replace lpe_ci = 1403.4 if zona_c == 1
replace lpe_ci = 1097.5 if zona_c == 0
...
gen autoconsumop_ci=ce448
replace autoconsumop_ci=0 if ce448 ==. & edad_ci>4 & (categopri==1 | categopri==2) & (emp_ci==1) 
label var autoconsumop_ci "Autoconsumo Individual Actividad Principal(Trabajadores Independientes)"

gen autoconsumos_ci=ce473 
replace autoconsumos_ci=0 if ce473==. & edad_ci>4 & (categosec==1 | categosec==2) & ce449==1 
