...
replace categoinac_ci = 4 if  ((categoinac_ci ~=1 & categoinac_ci ~=2 & categoinac_ci ~=3) & condocup_ci==3 & p18 != 3) // Exclusión de rentistas
...
rename p26a codindustria
rename p25a codocupa
