...
Detalle de procesamientos o modificaciones anteriores:
 opened on:  16 Aug 2006, 12:38:58
 marzo 2013 Andres Felipe Sanchez
Email: andressa@iadb.org, anfesanz@gmail.com

*******************************************************************************************************
*****                                       HONDURAS 1992                                              
*****                EPHPM 1992 (Encuesta Permanente de Hogares de Propositos Multiples)               
*****                                      24.704 personas                                             
*****                                       4.757 hogares                                              
*******************************************************************************************************
****************************************************************************/
...
generat lp_ci=300.84 if zona_c==1
replace lp_ci=167.34 if zona_c==0
...
replace  vivi2_ch=0 if tipoviv>=2 & tipoviv<=5
