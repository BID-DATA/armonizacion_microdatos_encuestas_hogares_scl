...
replace desalent_ci = 1 if ((p39 == 2 & p42 == 6) & condocup_ci == 3)
replace desalent_ci = 0 if ((p42 != 6 & p42 !=.) & condocup_ci==3)
...
replace cotizando_ci = 1 if (((p58_1>=1 & p58_1<=6) | (p58_2>=1 & p58_2<=6) | (p58_3>=1 & p58_3<=6) | (p58_4>=1 & p58_4<=6) | (p58_5>=1 & p58_5<=6) | (p58_6>=1 & p58_6<=6) | (p58_7>=1 & p58_7<=6) | (p58_8>=1 & p58_8<=6) | (p58_9>=1 & p58_9<=6) | (p58_10>=1 & p58_10<=6)) & emp_ci==1)
...
*remesas_ci*
************
gen double remesas_ci=remesaext_efec
...
***eduui_ci*** 
**************
g byte eduui_ci = ((inlist(p05, 7, 8, 9) & p07 == 2) | inlist(p11, 7, 8, 9))
...
***eduuc_ci*** 
**************
g byte eduuc_ci = ((inlist(p05, 7, 8, 9) & p07 == 1) | p05 == 10 | p11 == 10)
...
**************
gen byte eduac_ci=.
replace eduac_ci= 1 if inlist(p05, 9, 10) | inlist(p11, 9, 10) 
replace eduac_ci= 0 if inlist(p05, 7, 8) | inlist(p11, 7, 8) 
...
***asipre_ci***
***************
gen byte asispre_ci= (p03 == 1 & p18 == 3) // Asiste a pre-básica
...
***pqnoasis1_ci***
******************
g       pqnoasis1_ci = 1 if p04 == 7
replace pqnoasis1_ci = 2 if p04 == 11
replace pqnoasis1_ci = 3 if p04 == 6
replace pqnoasis1_ci = 4 if p04 == 3
replace pqnoasis1_ci = 5 if p04 == 4 | p04 == 10
replace pqnoasis1_ci = 6 if p04 == 2
replace pqnoasis1_ci = 7 if p04 == 8 | p04 == 9
replace pqnoasis1_ci = 8 if p04 == 5
replace pqnoasis1_ci = 9 if p04 == 1 | p04 == 12
...
replace bano_ch=1 if h6==1
replace bano_ch=2 if h6==2
replace bano_ch=3 if ( h6==6 | h6==7)
replace bano_ch=4 if (h6==3 | h6==4)
replace bano_ch=6 if h6==8 | h6==5 

***************
***banoex_ch***
***************
generate banoex_ch=.
replace banoex_ch = 9 if h5==2
