...
****************************	
	...
	****************	
	...
	replace tipo_bienestar  = 1 // ingresos
	...
	****************
	 * ln_ci *
	****************
	* https://ine.gob.hn/wp-content/uploads/2025/11/ResultadosMedicionPobreza18noviembre2025.pdf
	gen ln_ci = . 
	replace ln_ci = 5367.2 if zona_c==1 // Zona urbana
	replace ln_ci = 2748.6 if zona_c==0 // Zona rural		
