...
*Al crear de la forma tradicional se generan hogares de 52 miembros en lugar de 16 miembros como lo indica la variable.
...
replace categopri_ci=2 if ce31==4 | ce31==5   | ce31==8  | ce31==9 
...
*horastot_ci
************
gen horassec_ci=ce78 
replace horassec_ci=. if ce78 >168
...
*ocupa_ci*
**********
tostring ce25cod , replace
replace ce25cod  = "0" + ce25cod  if length(ce25cod )==6
gen labor=substr(ce25cod ,1,4)
...
replace  rama_ci=6 if (ce28cod>=5002005 & ce28cod<=5939057) & emp_ci==1
...
*/
* MOdificacion condicionada a categopri==3 MGD6/16/2014
gen tipocontrato_ci=.
replace tipocontrato_ci= 1 if (ce34==2 |ce34==3 ) & categopri_ci==3
replace tipocontrato_ci= 2 if ce34==1 & categopri_ci==3
replace tipocontrato_ci= 3 if (ce34==4  & tipocontrato_ci==.) & categopri_ci==3 
...
gen tamemp_ci = 1 if (ce32_cantidad>=1 & ce32_cantidad<=5)
replace tamemp_ci = 2 if (ce32_cantidad>=6 & ce32_cantidad<=50)
replace tamemp_ci = 3 if (ce32_cantidad>50) & ce32_cantidad!=.
replace tamemp_ci=. if  ce32_cantidad>=9999
label define tamemp_ci 1 "Pequeña" 2 "Mediana" 3 "Grande"
label value tamemp_ci tamemp_ci
label var tamemp_ci "Tamaño de empresa"

gen tamemp = 1 if (ce32_cantidad>=1 & ce32_cantidad<=4)
replace tamemp = 2 if (ce32_cantidad>=5 & ce32_cantidad<=14)
replace tamemp = 3 if (ce32_cantidad>=15) & ce32_cantidad<=40
replace tamemp=. if  ce32_cantidad>=41 & ce32_cantidad!=.
...
*lp_ci***
*********
*Y.L -> estimo la linea de pobreza en base a la de alimentos
generat lp_ci=2949.6 if zona_c==1
replace lp_ci=1529.2 if zona_c==0
...
*********
gen lpe_ci =.
replace lpe_ci = 1474.8 if zona_c == 1
replace lpe_ci = 1145.5 if zona_c == 0
...
* MGR Aug, 2015: se incluye ylmotros_ci
/*
...
* MGR Aug, 2015: se incluye ylnmotros_ci
/*
...
* Setear variables de origen en lowercase
...
***************
gen edupub_ci=.
replace edupub_ci = 1 if (ed16 == 1 | ed16 == 2 | ed16 == 3 | ed16 == 4 | ed16 == 8 | ed16 == 11)
replace edupub_ci = 0 if (ed16 == 5 | ed16 == 6 | ed16 == 7 | ed16 == 9 | ed16 == 10 | ed16 == 12)
...
*****************
gen aguafuente_ch =.
replace aguafuente_ch = 1 if dv06<=2 & dv09<=2
...
replace bano_ch=6 if   dh06==5 | dh06==8 
