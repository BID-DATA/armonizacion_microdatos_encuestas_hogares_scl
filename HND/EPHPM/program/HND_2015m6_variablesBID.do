...
gen lp_ci= 3266.38 if zona_c==1
replace lp_ci= 1668.34 if zona_c==0
...
gen lpe_ci = 1633.19 if zona_c==1
replace lpe_ci= 1249.69 if zona_c==0
...
***aedu_ci***
*************
* Remark: En este anio los codigos de ed110 van de 1 al 10. 
...
replace ed110 = . if ed110 == 10 // codigo de 99. ns/nr es 10. 
...
replace aedu_ci = 0 if ed110 == 1 | ed110 == 2 // Ctro alfab, Pre-Básica
replace aedu_ci = ed115 - 1 if ed110 == 3 // Básica
replace aedu_ci = ed115 + 6 - 1 if ed110 == 4 // Ciclco Común 
replace aedu_ci = ed115 + 9 - 1 if ed110 == 5 // Diversificado
replace aedu_ci = ed115 + 11 - 1 if ed110 == 6 | ed110 == 7 | ed110 == 8 // Técnico Sup, Sup no univ, univ
replace aedu_ci = ed115 + 15 - 1 if ed110 == 9 // Post-grado


* Imputacion anios perdidos:
replace aedu_ci = 0 if (ed105 == 1 | ed105 == 2 | ed105 == 3 & ed108 == .)  ///
				| (ed110 == 1 | ed110 == 2 & ed115 == .) // Ninguno, Ctro alafab , Pre-básica
replace aedu_ci = 0 if  (ed105 == 4 & ed108 == .) | (ed110 == 3 & ed115 == .) // Educación básica
replace aedu_ci = 6 if (ed105 == 5 & ed108 == .) | (ed110 == 4 & ed115 == .) // Ciclo Común
replace aedu_ci = 9 if (ed105 == 6 & ed108 == .) | (ed110 == 5 & ed115== .) // Diversificado
replace aedu_ci = 11 if (inlist(ed105, 7, 8, 9) & ed108==.) | (inlist(ed110, 6, 7, 8) & ed115 == .) // Terciaria
replace aedu_ci = 15 if (ed105 == 10 & ed108 == .) | (ed110 == 9 & ed115 == .) // Post-grado
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen miglac_ci=(migrante_ci==1 & inlist(cd202_p,2,3,4,5,6,11,18)) if migrante_ci!=.
