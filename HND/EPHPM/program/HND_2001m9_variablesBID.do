...
replace desalent_ci = 1 if ((p17 == 3 & p20 == 5) & condocup_ci == 3)
replace desalent_ci = 0 if ((p20 != 5 & p20 !=.) & condocup_ci==3)
...
gen categoinac_ci = .
replace categoinac_ci = 1 if ((p21==1 | p21==2) & condocup_ci==3)
