...
gen categoinac_ci = .
replace categoinac_ci = 1 if (p21==1 & condocup_ci==3)
replace categoinac_ci = 2 if  (p21==3 & condocup_ci==3)
replace categoinac_ci = 3 if  (p21==4 & condocup_ci==3)
replace categoinac_ci = 4 if  ((categoinac_ci ~=1 & categoinac_ci ~=2 & categoinac_ci ~=3) & condocup_ci==3 & p21 != 2) // Exclusión de rentistas
