...
replace cotizando_ci = 1 if ((ce423_1==1 | ce423_2==2 | ce423_3==3 | ce423_4==4 | ce423_5==5 | ce423_6==6) & emp_ci==1)
...
gen lp_ci= 3298.03 if zona_c==1
replace lp_ci= 1671.8 if zona_c==0
...
gen lpe_ci = 1649.01 if zona_c==1
replace lpe_ci= 1252.3 if zona_c==0
...
replace internet_jh = . if  at306_1==. & (at304==. | at304==3) & relacion_ci==1	  // No tiene
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen migrantelac_ci=(migrante_ci==1 & inlist(cd202_p,2,3,4,5,7,11,14,16,17,25)) if migrante_ci!=.
	...
	**********************
	...
	gen miglac_ci=(migrante_ci==1 & inlist(cd202_p,2,3,4,5,7,11,14,16,17,25)) if migrante_ci!=.
