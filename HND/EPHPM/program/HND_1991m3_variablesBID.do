...
gen subemp_ci=0
replace subemp_ci=1 if horaspri_ci<=30 & (p14>=1 & p14<99) & emp_ci==1
...
*durades_ci*
************
* MGD 04/09/2015: parece ser un valor atipico por lo que se la genera como missing.
gen durades_ci=.
/*replace  durades_ci=p19_2 if p19_2<99 & p19_2>0 & p19_1>1 & p19_1!=. & p19_2!=. 
replace  durades_ci=0.5 if p19_1==1 
...
*************
gen rama_ci=.
replace  rama_ci=1 if (ramagene>=1110 & ramagene<=1302) & emp_ci==1
replace  rama_ci=2 if (ramagene>=2100 & ramagene<=2909) & emp_ci==1
replace  rama_ci=3 if (ramagene>=3111 & ramagene<=3909) & emp_ci==1
replace  rama_ci=4 if (ramagene>=4101 & ramagene<=4200) & emp_ci==1
replace  rama_ci=5 if ramagene==5000 & emp_ci==1
replace  rama_ci=6 if (ramagene>=6100 & ramagene<=6320) & emp_ci==1
replace  rama_ci=7 if (ramagene>=7111 & ramagene<=7200) & emp_ci==1
...
generat lp_ci=251.64 if zona_c==1
replace lp_ci=139.97 if zona_c==0
...
recode p29_2 p31_2 p29_6 p31_4 p31_5 (99999 =.) (99998=.)

*replace p31_4 =. if emp_ci ==0
*replace p29_6 =. if emp_ci == 0
