...
********************************************************************************
	...
	*/
	...
	gen pqnoasis1_ci = .
	replace pqnoasis1_ci = 1 if inlist(ED04,8,13) // Problemas Económicos - Trabajo
	replace pqnoasis1_ci = 2 if inlist(ED04,3) // Falta de Interés 
	replace pqnoasis1_ci = 3 if inlist(ED04,4,6,7,11,12) // Problemas familiares o de salud
	replace pqnoasis1_ci = 4 if inlist(ED04,5, 9) // Problemas de acceso
	replace pqnoasis1_ci = 5 if inlist(ED04,2) //Otros problemas
