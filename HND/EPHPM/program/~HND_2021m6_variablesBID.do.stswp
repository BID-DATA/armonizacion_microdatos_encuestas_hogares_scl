...
Encuesta: EPHPM
Round: m6
Autores: Oscar Jaramillo
Última versión: Oscar Jaramillo - Email: oscarj@iadb.org, oscar.10000@hotmail.com
Fecha última modificación: septiembre de 2024
...
replace clasehog_ch = 4 if (clasehog_ch == 2 | clasehog_ch == 3) & notropari_ch > 0
**** corresidente
...
***nmayor21_ch***
*****************
by idh_ch, sort: egen nmayor21_ch = sum(miembros_ci == 1 & edad_ci >= 21)
label variable nmayor21_ch "Numero de familiares mayores a 21 anios"

*****************
***nmenor21_ch***
*****************
by idh_ch, sort: egen nmenor21_ch = sum(miembros_ci == 1 & edad_ci < 21)
label variable nmenor21_ch "Numero de familiares menores a 21 anios"

*****************
***nmayor65_ch***
*****************
by idh_ch, sort: egen nmayor65_ch = sum(miembros_ci == 1 & edad_ci >= 65)
label variable nmayor65_ch "Numero de familiares mayores a 65 anios"

****************
***nmenor6_ch***
****************
by idh_ch, sort: egen nmenor6_ch = sum(miembros_ci == 1 & edad_ci < 6)
label variable nmenor6_ch "Numero de familiares menores a 6 anios"

****************
***nmenor1_ch***
****************
by idh_ch, sort: egen nmenor1_ch = sum(miembros_ci == 1 & edad_ci < 1)
...
do "$github\armonizacion_microdatos_encuestas_hogares_scl\_DOCS\\Labels&ExternalVars_Harmonized_DataBank.do"
...
salmm_ci ipc_c lp19_c lp31_c lp5_c aedu_ci eduno_ci edupi_ci edupc_ci	edusi_ci edusc_ci eduui_ci eduuc_ci	edus1i_ci ///
