...
replace desalent_ci = 1 if ((p21 == 2 & p23 == 6) & condocup_ci == 3)
...
replace cotizando_ci = 1 if (((p09l1c2==1|p09l2c2==1|p09l3c2==1|p09l4c2==1|p09l5c2==1)) & emp_ci==1)
...
egen double remesas_ci=rsum(p87l06c1 p87l06c2 p87l06c3 p87l06c4), missing
