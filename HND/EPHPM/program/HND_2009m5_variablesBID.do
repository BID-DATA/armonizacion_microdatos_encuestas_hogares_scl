...
replace desalent_ci = 1 if ((p406 == 2 & p409 == 6) & condocup_ci == 3)
replace desalent_ci = 0 if ((p409 != 6 & p409 !=.) & condocup_ci==3)
...
replace cotizando_ci = 1 if (((aux_a>=1 & aux_a<=6) |  (aux_b>=1 & aux_b<=6)| (aux_c>=1 & aux_c<=6)| (aux_d>=1 & aux_d<=6) | (aux_e>=1 & aux_e<=6) | (aux_f>=1 & aux_f<=6)) & emp_ci==1)
...
gen categoinac_ci = .
replace categoinac_ci = 1 if ((p407 ==2 | p407==3) & condocup_ci==3)
...
***pqnoasis1_ci***
******************
g       pqnoasis1_ci = 1 if p104==7
replace pqnoasis1_ci = 2 if p104==11
replace pqnoasis1_ci = 3 if p104==6
replace pqnoasis1_ci = 4 if p104==3
replace pqnoasis1_ci = 5 if p104==4 | p104==10
replace pqnoasis1_ci = 6 if p104==2
replace pqnoasis1_ci = 7 if p104==8 | p104==9
replace pqnoasis1_ci = 8 if p104==5
replace pqnoasis1_ci = 9 if p104==1 | p104==12
...
replace aguafuente_ch = 10 if  v06==10 |v06==3 | v06==4|v06==9|(v06==. & jefe_ci!=.)
...
*cocina_ch*
***********
/*H02. En que pieza o sitio de la vivienda cocina los alimnentos:
...
/* La respuesta es a nivel de persona, por lo que un mismo hogar puede tener diferentes respuestas. Por lo que se utiliza la jefatura de hogar.
	p304. Durante los últimos 3 meses, ¿tuvo acceso a internet?
           1 Si
           2 No
           9 No sabe
    p306_1. (Acceso Internet) En su casa
           1 Si
           2 No */
gen internet_jh = (p306_1==1 & p304==1) & relacion_ci==1						  // Posee conexión a internet
replace internet_jh = . if  p306_1==. & (p304==. | p304==9) & relacion_ci==1	  // No tiene
...
/* La respuesta es a nivel de persona, según el manual cel_ch = 1 si al menos un integrante tiene celular.
	P308 ¿Tiene teléfono celular? 
         1 Si
         2 No */
bys idh_ch: egen cel_ch = min(p308)
