...
***  ine01  ***
***************
gen ine01=real(substr(pIDENT,1,2))
label define ine01          /// 
	5  "Antioquia"	        ///
	8  "Atlantico"	        ///
	11 "Bogota, D.C"	    ///
...
replace desalent_ci = 1 if (((p18_T50>=04 & p18_T50<=11)|p18_T50==02) & condocup_ci == 3)
...
gen aguared_ch=(p4_T01_==1 | p4_T01_==2) // 1 De acueducto por tubería 2 De otra fuente por tubería
...
replace aguafconsumo_ch = 1 if p4_T01_==1  //2021 1 De acueducto por tubería
replace aguafconsumo_ch = 2 if p4_T01_==6 // 2021 7 De pila pública 
										  //      4 Pozo protegido
replace aguafconsumo_ch = 3 if p4_T01_==0  //2021 10 Agua embotellada o en bolsa
replace aguafconsumo_ch = 5 if p4_T01_==9  //2021 5 Aguas lluvias
replace aguafconsumo_ch = 6 if p4_T01_==7 //2021 8 Carrotanque
replace aguafconsumo_ch = 7 if p4_T01_==2 //2021 2 De otra fuente por tubería
replace aguafconsumo_ch = 8 if p4_T01_==5  //2021 6 Río, quebrada, nacimiento o manantial
replace aguafconsumo_ch = 9 if (p4_T01_==4 | p4_T01_==8) //2021 4 De pozo sin bomba, aljibe, jagüey o barreno + 9 Aguatero
replace aguafconsumo_ch = 10 if p4_T01_==3 //2021 3 De pozo con bomba 

*****************
*aguafuente_ch*
*****************
gen aguafuente_ch =.
replace aguafuente_ch = 1 if p4_T01_==1 
replace aguafuente_ch = 2 if p4_T01_==6 
replace aguafuente_ch = 3 if p4_T01_==0 
replace aguafuente_ch = 5 if p4_T01_==9 
replace aguafuente_ch = 6 if p4_T01_==7 
replace aguafuente_ch = 7 if p4_T01_==2 
replace aguafuente_ch = 8 if p4_T01_==5 
replace aguafuente_ch = 9 if (p4_T01_==4 | p4_T01_==8) 
replace aguafuente_ch = 10 if p4_T01_==3 
...
****bano_ch*****
****************
destring p2_T01, replace
gen bano_ch=.
replace bano_ch=0 if p2_T01==6
replace bano_ch=1 if p2_T01==1
replace bano_ch=2 if p2_T01==2
replace bano_ch=4 if p2_T01==5
replace bano_ch=6 if p2_T01==3 | p2_T01 ==4
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if p2_T01<6
...
***combust_ch***
****************
destring p5_T01, replace
gen combust_ch=(p5_T01==1|p5_T01==3)
replace combust_ch =. if p5_T01==.
...
replace des1_ch=1 if p2_T01==1
replace des1_ch=2 if p2_T01==2 |p2_T01==4 
replace des1_ch=3 if p2_T01==3|p2_T01==5
...
replace des2_ch = 1 if p2_T01 == 1 |p2_T01 == 2 |p2_T01 == 3 | p2_T01 == 4
replace des2_ch = 2 if p2_T01 == 5 
...
****piso_ch*****
****************
destring p3i_T01, replace
g piso_ch = (p3i_T01 != 1 & p3i_T01 != .)
replace piso_ch = . if p3i_T01 == .
...
****************
/*
- Ladrillo, bloque, material prefabricado, piedra 1
- Madera pulida 2
- Adobe o tapia pisada 3
- Bahareque revocado 4
- Bahareque sin revocar 5
- Madera burda, tabla, tablón 6
- Guadua 7
- Caña, esterilla, otro tipo de material vegetal 8
- Zinc, tela, cartón, latas, desechos, plástico 9 */

destring p2i_T01, replace
gen pared_ch=. 
replace pared_ch = 0 if p2i_T01==9
replace pared_ch = 1 if p2i_T01==1| p2i_T01==4|p2i_T01==3 
replace pared_ch = 2 if p2i_T01==5|p2i_T01==6|p2i_T01==7|p2i_T01==8 |p2i_T01==2
...
****telef_ch****
****************
destring p8_T01_1, replace
gen telef_ch= 1 if p8_T01_1==1
replace telef_ch = . if p8_T01_1 == .
...
****refrig_ch***
****************
destring  p8_T01_3, replace
g refrig_ch = 1 if p8_T01_3== 1
replace refrig_ch = . if p8_T01_3 == .
...
****vivi1_ch****
****************
destring p1i_T01, replace
g vivi1_ch = 	   1 if p1i_T01 == 1
replace vivi1_ch = 2 if p1i_T01 == 2
replace vivi1_ch = 3 if p1i_T01 == 3 | p1i_T01 == 4 | p1i_T01 == 5 
replace vivi1_ch = . if p1i_T01 == .
...
****vivi2_ch****
****************
g vivi2_ch = (p1i_T01== 1 | p1i_T01 == 2)
replace vivi2_ch = . if p1i_T01 == .
la var vivi2_ch "La vivienda es casa o departamento"

*******************
****viviprop_ch****
*******************
destring p6_T01_, replace
g viviprop_ch = 0 if p6_T01_ == 3
replace viviprop_ch = 1 if p6_T01_ == 1
replace viviprop_ch = 2 if p6_T01_ == 2
replace viviprop_ch = 3 if p6_T01_ == 4 | p6_T01_ == 5 
replace viviprop_ch = . if p6_T01_ == .
