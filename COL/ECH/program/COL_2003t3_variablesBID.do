...
Fecha generacion: Septiembre 2014
...
*********
gen lp_ci =.
replace lp_ci= 144749 if zona_c==1 /*cabecera*/
replace lp_ci= 85698  if zona_c==0  /*resto*/
...
*********
gen lpe_ci =.
replace lpe_ci= 57977 if zona_c==1 /*cabecera*/
replace lpe_ci= 47458 if zona_c==0  /*resto*/
label var lpe_ci "Linea de indigencia oficial del pais"

*************
**salmm_ci***
*************
gen salmm_ci= 	11066.6666666667*30
...
*************
***rama_ci*** (corregido por MR oct 2014)
*************
...
*/
replace rama_ci=1 if ((p26>=1 & p26<=5)    | (p26>=111  & p26<=599))  & emp_ci==1   
replace rama_ci=2 if ((p26>=10  & p26<=14) | (p26>=1000 & p26<=1499)) & emp_ci==1
replace rama_ci=3 if ((p26>=15  & p26<=37) | (p26>=1500 & p26<=3799)) & emp_ci==1
replace rama_ci=4 if ((p26>=40  & p26<=41) | (p26>=4000 & p26<=4199)) & emp_ci==1
replace rama_ci=5 if ((p26==45)            | (p26>=4500 & p26<=4599)) & emp_ci==1
replace rama_ci=6 if ((p26>=50  & p26<=55) | (p26>=5000 & p26<=5599)) & emp_ci==1
replace rama_ci=7 if ((p26>=60  & p26<=64) | (p26>=6000 & p26<=6499)) & emp_ci==1
replace rama_ci=8 if ((p26>=65  & p26<=71) | (p26>=6500 & p26<=7199)) & emp_ci==1
replace rama_ci=9 if ((p26>=72  & p26<=99) | (p26>=7200 & p26<=9900)) & emp_ci==1
replace rama_ci=. if emp_ci==0
...
*Modificación Mayra Sáenz - Noviembre 2014
replace NIVEL=3	if p10>=400 & p10<=413
...
replace aedu_ci=10 if p10==410 
replace aedu_ci=11 if p10==411 | p10==500  
replace aedu_ci=12 if p10==412 /* Y.L -> 12 años de educacion secundaria "son muy pocos"*/
replace aedu_ci=13 if p10==413 /* Y.L -> 13 años de educacion secundaria "son muy pocos"*/
...
gen  tcylmpri_ci =.
gen tcylmpri_ch=.
* Line of code with indicator pqnoasis_ci was deletedgen benefdes_ci=.
gen ybenefdes_ci=.
