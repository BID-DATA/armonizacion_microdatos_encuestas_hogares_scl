...
*********
gen lp_ci =.
replace lp_ci= 153296 if zona_c==1 /*cabecera*/
replace lp_ci= 90728  if zona_c==0  /*resto*/
...
*********
gen lpe_ci =.
replace lpe_ci= 61257 if zona_c==1 /*cabecera*/
replace lpe_ci= 50055 if zona_c==0  /*resto*/
...
*************
* COL 2004
gen salmm_ci= 	11933.3333333333 * 30
...
gen cesante_ci=1 if p53==2
replace cesante_ci=0 if p53==1
...
**pension_ci*
*************
*gen pension_ci=1 if I65C>0 & I65C<.
