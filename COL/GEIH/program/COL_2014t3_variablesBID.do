...
replace p7500s2a1= . if p7500s2a1==9999999999 | p7500s2a1==9999 | p7500s2a1==98
...
*/
/*
* MGR: utilizo variable de recibe pensión o no, da el mismo resultado
gen pension_ci= (p7500s2==1)
label var pension_ci "1=Recibe pension contributiva"
*/
****************
*tipopen_ci*****
...
replace ypen_ci= . if p7500s2a1==9999999999 | p7500s2a1==9999 | p7500s2a1==98
replace ypen_ci=. if pension_ci==0
*YL -> no estoy segura si 9999 es valor perdido pero lo quito.
...
replace categoinac_ci=4 if p7450==1 |  p7450==4 | (p7450>=6 & p7450<=9)*/
...
/* Missing values para no sabe/noresponde en maximo nivel educativo
	y ultimo anio aprobado. */	
...
*MGD: modifico sintáxis para incluir opción 7 como materiales impermanentes
/*
...
************
	...
	bys idh_ch: egen temp2 = sum(temp1)
