...
gen tamemp_o=.
replace tamemp_o=1 if p6870>=1 & p6870<=4
replace tamemp_o=2 if p6870>=5 & p6870<=7
replace tamemp_o=3 if p6870>=8 & p6870<=9
label var tamemp_o "# empleados en la empresa-OECD"
...
* 0 anios de educacion
	replace aedu_ci = 0 if p6210 == 1 | p6210 == 2 // Prescolar o ninguno.
	replace aedu_ci = 0 if p6210 == 3 & p6210s1 == 0 // Primaria 0 anios.
