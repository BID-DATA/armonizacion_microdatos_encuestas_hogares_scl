...
****************
	...
	*** Montos de transferencias a nivel individual (mensualizado):
		...
		replace ypnc_ci = . if p1661s3a1 == 99 | p1661s3a1 == 98 | p1661s3a1 == 9999
		
		// Transferencia por PTMC	
		gen double yfamac_ci = p1661s1a1/12
		replace yfamac_ci = . if p1661s1a1 == 99 | p1661s1a1 == 98 | p1661s1a1 == 9999
		
		gen double yjovac_ci = p1661s2a1/12
		replace yjovac_ci = . if p1661s2a1 == 99 | p1661s2a1 == 98 | p1661s2a1 == 9999
		...
		replace yotrot_ci = . if p1661s4a2 == 99 | p1661s4a2 == 98 | p1661s4a2 == 9999
...
*************
	...
	gen m_`var' = `var'a1
	replace m_`var' = . if `var'a1 == 98 | `var'a1 == 9999
	}
	...
	replace yjubilacion = iof2es if iof2 == 0 & iof2es != . & (p7500s2   == 9 | p7500s2a1 == 98 | p7500s2a1 == 9999)
...
*** nrylmpri_ch ***
*******************
	bys idh_ch: egen nrylmpri_ch = total(nrylmpri_ci) if miembros_ci == 1, mi
...
*******************
	...
	foreach i in lm lnm nlm {
		bys idh_ch: egen double y`i'_ch = total(y`i'_ci) if miembros_ci == 1, mi
	}
...
*** ylmnr_ch ***
****************
	bys idh_ch: egen double ylmnr_ch = total(ylm_ci) if miembros_ci == 1, mi
