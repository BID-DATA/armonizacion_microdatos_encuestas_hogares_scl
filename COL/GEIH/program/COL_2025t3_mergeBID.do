...
/*
Autor: Olga Dulce, Matias Rodriguez
 */

*** MERGE COLOMBIA GEIH 2025 (t3) ****
*------------------------------*	
...
*---------------
clear
use "`out'\COL_2025t3.dta", clear
replace fex_c18=fex_c18/3
merge 1:1 id using "`out'\COL_2025t3migracion.dta"
sort id
drop _merge
merge 1:1 id using "`ruta'\`ronda1'\data_merge\pov_t3.dta"
compress
save "`ruta'\`ronda2'\data_merge\COL_2025t3.dta", replace
