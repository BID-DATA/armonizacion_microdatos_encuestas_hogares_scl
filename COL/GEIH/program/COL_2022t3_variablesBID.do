...
replace transf_jov = jh_iof/(filtro_h*filtro_750) if p1661s2 == 1 & p1661s2a1 == 98 & filtro_h >= 1 & filtro_750 >= 1 & p750s2 == 1
...
* e) Cuando viene el código especial pero missing en el agregado:
replace remesas_ci = 0 if p7510s2 == 1  & p7510s2a1 == 98 & filtro_7510 >= 1  & iof3h == . & iof3hes == .
replace remesas_ci = 0 if p7510s2 == 1  & p7510s2a1 != 98 & filtro_7510 >= 1  & iof3h == . & iof3hes == . & jh_iof3h == 0
