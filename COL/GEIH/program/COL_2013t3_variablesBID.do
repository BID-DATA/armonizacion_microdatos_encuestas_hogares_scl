...
*lpe_ci***
*********
*YL: pendiente hasta que el DANE descargue el homologado de ingresos
gen lpe_ci =li
...
replace ypen_ci= . if p7500s2a1==9999999999 | p7500s2a1==9999 | p7500s2a1==99999 | p7500s2a1==98
...
* 0 anios educacion
	...
	replace aedu_ci = 0 if p6210 == 3 & p6210s1 == 0 // Primaria anio cero. 
