...
se hicieron dos cambios: El primero se refiere a la definicion de los miembros del 
hogar y el segundo, con esta nueva definicion, se calcularon nuevamente las variables 
relativas a la composicion demografica del hogar.
CODIGO ANTERIOR:
1.gen miembro_ci=(relacion_ci>=1 & relacion_ci<=4) 
...
****idh_ch*****
***************
egen idh_ch=concat(ca_VIVI ca_HOGA)
sort idh_ch
...
replace pension1=. if  pension1==9999998 | pension1==9999999
replace pension2=. if  pension2==9999998 | pension2==9999999
...
replace temi=. if (re_56_T0708=="9999999" | re_56_T0708=="999998")
*ocupados*
gen temo=real(re_44_T0507) if emp_ci==1 
replace temo=. if (re_44_T0507=="9999999" | re_44_T0507=="999998")
