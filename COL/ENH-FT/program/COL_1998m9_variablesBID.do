...
**salmm_ci***
*************
gen salmm_ci= 	203826.00 /* salario minimo diario * 30*/
...
destring ca_13_T50  ca_13_T50  ca_14_T501  ca_14_T502 ca_15_T50 ca_17_T50  ca_18_T50 ca_19_T50 ca_16_T50 ca_20_T501, replace
/*
gen condocup_ci=.
*replace condocup_ci=1 if  ca_13_T50 == 1 |  ((ca_13_T50>=2 & ca_13_T50<=8) & (ca_14_T501 == 1 | ca_14_T502 == 1 |  ca_15_T50==1 )
replace condocup_ci=1 if  ca_13_T50 == 1 |  ((ca_13_T50>=2 & ca_13_T50<=8) & (ca_14_T501 == 1 | ca_14_T502 == 1 |  ca_15_T50==1 | (ca_16_T50>=1 & ca_16_T50<=7)) )
...
gen segsoc_ci=.
replace segsoc_ci=(ca_35_T601=="1") if emp_ci==1

*ca_34_T601=="1" ES SALUD*
*comentario agosto 11 de 2005_MFP*
*en esta variable quedan algunas personas no ocupadas con 0 en vez de missing, a pesar de que los manuales*
*dicen que se le hace solo a los trabajadores,pasa en 163 casos de la zona rural, y 9 casos de personas *
* no ocupadas en las zonas rurales que dicen tener pensiones, en las cabeceras se presentan 459 casos de*
*respuesta en no empleados (179 que dicen si, 273 que dicen no y 7 que no saben).. SI se hizo la restriccion*
*de estar empleado y ES MUY IMPORTANTE tenerlo en cuenta*
*/
...
gen ylnm1=real(ca_31_T601) if emp_ci==1 
replace ylnm1=. if ylnm1==99 
gen ylnm2=real(ca_31_T602) if emp_ci==1 
replace ylnm2=. if ylnm2==99 

egen ylnm_ci=rsum(ylnm1 ylnm2)
replace ylnm_ci=. if  ylnm1==. & ylnm2==.  
drop ylnm1 ylnm2
...
*gen condocup_ci=.
*2014,01 Modificacion MLO
destring  re_19_T50 re_20_T50 re_22_T50 re_23_T50  re_24_T50 re_21_T50 re_23_T50 re_25_T50, replace
/*
replace condocup_ci=1 if (re_19_T50==1) |  ((re_19_T50>=2 & re_19_T50<=8) & (re_20_T50==1 |re_21_T50==1 |re_22_T50==1| re_23_T50>=1 & re_23_T50<=7)) 
...
*/
/*
replace condocup_ci=1 if (re_19_T50==1") |  ((re_19_T50>="2" & re_19_T50<="8") & (re_20_T50=="1" |re_21_T50=="1" |re_22_T50=="1"))
...
*afiliado_ci****
****************
destring re_43_T611 re_43_T612, replace
gen afiliado_ci=.
*2014,04 modificacion MLO
*replace afiliado_ci=1 if re_43_T611 ==1 | re_43_T612 ==1
...
**pension_ci*
*************
destring re_44_T613 re_53_T704, replace
recode re_44_T613 (99=.)
recode re_53_T704 (99=.)
egen aux_p=rsum(re_44_T613 re_53_T704), m
gen pension_ci=1 if aux_p>0 & aux_p<.
recode pension_ci .=0
label var pension_ci "1=Recibe pension contributiva"
...
/*re_43_T611 es salud y re_43_T612 es pensiones.*/
*/
...
/*Ganancia al trabajo* un AÑO!!!*/
gen yprid1=real(re_33_T60)/12 if emp_ci==1 & re_29_T60=="4"
replace yprid1=real(re_33_T60)/12 if emp_ci==1 & re_29_T60=="5"
...
egen ylnm_ci=rsum(ylnmpri ylnmsec)
