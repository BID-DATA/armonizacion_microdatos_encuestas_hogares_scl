...
1. redefinio la variable segsoc_ci, por consistencia con los otros países, se definio solo 
para pensiones, quitando la condicion (ca_34_T60) que se refiere a salud
codigo anterior:
gen segsoc_ci=(ca_34_T60=="1"|ca_35_T60=="1") if emp_ci==1
...
* Revision Marzo 2006 miembros: Conteo de miembros en el hogar si relacion_ci [1-4] y dummy de miembro
...
**salmm_ci***
*************
gen salmm_ci= 	172005.00  /*salario diario *30*/
...
*replace condocup_ci=2 if  ca_13_T50>=2 & ca_13_T50<=8 & (ca_17_T50==1)
...
*afiliado_ci****
****************
*2014, 04,10 modificacion MLO
*gen afiliado_ci=.
gen afiliado_ci=1 if ca_35_T60=="1"
...
/*no disponible*/
gen contrato_ci=.
gen contrato_ci1=(ca_21_T60=="1") if emp_ci==1

/*Para los asalariados el trabajo es permanente, cuando la relación 
laboral se deriva de un acuerdo definitivo para la realización de 
un trabajo en forma regular a través de un contrato de trabajo con 
duración superior a un año o a término indefinido.
Para los independientes el trabajo es permanente, cuando este se ejerce
en forma regular y continua. se entiende por trabajo temporal, aquel que 
ejerce una persona en forma esporádica o no continua, trabajando sólo por 
ciertas épocas o períodos o cuando tiene un contrato de trabajo hasta 
por un (1) año, aunque tenga renovaciones sucesivas.*/
...
gen segsoc_ci=.
replace segsoc_ci=(ca_35_T60=="1") if emp_ci==1
*/
...
replace yprid=real(ca_30_T601)*4 if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="4"
...
gen yprid2=real(ca_20_T508) if ca_20_T501==1 
replace yprid2=. if yprid2==99


gen yprid3=real(ca_46_T708) if ca_46_T701=="1" 
...
gen byte yedc=.
gen yedc1=real(ca_12_T10) /*Todos*/
...
*aguafconsumo_ch*
*****************
*se clasificó de 1997 sobre la base del 2021
...
****pared_ch****
****************
destring ca_2i_T0, replace
gen pared_ch=. 
replace pared_ch = 0 if ca_2i_T0==7
replace pared_ch = 1 if ca_2i_T0 ==1| ca_2i_T0==2|ca_2i_T0==3
replace pared_ch = 2 if ca_2i_T0==4|ca_2i_T0==5|ca_2i_T0==6
...
****************
gen afiliado_ci=.
replace afiliado_ci=1 if re_43_T602 =="1"
*modificacion MLO 2014,04
*replace afiliado_ci=1 if re_43_T601 =="1" | re_43_T602 =="1"
recode afiliado_ci .=0 if condocup_ci==2  | condocup_ci==1
label var afiliado_ci "Afiliado a la Seguridad Social"
...
gen byte emp_ci=(trab==1)
/* Es desempleado: en el ultimo anio*/
...
gen desalent_ci=.
*No se puede crear para urbano (re_25_T50=="2")
...
de id para COL-1997, lo que resulta en ids de hogar duplicados y en una subestimación de pobreza
