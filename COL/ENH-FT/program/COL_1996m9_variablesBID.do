...
********************* CABECERA PARA COLOMBIA 1996 **************************
****************************************************************************

***************
***region_c ***
***************
gen region_c=real(ca_7_T10_1)
...
***zona***
**********
/*PILAS: Desde 1996 zona_c NO ES MAS una clasificacion entre urbano y Rural, 
sino entre cabecera y resto*/

gen byte zona_c=1
label variable zona_c "Zona del pais"
label define zona_c 1 "cabecera" 0 "Resto"
...
**salmm_ci***
*************
gen salmm_ci= 	142125 /*salario diario *30*/
...
destring ca_13_T50  ca_13_T50  ca_14_T50 ca_15_T50 ca_17_T50 ca_16_T50 ca_18_T50 ca_19_T50 ca_20_T501, replace
/*
gen condocup_ci=.
*replace condocup_ci=1 if  ca_13_T50 == 1 |  (ca_13_T50>=2  & ca_13_T50<=8 & (ca_14_T50 == 1 |  ca_15_T50==1 ))
replace condocup_ci=1 if  ca_13_T50 == 1 |  (ca_13_T50>=2  & ca_13_T50<=8 & (ca_14_T50 == 1 |  ca_15_T50==1  |  ca_16_T50 >=1 & ca_16_T50<=7))
replace condocup_ci=2 if  condocup_ci!=1 & (ca_17_T50==1 | ca_18_T50==1 & (ca_19_T50>=1 & ca_19_T50<=4))
recode condocup_ci .=3  
*recode condocup_ci .=3 if ( ca_13_T50==3 |  ca_13_T50==5|  ca_13_T50==6)  
...
gen condocup_ci=.
replace condocup_ci=1 if  ca_13_T50 == 1 | ca_14_T50==1 | ca_15_T50==1 
...
*afiliado_ci****
****************
destring ca_35_T60, replace
gen afiliado_ci=.
replace afiliado_ci=1 if ca_35_T60==1
recode afiliado_ci .=0 if condocup_ci==2 
...
gen cesante_ci=1 if ca_41_T70==2
replace cesante_ci=0 if ca_41_T70==1
*gen cesante_ci=1 if p7310==2
*replace cesante_ci=0 if p7310==1
label var cesante_ci "Desocupado - definicion oficial del pais"	*/

* MGD 12/1/2015: se genera la variable condicionada a desocupados
destring ca_41_T70, replace
...
*ypen_ci*
*************
* MGD 11/30/2015: Se la genera como en la parte de resto de zonas urbanas.
g pension1=real(ca_20_T508) if ca_20_T504=="1"
g pension2=real(ca_46_T708) if ca_46_T704=="1"
recode pension1 (99=.) (9999999=.) (10700000=.)
recode pension2 (99=.) (9999999=.)
...
**pension_ci*
*************
* MGD 11/30/2015: se genera igual que en 1997
gen pension_ci=(aux_p>0 & aux_p<.)
/*destring ca_46_T704 ca_20_T504 , replace
egen aux_p=rsum(ca_46_T704 ca_20_T504), m
...
replace trab=1 if ((ca_13_T50>="2" & ca_13_T50<="8") & (ca_14_T50=="1"|ca_15_T50=="1" ))
...
gen desemp2_ci=.
/* no disponible*/
* el periodo es una semana pero se incluye a quienes esperan respuesta de un trabajo*
...
***************
gen subemp_ci=0
gen tothoras=real(ca_23_T60)
replace tothoras=. if ca_23_T60=="99"
...
drop ocupa
*/
replace ca_26_T60="." if ca_26_T60=="00"
...
gen yprid=real(ca_30_T601) if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="1"
replace yprid=real(ca_30_T601)*2 if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="2"
replace yprid=real(ca_30_T601)*3 if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="3"
replace yprid=real(ca_30_T601)*4.2 if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="4"
replace yprid=real(ca_30_T601)*22 if emp_ci==1 & (ca_29_T60>="2" & ca_29_T60<="4") & ca_30_T602=="5"
replace yprid=. if emp_ci==1 & ca_30_T602=="9"
...
gen yprid2=real(ca_20_T508) if ca_20_T501==1 & ca_20_T502=="" & ca_20_T503==""  & ca_20_T504=="." & ca_20_T505=="" & ca_20_T506=="" & ca_20_T507==""
replace yprid2=. if yprid2==99

gen yprid3=real(ca_46_T708) if ca_46_T701=="1" & ca_46_T702=="" & ca_46_T703==""  & ca_46_T704=="." & ca_46_T705=="" & ca_46_T706=="" & ca_46_T707==""
...
/*real(ca_31_T602) if emp_ci==1 & ca_31_T601=="1"
replace ylnm_ci=. if ylnm_ci==99 
...
*************
*inactivos*
gen temi=real(ca_20_T508)
replace temi=. if ca_20_T501==1 & ca_20_T502=="" & ca_20_T503==""  & ca_20_T504=="." & ca_20_T505=="" & ca_20_T506=="" & ca_20_T507==""
replace temi=. if temi==99

*ocupados*
gen temo=real(ca_33_T602) if emp_ci==1 & ca_33_T601=="1"
replace temo=. if temo==99

*desocupados*
gen temd=real(ca_46_T708)
replace temd=. if ca_46_T701=="1" & ca_46_T702=="" & ca_46_T703==""  & ca_46_T704=="." & ca_46_T705=="" & ca_46_T706=="" & ca_46_T707==""
replace temd=. if temd==99
...
gen byte yedc=.
gen yedc1=real(ca_11_T10) /*Todos*/
...
***************
gen asiste_ci=.
replace asiste_ci=1 if ca_10_T101=="1"
replace asiste_ci=0 if ca_10_T101=="2"
...
***************
gen edupub_ci=.
replace edupub_ci=1 if ca_10_T102=="1"
replace edupub_ci=0 if ca_10_T102=="2"
...
**aguared_ch***
***************
destring ca_4_T01_, replace
gen aguared_ch=(ca_4_T01_==1 | ca_4_T01_==2) // 1 De acueducto por tubería 2 De otra fuente por tubería
...
replace aguafconsumo_ch = 1 if ca_4_T01_==1  //2021 1 De acueducto por tubería
replace aguafconsumo_ch = 2 if ca_4_T01_==6 // 2021 7 De pila pública 
replace aguafconsumo_ch = 3 if ca_4_T01_==0  //2021 10 Agua embotellada o en bolsa
replace aguafconsumo_ch = 5 if ca_4_T01_==9  //2021 5 Aguas lluvias
replace aguafconsumo_ch = 6 if ca_4_T01_==7 //2021 8 Carrotanque
replace aguafconsumo_ch = 7 if ca_4_T01_==2 //2021 2 De otra fuente por tubería
replace aguafconsumo_ch = 8 if ca_4_T01_==5  //2021 6 Río, quebrada, nacimiento o manantial
replace aguafconsumo_ch = 9 if (ca_4_T01_==4 | ca_4_T01_==8) //2021 4 De pozo sin bomba, aljibe, jagüey o barreno + 9 Aguatero
replace aguafconsumo_ch = 10 if (ca_4_T01_==3) //2021 3 De pozo con bomba 

*****************
*aguafuente_ch*
*****************
gen aguafuente_ch =.
replace aguafuente_ch = 1 if ca_4_T01_==1  
replace aguafuente_ch = 2 if ca_4_T01_==6 
replace aguafuente_ch = 3 if ca_4_T01_==0 
replace aguafuente_ch = 5 if ca_4_T01_==9
replace aguafuente_ch = 6 if ca_4_T01_==7 
replace aguafuente_ch = 7 if ca_4_T01_==2 
replace aguafuente_ch = 8 if ca_4_T01_==5  
replace aguafuente_ch = 9 if (ca_4_T01_==4 | ca_4_T01_==8) 
replace aguafuente_ch = 10 if (ca_4_T01_==3) 
...
****bano_ch*****
****************
destring ca_2_T01, replace
gen bano_ch=.
replace bano_ch=0 if ca_2_T01==6
replace bano_ch=1 if ca_2_T01==1
replace bano_ch=2 if ca_2_T01==2
replace bano_ch=4 if ca_2_T01==5
replace bano_ch=6 if ca_2_T01==3 | ca_2_T01 ==4
replace bano_ch=6 if bano_ch ==. & jefe_ci==1
la var bano_ch"Tipo de instalación sanitaria que tiene el hogar"
la def bano_ch 	1 "Indoro a red de desagüe" 				///
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if ca_2_T01<6
...
*****luz_ch*****
****************
destring ca_4i_T013, replace
gen luz_ch=(ca_4i_T013==1)
replace luz_ch=. if ca_4i_T013==.
...
***combust_ch***
****************
destring ca_5_T01, replace
gen combust_ch=(ca_5_T01==1|ca_5_T01==3)
replace combust_ch =. if ca_5_T01==.
...
replace des2_ch = 1 if ca_2_T01 == 1 |ca_2_T01 == 2 |ca_2_T01 == 3 | ca_2_T01 == 4
replace des2_ch = 2 if ca_2_T01 == 5 
...
****piso_ch*****
****************}
destring ca_3i_T01, replace
g piso_ch = (ca_3i_T01 != 1 & ca_3i_T01 != .)
replace piso_ch = . if ca_3i_T01 == .
...
replace pared_ch = 1 if ca_2i_T01==1 |ca_2i_T01==2|ca_2i_T01==3
replace pared_ch = 2 if ca_2i_T01==4 |ca_2i_T01==5 |ca_2i_T01==6
...
****telef_ch****
****************
destring ca_4i_T014, replace
gen telef_ch= 1 if ca_4i_T014==1
replace telef_ch = . if ca_4i_T014 == .
la var telef_ch "El hogar tiene servicio telefónico fijo"

****************
****refrig_ch***
****************
destring  ca_8_T01_2, replace
g refrig_ch = 1 if ca_8_T01_2== 1
replace refrig_ch = . if ca_8_T01_2 == .
...
****vivi1_ch****
****************
destring ca_1i_T01, replace
g vivi1_ch = 1     	 if ca_1i_T01 == 1
replace vivi1_ch = 2 if ca_1i_T01 == 2
replace vivi1_ch = 3 if ca_1i_T01 == 3 | ca_1i_T01 == 4 | ca_1i_T01 == 5 
replace vivi1_ch = . if ca_1i_T01 == .
...
****vivi2_ch****
****************
g vivi2_ch = (ca_1i_T01== 1 | ca_1i_T01 == 2)
replace vivi2_ch = . if ca_1i_T01 == .
la var vivi2_ch "La vivienda es casa o departamento"

*******************
****viviprop_ch****
*******************
destring ca_6_T01_, replace
g viviprop_ch = 0 if ca_6_T01_ == 3
replace viviprop_ch = 1 if ca_6_T01_ == 1
replace viviprop_ch = 2 if ca_6_T01_ == 2
replace viviprop_ch = 3 if ca_6_T01_ == 4 | ca_6_T01_ == 5 | ca_6_T01_ == 6
replace viviprop_ch = . if ca_6_T01_ == .
...
/*PILAS: Desde 1996 zona_c NO ES MAS una clasificacion entre urbano y Rural, 
sino entre cabecera y resto
la definicion de rural tiene que ser tomada con cuidado puesto que es una 
definicion politico-geografica, no por densidad demografica*/
...
*****************
gen civil_ci=.
replace civil_ci=1 if re_6_T10_1=="5"
replace civil_ci=2 if re_6_T10_1=="1" | re_6_T10_1=="3" 
replace civil_ci=3 if re_6_T10_1=="2"
replace civil_ci=4 if re_6_T10_1=="4" 
label variable civil_ci "Estado civil"
label define civil_ci 1 "Soltero" 2 "Union formal o informal"
label define civil_ci 3 "Divorciado o separado" 4 "Viudo" , add
label value civil_ci civil_ci
...
****************
* 2014, 01 revision MLO
destring  re_19_T50 re_20_T50 re_22_T50 re_23_T50  re_24_T50 re_21_T50 re_22_T50 re_23_T50 re_25_T50, replace
/*
gen condocup_ci=.
replace condocup_ci=1 if (re_19_T50==1) | ((re_19_T50>=2 & re_19_T50<=8) & (re_20_T50==1|re_21_T50==1|re_22_T50==1 | re_23_T50>=1 & re_23_T50<=5))
*replace condocup_ci=1 if (re_19_T50==1) | ((re_19_T50>=2 & re_19_T50<=8) & (re_20_T50==1 |re_21_T50==1))
replace condocup_ci=2 if (condocup_ci!=1) & (re_24_T50==1)
replace condocup_ci=3 if condocup_ci!=1 & condocup_ci!=2
replace condocup_ci= . if re_19_T50==.

/*replace condocup_ci=1 if (re_19_T50=="1") | ((re_19_T50>="2" & re_19_T50<="8") & (re_20_T50=="1" |re_21_T50=="1"))
replace condocup_ci=2 if (re_19_T50>="2" & re_19_T50<="8") & (re_24_T50=="1")
replace condocup_ci=3 if condocup_ci!=1 & condocup_ci!=2
replace condocup_ci= . if re_19_T50=="."*/
replace condocup_ci=4 if edad_ci<10
*/
...
*ypen_ci*
*************
gen pension1=real(re_56_T708) if re_56_T704=="1"
gen pension2=real(re_44_T607) if re_44_T603=="1"
recode pension2 (100000000=.)
egen aux_p=rsum(pension1 pension2), m
gen ypen_ci=aux_p if aux_p>0 & aux_p<.
replace ypen_ci= . if aux_p==9999999999  | aux_p==99
label var ypen_ci "Valor de la pension contributiva"
...
replace trab=1 if (re_19_T50>="2" & re_19_T50<="8") & (re_20_T50=="1" |re_21_T50=="1")
...
***desemp3_ci***
****************
gen desemp3_ci=(re_24_T50=="1")
/* Es desempleado: en la ultimo año*/
...
***************
gen subemp_ci=0
gen tothoras=real(re_40_T60)  if emp_ci==1
replace tothoras=. if re_40_T60=="99"
replace subemp_ci=1 if tothoras<=30 & emp_ci==1 & re_41_T60=="1"
...
gen tiempoparc_ci=0
replace tiempoparc_ci=1 if tothoras<=30 & emp_ci==1 & re_41_T60=="2"
...
gen segsoc_ci=.
replace segsoc_ci=(re_43_T602=="1") if emp_ci==1
...
drop ocupa
*/
replace re_27_T60="." if re_27_T60=="00"
...
/*Remuneracion al empleo para categopri 1, 2 y 3 , el resto es missing*/
generat yprid=real(re_31_T601)     if emp_ci==1 & re_31_T602=="1"
replace yprid=real(re_31_T601)*4.2 if emp_ci==1 & re_31_T602=="2" 
replace yprid=real(re_31_T601)*22  if emp_ci==1 & re_31_T602=="3" 
replace yprid=.                    if emp_ci==1 & re_31_T602=="4" 
...
gen ylmsec=real(re_39_T60) if emp_ci==1 
replace ylmsec=. if ylmsec_ci==98 /*no sabe*/
replace ylmsec=. if ylmsec_ci==99 /*no informa*/
...
*para inactivos y desempleados VER COUNTRY SPECIFIC CODE BOOK
gen yprid2=real(re_56_T708) if re_56_T701=="1" & re_56_T702==""  & re_56_T703=="" & re_56_T704=="" & re_56_T705=="" & re_56_T706=="" & re_56_T707=="" 
replace yprid2=. if yprid2==99
...
gen temi=real(re_56_T708)
replace temi=. if re_56_T701=="1" & re_56_T702==""  & re_56_T703=="" & re_56_T704=="" & re_56_T705=="" & re_56_T706=="" & re_56_T707=="" 
replace temi=. if temi==99
*ocupados*
gen temo=real(re_44_T607) if emp_ci==1 
replace temo=. if temo==99

egen ynlm_ci=rsum(temi temo)
replace ynlm_ci=. if temo==. & temi==.
replace  ynlm_ci=. if  ynlm_ci>=100000000
...
*** people who have missings
gen byte yedc=.
gen yedc1=real(re_10_T10) /*Todos*/
replace yedc=. if yedc1==999
...
***************
gen asiste_ci=.
replace asiste_ci=1 if re_9_T10_1=="1"
replace asiste_ci=0 if re_9_T10_1=="2"
label variable asiste_ci "Asiste actualmente a la escuela"
...
***************
gen edupub_ci=.
replace edupub_ci=1 if re_9_T10_2=="1"
replace edupub_ci=0 if re_9_T10_2=="2"
label variable edupub_ci "Asiste a centros publicos"
...
**aguared_ch***
***************
destring re_4_T01_, replace
gen aguared_ch=(re_4_T01_==1 | re_4_T01_==2) // 1 De acueducto por tubería 2 De otra fuente por tubería
la var aguared_ch "Acceso a fuente de agua por red"
...
*se clasificó sel 2000 sobre la base del 2021
gen aguafconsumo_ch = 0 //2021 0 La encuesta no pregunta sobre agua para beber
replace aguafconsumo_ch = 1 if re_4_T01_==1  //2021 1 De acueducto por tubería
replace aguafconsumo_ch = 2 if re_4_T01_==6 // 2021 7 De pila pública 
replace aguafconsumo_ch = 3 if re_4_T01_==0  //2021 10 Agua embotellada o en bolsa
replace aguafconsumo_ch = 5 if re_4_T01_==9  //2021 5 Aguas lluvias
replace aguafconsumo_ch = 6 if re_4_T01_==7 //2021 8 Carrotanque
replace aguafconsumo_ch = 7 if re_4_T01_==2 //2021 2 De otra fuente por tubería
replace aguafconsumo_ch = 8 if re_4_T01_==5  //2021 6 Río, quebrada, nacimiento o manantial
replace aguafconsumo_ch = 9 if (re_4_T01_==4 | re_4_T01_==8) //2021 4 De pozo sin bomba, aljibe, jagüey o barreno + 9 Aguatero
replace aguafconsumo_ch = 10 if (re_4_T01_==3) //2021 3 De pozo con bomba 

*****************
*aguafuente_ch*
*****************
gen aguafuente_ch =.
replace aguafconsumo_ch = 1 if re_4_T01_==1  
replace aguafconsumo_ch = 2 if re_4_T01_==6 
replace aguafconsumo_ch = 3 if re_4_T01_==0 
replace aguafconsumo_ch = 5 if re_4_T01_==9
replace aguafconsumo_ch = 6 if re_4_T01_==7 
replace aguafconsumo_ch = 7 if re_4_T01_==2 
replace aguafconsumo_ch = 8 if re_4_T01_==5  
replace aguafconsumo_ch = 9 if (re_4_T01_==4 | re_4_T01_==8) 
replace aguafconsumo_ch = 10 if (re_4_T01_==3) 
replace aguafuente_ch = 10 if aguafuente_ch ==. & jefe_ci==1
...
****bano_ch*****
****************
destring re_2_T01, replace
gen bano_ch=.
replace bano_ch=0 if re_2_T01==6
replace bano_ch=1 if re_2_T01==1
replace bano_ch=2 if re_2_T01==2
replace bano_ch=4 if re_2_T01==5
replace bano_ch=6 if re_2_T01==3 | re_2_T01 ==4
replace bano_ch=6 if bano_ch ==. & jefe_ci==1
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if re_2_T01<6
...
*****luz_ch*****
****************
destring re_4i_T013, replace
gen luz_ch=(re_4i_T013==1)
replace luz_ch=. if re_4i_T013==.
la var luz_ch  "La principal fuente de iluminación es electricidad"
...
***combust_ch***
****************
destring re_5_T01, replace
gen combust_ch=(re_5_T01==1|re_5_T01==3)
replace combust_ch =. if re_5_T01==.
la var combust_ch "Principal combustible gas o electricidad" 
...
g des2_ch = .
replace des2_ch = 0 if bano_ch == 0
replace des2_ch = 1 if re_2_T01 == 1 |re_2_T01 == 2 |re_2_T01 == 3 | re_2_T01 == 4
replace des2_ch = 2 if re_2_T01 == 5 
la var des2_ch "Tipo de desague sin incluir definición MDG"
la def des2_ch 	0 "No tiene servicio sanitario" 								///
					1 "Conectado a red general, cámara pséptica, pozo o letrina" 	///
					2 "Cualquier otro caso"
...
****piso_ch*****
****************}
destring re_3i_T01, replace
g piso_ch = (re_3i_T01 != 1 & re_3i_T01 != .)
replace piso_ch = . if re_3i_T01 == .
la var piso_ch "Materiales de construcción del piso"  
la def piso_ch 	0 "Piso de tierra" 			///
				1 "Materiales permanentes: cemento, cerámica, mosaico, madera" ///
				2 "otros materiales: natural, otros"
...
g pared_ch = .
replace pared_ch = 0 if re_2i_T01== 7
replace pared_ch = 1 if re_2i_T01==1 |re_2i_T01==2|re_2i_T01==3
replace pared_ch = 2 if re_2i_T01==4 |re_2i_T01==5 |re_2i_T01==6
la var pared_ch "Materiales de la pared"  
la def pared_ch 0 "No permanentes: desechos, zinc, tela, cartón." 			///
				1 "Materiales permanentes: paredes de ladrillo, adobe revocado, cemento y hormigón." ///
				2 "Otros materiales: naturales, otros."
...
****telef_ch****
****************
destring re_4i_T014, replace
gen telef_ch= 1 if re_4i_T014==1
replace telef_ch = . if re_4i_T014 == .
la var telef_ch "El hogar tiene servicio telefónico fijo"

****************
****refrig_ch***
****************
destring  re_8_T01_2, replace
g refrig_ch = 1 if re_8_T01_2== 1
replace refrig_ch = . if re_8_T01_2 == .
la var refrig_ch "El hogar posee refrigerador o heladera"	
...
****vivi1_ch****
****************
destring re_1i_T01, replace
g vivi1_ch = 1     	 if re_1i_T01 == 1
replace vivi1_ch = 2 if re_1i_T01 == 2
replace vivi1_ch = 3 if re_1i_T01 == 3 | re_1i_T01 == 4 | re_1i_T01 == 5 
replace vivi1_ch = . if re_1i_T01 == .
la var vivi1_ch "Tipo de vivienda en la que reside el hogar"
la de vivi1_ch 	1 "Casa" ///
				2 "Departamento" ///
				3 "Otros"
...
****vivi2_ch****
****************
g vivi2_ch = (re_1i_T01== 1 | re_1i_T01 == 2)
replace vivi2_ch = . if re_1i_T01 == .
la var vivi2_ch "La vivienda es casa o departamento"

*******************
****viviprop_ch****
*******************
destring re_6_T01_, replace
g viviprop_ch = 0 if re_6_T01_ == 3
replace viviprop_ch = 1 if re_6_T01_ == 1
replace viviprop_ch = 2 if re_6_T01_ == 2
replace viviprop_ch = 3 if re_6_T01_ == 4 | re_6_T01_ == 5 | re_6_T01_ == 6
replace viviprop_ch = . if re_6_T01_ == .
la var viviprop_ch "Propiedad de la vivienda"
la de viviprop_ch 	0 "Alquilada" 					///
					1 "Propia y totalmente pagada" 	///
					2 "Propia y en proceso de pago" ///
