...
replace rama_ci=1 if rama1>=11 & rama1<=13   & emp_ci==1
replace rama_ci=2 if rama1>=21 & rama1<=29   & emp_ci==1
replace rama_ci=3 if rama1>=31 & rama1<=39   & emp_ci==1
replace rama_ci=4 if rama1>=41 & rama1<=42   & emp_ci==1
replace rama_ci=5 if rama1==50  & emp_ci==1
replace rama_ci=6 if rama1>=61 & rama1<=63  & emp_ci==1
replace rama_ci=7 if rama1>=71 & rama1<=72   & emp_ci==1
replace rama_ci=8 if rama1>=81 & rama1<=83   & emp_ci==1
replace rama_ci=9 if rama1>=91 & rama1<=96  & emp_ci==1
drop rama1
...
replace yedc=0 if (yedc1==100 | yedc1==200| yedc1==300) 
...
gen byte edupre_ci=(yedc1==200|yedc1==201)
...
****bano_ch*****
****************
*Se corrige ca_3_T00_=="." por ca_3_T00_!="."
...
* Modificaciones Marcela Rubio Septiembre 2014: variable des2_ch habia sido creada como missing
gen des2_ch=.
replace des2_ch = 0 if ca_3_T00_=="4"
...
****************
*2014, 01 revision MLO
destring re_19_T03 re_20_T03  re_21_T03 re_22_T03   re_22_T03 re_24_T03 re_23_T03 re_25_T03, replace
/*
gen condocup_ci=.
...
recode pension1 (9999999=.) (9999998=.)
recode pension2 (9999999=.) (9999998=.)
egen aux_p=rsum(pension1 pension2), m
gen ypen_ci=aux_p if aux_p>0 & aux_p<.
replace ypen_ci= . if aux_p==9999999999  | aux_p==99
label var ypen_ci "Valor de la pension contributiva"
...
replace rama_ci=2 if rama1>=21 & rama1<=29  & emp_ci==1
replace rama_ci=3 if rama1>=31 & rama1<=39  & emp_ci==1
replace rama_ci=4 if rama1>=40 & rama1<=49  & emp_ci==1
replace rama_ci=5 if rama1==50 & emp_ci==1
replace rama_ci=6 if rama1>=61 & rama1<=63  & emp_ci==1
replace rama_ci=7 if rama1>=71 & rama1<=72  & emp_ci==1
replace rama_ci=8 if rama1>=81 & rama1<=83  & emp_ci==1
...
replace yprid=real(re_31_T0401)*4.3 if emp_ci==1  & re_31_T0402=="2"
...
/*Ganancia los trabajos para patrones y cuenta propia ANUAL*/
...
** No educacion, preescolar, jardin o pre-primaria
replace yedc=0 if (yedc1==100 | yedc1==200|yedc1==201 |yedc1==300) 
/*100 ninguno, 200 es preescolar y 300 es primaria y ningun anio terminado*/
...
gen aguamala_ch=.
replace aguamala_ch=(re_5_T01 !="1" & re_5_T01 !="2")
...
gen bano_ch=.
replace bano_ch=(re_3_T01=="1"| re_3_T01=="2"| re_3_T01=="3")
...
* Modificaciones Marcela Rubio Septiembre 2014: variable des2_ch habia sido creada como missing
gen des2_ch=.
replace des2_ch = 0 if re_3_T01=="4"
...
g       aguamejorada_ch = 1 if (re_5_T01  >=1 & re_5_T01 <=2) | (re_5_T01 >=4 & re_5_T01 <=5) | re_5_T01 ==7
replace aguamejorada_ch = 0 if  re_5_T01 ==3 | re_5_T01 ==6 | re_5_T01 ==8
...
/*
casos en los que vivialq_ch< 100 pesos, muy raro 2.34% de la muestra,0.73% de los hogares
tab uno , m

        uno |      Freq.     Percent        Cum.
------------+-----------------------------------
          1 |        763        2.34        2.34
          . |     31,909       97.66      100.00
------------+-----------------------------------
