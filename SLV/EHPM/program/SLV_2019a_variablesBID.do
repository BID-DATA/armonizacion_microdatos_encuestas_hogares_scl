...
replace aguafuente_ch = 1 if r312 == 6.0
...
replace aguafuente_ch = 4  if r313 == 5.0    /* Pozo protegido privado          - pozo protegido */
replace aguafuente_ch = 4  if r313 == 5.1  /* Pozo protegido público          - pozo protegido */
replace aguafuente_ch = 5  if r313 == 8.0    /* Manantial protegido             - manantial prot. */
...
replace aguafuente_ch = 7  if inlist(r313, 1, 11.0) /* Cañería vecino/acarreo vecino - otra mejorada */
replace aguafuente_ch = 7  if r313 == 10.0   /* Colecta agua lluvia             - lluvia */
replace aguafuente_ch = 8  if r313 == 6.0    /* Pozo no protegido privado       - pozo no prot. */
replace aguafuente_ch = 8  if r313 == 9.0   /* Manantial no protegido          - fuente no prot. */
replace aguafuente_ch = 9  if r313 == 6.1  /* Pozo no protegido público    	  - superficial */
replace aguafuente_ch = 9  if r313 == 7.0    /* Ojo de agua, río o quebrada     - superficial */
replace aguafuente_ch = 10 if r313 == 4.1  /* Pozo con tubería publica        -  */
replace aguafuente_ch = 10 if r313 == 13.0   /* Otros medios                    - sin info */
