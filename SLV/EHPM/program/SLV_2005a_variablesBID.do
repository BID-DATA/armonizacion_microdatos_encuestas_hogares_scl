...
replace desalent_ci = 1 if ((r406 == 2 & (r407 == 2 | r407 == 3) & condocup_ci == 3))
...
replace ocupa_ci=4 if (r414>=9110 & r414<=9113) | (r414>=5200 & r414<=5260) 
...
replace ocupa_ci=. if emp_ci==0 | r414==9999 | r414==0
...
replace yprid= 999999 	if r423>=999999 & r423!=.

gen hrsextrasd=.
replace hrsextrasd= r42401a*r42401b/12
replace hrsextrasd= 999999 if (r42401a>=999999 & r42401a!=.) | r42401b==999

gen vacacionesd=.
replace vacacionesd= r42402a*r42402b/12
replace vacacionesd=999999 if  (r42402a>=999999 & r42402a!=.) |  r42402b==999

gen aguinaldod=.
replace aguinaldod= r42403a*r42403b/12
replace aguinaldod=999999 if  (r42403a>=999999 & r42403a!=.) |  r42403b==999

gen bonificacionesd=.
replace bonificacionesd= r42404a*r42404b/12
replace bonificacionesd=999999 if  (r42404a>=999999 & r42404a!=.) |  r42404b==999
...
replace yprijbi=999999       if (ingrneto>=999999 & ingrneto!=.) | r426==99
...
gen ysec1=r433
replace ysec1=. if r433>=999999 & r433!=.

gen hrsextras=.
replace hrsextras=r43401a*r43401b/12
replace hrsextras=. if (r43401a>=999999 & r43401a!=.) | r43401b==999

gen vacaciones=.
replace vacaciones=r43402a*r43402b/12
replace vacaciones=. if (r43402a>=999999 & r43402a!=.) | r43402b==999

gen aguinaldo=.
replace aguinaldo=r43403a*r43403b/12
replace aguinaldo=. if (r43403a>=999999 & r43403a!=.) | r43403b==999

gen bonificaciones=.
replace bonificaciones=r43404a*r43404b/12
replace bonificaciones=. if (r43404a>=999999 & r43404a!=.) | r43404b==999
...
replace remesasext=. if (r44301a>=999999 & r44301a!=.) | r44301b==999

gen ayuda=.
replace ayuda=r44302a*r44302b/12
replace ayuda=. if (r44302a>=999999 & r44302a!=.) | r44302b==999

gen cuotalim=.
replace cuotalim=r44303a*r44303b/12
replace cuotalim=. if (r44303a>=999999 & r44303a!=.) | r44303b==999

gen alqui=.
replace alqui=r44304a*r44304b/12
replace alqui=. if (r44304a>=999999 & r44304a!=.) | r44304b==999

gen alqneg=.
replace alqneg=r44305a*r44305b/12
replace alqneg=. if (r44305a>=999999 & r44305a!=.) | r44305b==999

gen jubil=.
replace jubil=r44306a*r44306b/12
replace jubil=. if (r44306a>=999999 & r44306a!=.) | r44306b==999

gen deveh=.
replace deveh=r44308a*r44308b/12
replace deveh=. if (r44308a>=999999 & r44308a!=.) | r44308b==999

* rename otros otros1
gen otros=.
replace otros=r44309a*r44309b/12
replace otros=. if (r44309a>=999999 & r44309a!=.) | r44309b==999

gen utilidades=.
replace utilidades=r44401/12
replace utilidades=. if r44401>=999999 & r44401!=.

gen dividendos=.
replace dividendos=r44402/12
replace dividendos=. if r44402>=999999 & r44402!=.

gen intereses=.
replace intereses=r44403/12
replace intereses=. if r44403>=999999 & r44403!=.

gen herencias=.
replace herencias=r44404/12
replace herencias=. if r44404>=999999 & r44404!=.

gen indemnizacion=.
replace indemnizacion=r44405/12
replace indemnizacion=. if r44405>=999999 & r44405!=.

gen ayudagob=.
replace ayudagob=r44406/12
replace ayudagob=. if r44406>=999999 & r44406!=.

gen acteventual=.
replace acteventual=r44407/12
replace acteventual=. if r44407>=999999 & r44407!=.

gen arrendamiento=.
replace arrendamiento=r44408/12
replace arrendamiento=. if r44408>=999999 & r44408!=.

gen otross=.
replace otross=r44409/12
replace otross=. if r44409>=999999 & r44409!=.
...
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted
...
replace cotizando_ci = 1 if ((r421 == 1) & emp_ci==1)
...
*ypen_ci*
*************
* MGD 12/22/2015: faltaba recodificar missings
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 132.90	if mes_c==1 & zona_c==1
replace lpe_ci= 132.90	if mes_c==2 & zona_c==1
replace lpe_ci= 132.00	if mes_c==3 & zona_c==1
replace lpe_ci= 130.80	if mes_c==4 & zona_c==1
replace lpe_ci= 132.00	if mes_c==5 & zona_c==1
replace lpe_ci= 135.30	if mes_c==6 & zona_c==1
replace lpe_ci= 136.50	if mes_c==7 & zona_c==1
replace lpe_ci= 136.50	if mes_c==8 & zona_c==1
replace lpe_ci= 136.50	if mes_c==9 & zona_c==1
replace lpe_ci= 142.50	if mes_c==10 & zona_c==1
replace lpe_ci= 138.90	if mes_c==11 & zona_c==1
replace lpe_ci= 138.90  if mes_c==12 & zona_c==1

*zona rural
replace lpe_ci=100.80	if mes_c==1 & zona_c==0
replace lpe_ci=100.80	if mes_c==2 & zona_c==0
replace lpe_ci=99.60	if mes_c==3 & zona_c==0
replace lpe_ci=99.60	if mes_c==4 & zona_c==0
replace lpe_ci=100.80	if mes_c==5 & zona_c==0
replace lpe_ci=100.80	if mes_c==6 & zona_c==0
replace lpe_ci=102.00	if mes_c==7 & zona_c==0
replace lpe_ci=100.80	if mes_c==8 & zona_c==0
replace lpe_ci=99.60	if mes_c==9 & zona_c==0
replace lpe_ci=103.50	if mes_c==10 & zona_c==0
replace lpe_ci=102.00	if mes_c==11 & zona_c==0
replace lpe_ci=102.00   if mes_c==12 & zona_c==0
...
*****************	
gen categoinac_ci=.	
replace categoinac_ci=1 if r407==9 & condocup_ci == 3
replace categoinac_ci=2 if (r407==5 | r407==11) & condocup_ci == 3
replace categoinac_ci=3 if r407==8 & condocup_ci == 3
...
/*_____________________________________________________________________________________________________*/
  ...
  afro_ci ind_ci noafroind_ci afroind_ci afro_ch ind_ch noafroind_ch afroind_ch dis_ci disWG_ci dis_ch SLV_dis_ci /// Diversidad
