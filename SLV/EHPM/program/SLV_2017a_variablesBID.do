...
Fecha última modificación: Julio de 2018
...
*zona urbana
replace lp_ci= 53.06*2 if  zona_c == 1

*zona rural
replace lp_ci= 32.74*2 if  zona_c == 0
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 53.06 if zona_c == 1

*zona rural
replace lpe_ci= 32.74 if  zona_c == 0
...
*http://www.mtps.gob.sv/wp-content/uploads/descargas/InformacionInstitucional/SalarioMinimo/tabla-salarios-minimos-2017.pdf
**Aplica para 2017**

g salmm_ci=.
replace salmm_ci=221.2 if rama_ci==1
replace salmm_ci=297.6 if rama_ci==3
replace salmm_ci=300.0 if rama_ci==6
