...
Fecha última modificación: Julio de 2017
...
*zona urbana
replace lp_ci= 53.61*2 if  zona_c == 1

*zona rural
replace lp_ci= 33.45*2 if  zona_c == 0
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 53.61 if zona_c == 1

*zona rural
replace lpe_ci= 33.45 if  zona_c == 0
...
*http://www.mtps.gob.sv/wp-content/uploads/descargas/InformacionInstitucional/SalarioMinimo/SalarioMinimoVigente2015.pdf
*http://www.mtps.gob.sv/descargas-informacion-institucional/
**Aplica para 2015 y 2016**

g salmm_ci=.
replace salmm_ci=124.9 if rama_ci==1
replace salmm_ci=228.8 if rama_ci==3
replace salmm_ci=251.7 if rama_ci==6
replace salmm_ci=201.8 if salmm_ci==. /* promedio de resto de ramas*/
