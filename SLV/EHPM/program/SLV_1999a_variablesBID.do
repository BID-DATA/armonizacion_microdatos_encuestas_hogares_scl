...
replace aguafuente_ch = 2 if r313==3
replace aguafuente_ch = 4 if r313==6
replace aguafuente_ch = 6 if r313==5
replace aguafuente_ch = 7 if r313==7
replace aguafuente_ch = 8 if r313==8
replace aguafuente_ch = 9 if r313==4|r313==9
...
*************
gen aguatrat_ch=.
replace aguatrat_ch = 1 if r315==1|r315==2|r315==3|r315==5
