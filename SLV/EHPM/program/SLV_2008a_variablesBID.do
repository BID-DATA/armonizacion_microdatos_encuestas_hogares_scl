...
replace aguafuente_ch = 1 if inlist(r312, 1, 2)
/* r312==6: tiene cañería pero sin servicio - tratamos como piped */
replace aguafuente_ch = 1 if r312 == 4
...
replace aguafuente_ch = 7  if r313 == 1 /* Cañería vecino/acarreo vecino - otra mejorada */
