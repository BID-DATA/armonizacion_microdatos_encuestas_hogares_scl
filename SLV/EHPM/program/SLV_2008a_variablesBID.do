...
replace aguafuente_ch = 1 if inlist(r312, 1, 2)			// Cañería (piped), red de distribución 
...
replace aguafuente_ch = 7  if inlist(r313, 1, 8)		// Otra fuente mejorada
...
replace bano_ch=4 if inlist(r318,1,2) & (r324a == 3 |r324a == 4)
replace bano_ch=6 if (r319==5 | r319==6)
replace bano_ch=0 if inlist(r318,3,4,5)
...
replace sinbano_ch = 1 if inlist(r318,3) | (r318 ==5 & inlist(r324a,1,2))
replace sinbano_ch = 2 if (r324a==4 | r324a==3)& r318==5
...
*afiliado_ci****
****************
***** No se tiene variable para construir "afiliado_ci" ya que la variable r108a literal dice: Durante el mes anterior (NOMBRE) tuvo alguna enfermedad o accidente *****.
gen afiliado_ci=.
