...
Fecha última modificación: 9 de diciembre de 2016
...
label define desemp_c1 0"No " 1"Si", add
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 190.66 if mes_c==1 & zona_c == 1
replace lpe_ci= 193.61 if mes_c==2 & zona_c == 1
replace lpe_ci= 196.56 if mes_c==3 & zona_c == 1
replace lpe_ci= 200.26 if mes_c==4 & zona_c == 1
replace lpe_ci= 200.91 if mes_c==5 & zona_c == 1
replace lpe_ci= 203.59 if mes_c==6 & zona_c == 1
replace lpe_ci= 205.27 if mes_c==7 & zona_c == 1
replace lpe_ci= 205.89 if mes_c==8 & zona_c == 1
replace lpe_ci= 204.1 if mes_c==9 & zona_c == 1
replace lpe_ci= 203.45  if mes_c==10 & zona_c == 1
replace lpe_ci= 202.18 if mes_c==11 & zona_c == 1
replace lpe_ci= 203.86 if mes_c==12 & zona_c == 1

*zona rural
replace lpe_ci= 134.95 if mes_c==1 & zona_c == 0
replace lpe_ci= 139.92 if mes_c==2 & zona_c == 0
replace lpe_ci= 143.42 if mes_c==3 & zona_c == 0
replace lpe_ci= 145.03 if mes_c==4 & zona_c == 0
replace lpe_ci= 144.89 if mes_c==5 & zona_c == 0
replace lpe_ci= 149.42 if mes_c==6 & zona_c == 0
replace lpe_ci= 151.03 if mes_c==7 & zona_c == 0
replace lpe_ci= 153.81 if mes_c==8 & zona_c == 0
replace lpe_ci= 149.28 if mes_c==9 & zona_c == 0
replace lpe_ci= 148.25 if mes_c==10 & zona_c == 0
replace lpe_ci= 146.06 if mes_c==11 & zona_c == 0
replace lpe_ci= 145.92 if mes_c==12 & zona_c == 0
