...
replace aguafuente_ch = 4  if inrange(r313, 5.05, 5.15)  /* Pozo protegido público          - pozo protegido */
...
replace aguafuente_ch = 7  if inrange(r312, 4.05, 4.15)  /* Tubería por poliducto (buen estado) - otra mejorada */
...
replace aguafuente_ch = 9  if inrange(r313, 6.05, 6.15)  /* Pozo no protegido público    	  - superficial */
replace aguafuente_ch = 9  if r313 == 7    /* Ojo de agua, río o quebrada     - superficial */
replace aguafuente_ch = 10 if inrange(r313, 4.05, 4.15)  /* Pozo con tubería publica        -  */
