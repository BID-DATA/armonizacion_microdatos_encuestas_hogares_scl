...
gen probsalud_ci=1 if ENFERMO!=4
replace probsalud_ci=0 if ENFERMO==4
...
*** distancia_ci  ***
*********************
gen distancia_ci=1 if PQNOASIS==2
recode distancia_ci(.=0) if PQNOASIS!=.
...
*** costo_ci  ***
*****************
gen costo_ci=1 if PQNOASIS==3
recode costo_ci (.=0) if PQNOASIS!=.
...
*** atencion_ci  ***
********************
gen atencion_ci=1 if PQNOASIS==1 | PQNOASIS==4 | PQNOASIS==5 | PQNOASIS==7
recode atencion_ci (.=0) if PQNOASIS!=.
