...
g aedu_ci=aproba1
* Una observación declara -1 anios de educación, se corrige. 
replace aedu_ci = . if aedu_ci == -1 
/*
...
gen lp_ci =.
*zona urbana
replace lp_ci= 53.39*2 if  zona_c == 1

*zona rural
replace lp_ci= 34.00*2 if  zona_c == 0
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 53.39 if zona_c == 1

*zona rural
replace lpe_ci= 34.00 if  zona_c == 0
