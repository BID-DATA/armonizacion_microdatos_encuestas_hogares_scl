...
******************************
gen mes_c= .
label define mes_c 1 "First" 2 "Second" 
...
*en 05 hay 19742/70066 missing values; en 06 hay 18843/68312 missing values; en 07 hay 18032/69138 missing values
...
replace categosec_ci=2 if r439==2 | r439==3
replace categosec_ci=3 if r439==6 | r439==7 |r439==8 | r439==9 |r439==4 | r439==10
...
*	firmapeq_ci
******************************
gen firmapeq_ci=(r420<=5) if emp_c==1
...
******************************
g ocupa_ci=.
replace ocupa_ci=1 if (r414>=2111 & r414<=3512) 
replace ocupa_ci=2 if (r414>=1110 & r414<=1319) 
replace ocupa_ci=3 if (r414>=4110 & r414<=4223)
replace ocupa_ci=4 if (r414>=9110 & r414<=9113) | (r414>=5210 & r414<=5250) 
...
replace rama_ci=9 if (r416>=7500 & r416<=9900)  & emp_ci==1 
...
gen otross1=r42412a*r42412b/12 if emp_ci==1 
...
gen otross2=r43412a*r43412b/12 if emp_ci==1
...
*	durades_ci
******************************
gen durades_ci=r409/4.3 if /*desemp_ci==1 & */r409>0  
******************************
*	antiguedad_ci
******************************
gen antiguedad_ci=.
...
***eduui_ci***
**************
gen eduui_ci = (inlist(r204, 4, 5)) | (inlist(r219a, 4, 5) & inlist(r220, 1, 2))
...
***eduuc_ci***
**************
gen eduuc_ci = inlist(r219a, 4, 5) & inrange(r220, 3, 10)
...
**************
gen eduac_ci = .
replace eduac_ci = 1 if r204 == 4 | r219a == 4
replace eduac_ci = 0 if r204 == 5 | r219a == 5
...
replace tipocontrato_ci=2 if (r418==1 & r418a>0 & r418a<=12) & emp_ci==1
...
gen lpe_ci =.
*zona urbana
replace lpe_ci= 145.20	if mes_c==1 & zona_c==1
replace lpe_ci= 141.60	if mes_c==2 & zona_c==1
replace lpe_ci= 141.60	if mes_c==3 & zona_c==1
replace lpe_ci= 140.70	if mes_c==4 & zona_c==1
replace lpe_ci= 138.30	if mes_c==5 & zona_c==1
replace lpe_ci= 141.60	if mes_c==6 & zona_c==1
replace lpe_ci= 146.40	if mes_c==7 & zona_c==1
replace lpe_ci= 146.40	if mes_c==8 & zona_c==1
replace lpe_ci= 147.30	if mes_c==9 & zona_c==1
replace lpe_ci= 152.10	if mes_c==10 & zona_c==1
replace lpe_ci= 161.10	if mes_c==11 & zona_c==1
replace lpe_ci= 155.40  if mes_c==12 & zona_c==1

*zona rural
replace lpe_ci=100.50	if mes_c==1 & zona_c==0
replace lpe_ci=99.30	if mes_c==2 & zona_c==0
replace lpe_ci=100.50	if mes_c==3 & zona_c==0
replace lpe_ci=100.50	if mes_c==4 & zona_c==0
replace lpe_ci=102.00	if mes_c==5 & zona_c==0
replace lpe_ci=111.00	if mes_c==6 & zona_c==0
replace lpe_ci=116.40	if mes_c==7 & zona_c==0
replace lpe_ci=116.40	if mes_c==8 & zona_c==0
replace lpe_ci=117.60	if mes_c==9 & zona_c==0
replace lpe_ci=120.30	if mes_c==10 & zona_c==0
replace lpe_ci=125.70	if mes_c==11 & zona_c==0
replace lpe_ci=119.10   if mes_c==12 & zona_c==0
...
*****************	
gen categoinac_ci=.	
replace categoinac_ci=1 if r407==13 & condocup_ci == 3
replace categoinac_ci=2 if (r407==8 | r407==15) & condocup_ci == 3
replace categoinac_ci=3 if r407==12 & condocup_ci == 3
