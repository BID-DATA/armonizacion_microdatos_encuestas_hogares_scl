...
replace cotizando_ci = 1 if (inlist(i_j13, 1, 2, 3) & emp_ci==1)
...
replace desalent_ci = 1 if (inlist(i_n02, 2, 11) & condocup_ci == 3)
...
/*_____________________________________________________________________________________________________*/
  ...
  afro_ci ind_ci noafroind_ci afroind_ci afro_ch ind_ch noafroind_ch afroind_ch dis_ci disWG_ci dis_ch HTI_dis_ci /// Diversidad
