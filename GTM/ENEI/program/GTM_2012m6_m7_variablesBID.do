...
**            1 xinka; 2 garifuna; 3 ladino; 4 extranjero; 5 maya
	...
	*********
	gen byte afro_ci = .
	replace afro_ci = 1 if ppa06 == 2 
	replace afro_ci = 0 if ppa06 != 2 & ppa06 != . 
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = . 		
	replace ind_ci = 1  if (ppa06 == 1 | ppa06 == 2 | ppa06 == 5)
	replace ind_ci = 0  if (ppa06 != 1 & ppa06 != 2 & ppa06 != 5) & ppa06 != . 
...
replace desalent_ci = 1 if (p04b02 == 2 & (p04b05 >= 3 & p04b05 <= 5) & condocup_ci == 3)
...
replace aedu_ci = p03a04 + 11 if p03a03 == 5 // Superior
replace aedu_ci = p03a04 + 16 if p03a03 == 6 // Maestría 
replace aedu_ci = p03a04 + 18 if p03a03 == 7 // Doctorado
lab var aedu_ci "Anios de educacion aprobados"
...
***eduui_ci***
**************
gen eduui_ci = ((p03a03 == 5)&  inrange(p03a05b, 103, 499)) 
...
***eduuc_ci***
**************
gen eduuc_ci = (((p03a03 == 5) & inrange(p03a05b, 500, 7100))| inlist(p03a03, 6, 7))
...
***eduac_ci***
**************
gen eduac_ci = (inrange(p03a05b, 2000, 7100))
replace eduac_ci = . if (p03a05b == . |  p03a05b <= 499)
...
******************************
g byte asispre_ci = 0
replace asispre_ci = 1 if p03a03 == 1 & p03a02 == 1
...
replace asiste_ci = 0 if (p03a02 == 2 | p03a02 == 3)
...
******************************
// No hay pregunta sobre tipo de centro educativo
g edupub_ci=.
...
*****************
gen bano_ch=.
replace bano_ch=0 if p02b06==5
replace bano_ch=1 if p02b06==1
replace bano_ch=2 if p02b06==2
replace bano_ch=6 if p02b06==3|p02b06==4
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if p02b06!=5
