...
*Para trabajadores de exportadora y maquila Q.72.36 diarios
gen salmm_ci= 78.72*30 /*Para agrícolas y no agrícolas*/
...
destring p03a02 p03a03 p03a04a p03a05a p03a05b p03a06b, replace force
...
***************
gen eduuc_ci = 0
replace eduuc_ci = 1 if p03a05a == 5 & inrange(p03a06b, 1001, 1099)
...
gen eduac_ci = .
replace eduac_ci = 0 if p03a05a == 5 & inrange(p03a06b, 1001, 1099)
replace eduac_ci = 1 if inlist(p03a05a, 6, 7)
replace eduac_ci = 1 if p03a05a == 5 & inlist(p03a04a, 6, 7)
replace eduac_ci = 1 if p03a05a == 5 & inrange(p03a06b, 2000, 7100)
