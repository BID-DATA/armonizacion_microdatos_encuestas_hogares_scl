...
*global ruta = "C:\Users\JILLIEC\OneDrive - Inter-American Development Bank Group\2023\IADB_2023\Armonizacion_encuestas\surveys"
...
replace desalent_ci = 1 if (p05b01 == 2 & (p05b05 >= 4 & p05b05 <= 6) & condocup_ci == 3)
...
replace cotizando_ci = 1 if ((p05c07a==1 & (p05c07b>0 & p05c07b!=.)) & emp_ci==1)
...
replace afiliado_ci = 1 if(p05c07a==1 & emp_ci==1)
...
*/
gen categoinac_ci = .
replace categoinac_ci = 1 if  (p05a02==6 & condocup_ci==3)
...
replace aguafconsumo_ch = 10 if (p02b03==8 | p02b03==4) & p02b04!=5
...
replace aguadist_ch= 0 if  p02b03>=4 & p02b03 <=8
...
*do "C:\Users\JILLIEC\OneDrive - Inter-American Development Bank Group\2023\IADB_2023\Armonizacion_encuestas\surveys\Labels&ExternalVars_Harmonized_DataBank.do"
...
/*_____________________________________________________________________________________________________*/
  ...
  aedu_ci eduui_ci eduuc_ci edupre_ci eduac_ci asiste_ci edupub_ci razonesnoasis_ci /// Educación
