...
**            1 kiché 2 Qeqchí 3 Kaqchikel 4 Mam 5 Garífuna 6 Ladino 7 Xinca 8 Extranjero ..... 98 Otro ¿cual?

	*********
	*afro_ci*
	*********
	gen byte afro_ci = .
	replace afro_ci = 1 if p03a03 == 5 
	replace afro_ci = 0 if p03a03 != 5 & p03a03 != . 
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = . 		
	replace ind_ci = 1  if (p03a03 != 6 & p03a03 !=8) & p03a03 != . 
	replace ind_ci = 0  if (p03a03 == 6 | p03a03 == 8) & p03a03 != . 
...
replace desalent_ci = 1 if (p04a10 == 2 & (p04a11 >= 2 & p04a11 <= 4) & condocup_ci == 3)
...
replace cotizando_ci = 1 if ((p05a29 == 1 & (p05a30 > 0 & p05a30 !=.)) & emp_ci==1)
...
replace afiliado_ci = 1 if(p05a29 == 1 & emp_ci==1)
...
******************************
g byte asispre_ci = 0 
replace asispre_ci = 1 if p03a07a == 1 & p03a05==1
...
98 Otra causa ¿cuál?
*/
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted2 "Falta de maestro" ///
...
g       pqnoasis1_ci = 1 if p03a06==5
replace pqnoasis1_ci= 2 if  p03a06==6
replace pqnoasis1_ci= 3 if  p03a06==13 | p03a06==1
replace pqnoasis1_ci= 4 if  p03a06==7
replace pqnoasis1_ci= 5 if  p03a06==3 | p03a06==9
replace pqnoasis1_ci= 6 if  p03a06==12
replace pqnoasis1_ci= 8 if  p03a06==11 
replace pqnoasis1_ci= 9 if  p03a06==98 | p03a06==10 | p03a06==8 | p03a06==4 | p03a06==2 | p03a06==14
