...
replace aguafconsumo_ch = 1 if (P01D06==1 | P01D06==2) & P01D15!=5
replace aguafconsumo_ch = 2 if P01D06==3 & P01D15!=5
replace aguafconsumo_ch = 3 if P01D15==5 
replace aguafconsumo_ch = 5 if P01D06==7 & P01D15!=5
replace aguafconsumo_ch = 6 if P01D06==6 & P01D15!=5
replace aguafconsumo_ch = 8 if P01D06==5 & P01D15!=5
replace aguafconsumo_ch = 10 if (P01D06==98 | P01D06==4) & P01D15!=5
...
*************
gen aguadist_ch=0
replace aguadist_ch= 1 if  P01D06 ==1
replace aguadist_ch= 2 if  P01D06 ==2
replace aguadist_ch= 3 if  P01D06==3
replace aguadist_ch= 0 if  P01D06>=4 & P01D06 <=98
...
replace bano_ch=1 if P01D16==1
replace bano_ch=2 if P01D16==2
replace bano_ch=6 if P01D16==3|P01D16==4
...
************
gen sinbano_ch = 3
replace sinbano_ch = 0 if P01D16!=5
...
*************
gen aguatrat_ch = 9
replace aguatrat_ch = 1 if P01D15!=1
replace aguatrat_ch = 0 if P01D15==1|P01D15==5 
...
replace cotizando_ci = 1 if ((P10B26A==1 & (P10B26B>0 & P10B26B!=.)) & emp_ci==1)
...
replace afiliado_ci = 1 if(P10B26A==1 & emp_ci==1)
...
No se discrimina en este anio entre maestría o doctorado.
...
* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted* Line of code with indicator pqnoasis_ci was deleted
**************
*pqnoasis1_ci*
**************
**Daniela Zuluaga- Enero 2018: Se agrega la variable pqnoasis1_ci cuya sintaxis fue elaborada por Mayra Saenz**

g       pqnoasis1_ci = 1 if P06B23==5
replace pqnoasis1_ci= 2 if  P06B23==6
replace pqnoasis1_ci= 3 if  P06B23==1 | P06B23==3
replace pqnoasis1_ci= 4 if  P06B23==7
replace pqnoasis1_ci= 5 if  P06B23==4 | P06B23==9
replace pqnoasis1_ci= 9 if  P06B23==98 | P06B23==12 | P06B23==11 | P06B23==10 | P06B23==8 | P06B23==2
...
* Line of code with indicator repite_ci was deleted******************************
* Line of code with indicator repiteult was deleted* Line of code with indicator repiteult was deleted* EDUCACION PUBLICA OR PRIVADA
/* 
...
**            1 kiché 2 Qeqchí 3 Kaqchikel 4 Mam .... 24 Garífuna 29 No indígena 30 Extranjero ..... 98 Otro ¿cual?

	*********
	*afro_ci*
	*********
	gen byte afro_ci = .
	replace afro_ci = 1 if P04A11A == 24 
	replace afro_ci = 0 if P04A11A != 24 & P04A11A != . 
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci = . 		
	replace ind_ci = 1  if (P04A11A != 29 & P04A11A != 30) & P04A11A != . 
	replace ind_ci = 0  if (P04A11A == 29 | P04A11A == 30) & P04A11A != . 
