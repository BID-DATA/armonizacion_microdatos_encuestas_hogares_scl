...
replace desalent_ci = 1 if ((P10A09==9 | P10A09==11) & condocup_ci == 3)
...
replace cotizando_ci = 1 if ((P10B13A==1 & (P10B13B>0 & P10B13B!=.)) & emp_ci==1)
...
replace afiliado_ci = 1 if(P10B13A==1 & emp_ci==1)
...
rename P10B02 codindustria
rename P10B01 codocupa
