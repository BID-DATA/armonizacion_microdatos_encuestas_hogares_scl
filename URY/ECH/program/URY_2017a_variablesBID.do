...
Última versión: Daniela Zuluaga (DZ) E-mail: danielazu@iadb.org, da.zuluaga@hotmail.com - Junio 26 de 2018
...
*lp_ci***
*********
*http://www.ine.gub.uy/documents/10181/364159/Estimaci%C3%B3n+de+la+pobreza+por+el+M%C3%A9todo+del+Ingreso+2017/f990baaf-1c32-44c5-beda-59a20dd8325c

gen lp_ci =.
replace lp_ci =  8648 if mes==1 & region_3==1
replace lp_ci =  9083 if mes==2 & region_3==1
replace lp_ci =  9150 if mes==3 & region_3==1
replace lp_ci =  9201 if mes==4 & region_3==1
replace lp_ci =  9224 if mes==5 & region_3==1
replace lp_ci =  9263 if mes==6 & region_3==1
replace lp_ci =  9294 if mes==7 & region_3==1
replace lp_ci =  9315 if mes==8 & region_3==1
replace lp_ci =  9376 if mes==9 & region_3==1
replace lp_ci =  9414 if mes==10 & region_3==1
replace lp_ci =  9455 if mes==11 & region_3==1
replace lp_ci =  9478 if mes==12 & region_3==1


replace lp_ci =   4853 if mes==1 & region_3==2
replace lp_ci =   5181 if mes==2 & region_3==2
replace lp_ci =   5213 if mes==3 & region_3==2
replace lp_ci =   5238 if mes==4 & region_3==2
replace lp_ci =   5253 if mes==5 & region_3==2
replace lp_ci =   5260 if mes==6 & region_3==2
replace lp_ci =   5272 if mes==7 & region_3==2
replace lp_ci =   5284 if mes==8 & region_3==2
replace lp_ci =   5307 if mes==9 & region_3==2
replace lp_ci =   5315 if mes==10 & region_3==2
replace lp_ci =   5330 if mes==11 & region_3==2
replace lp_ci =   5349 if mes==12 & region_3==2


replace lp_ci =   2694 if mes==1 & region_3==3
replace lp_ci =   2812 if mes==2 & region_3==3
replace lp_ci =   2827 if mes==3 & region_3==3
replace lp_ci =   2843 if mes==4 & region_3==3
replace lp_ci =   2853 if mes==5 & region_3==3
replace lp_ci =   2856 if mes==6 & region_3==3
replace lp_ci =   2863 if mes==7 & region_3==3
replace lp_ci =   2868 if mes==8 & region_3==3
replace lp_ci =   2882 if mes==9 & region_3==3
replace lp_ci =   2887 if mes==10 & region_3==3
replace lp_ci =   2897 if mes==11 & region_3==3
replace lp_ci =   2907 if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci =   2979 if mes==1 & region_3==1
replace lpe_ci =   2981 if mes==2 & region_3==1
replace lpe_ci =   2987 if mes==3 & region_3==1
replace lpe_ci =   3024 if mes==4 & region_3==1
replace lpe_ci =   3028 if mes==5 & region_3==1
replace lpe_ci =   3017 if mes==6 & region_3==1
replace lpe_ci =   3024 if mes==7 & region_3==1
replace lpe_ci =   3040 if mes==8 & region_3==1
replace lpe_ci =   3080 if mes==9 & region_3==1
replace lpe_ci =   3116 if mes==10 & region_3==1
replace lpe_ci =   3132 if mes==11 & region_3==1
replace lpe_ci =   3138 if mes==12 & region_3==1

replace lpe_ci =   2776 if mes==1 & region_3==2
replace lpe_ci =   2778 if mes==2 & region_3==2
replace lpe_ci =   2769 if mes==3 & region_3==2
replace lpe_ci =   2802 if mes==4 & region_3==2
replace lpe_ci =   2804 if mes==5 & region_3==2
replace lpe_ci =   2802 if mes==6 & region_3==2
replace lpe_ci =   2793 if mes==7 & region_3==2
replace lpe_ci =   2805 if mes==8 & region_3==2
replace lpe_ci =   2840 if mes==9 & region_3==2
replace lpe_ci =   2876 if mes==10 & region_3==2
replace lpe_ci =   2893 if mes==11 & region_3==2
replace lpe_ci =   2903 if mes==12 & region_3==2

replace lpe_ci =  2510 if mes==1 & region_3==3
replace lpe_ci =  2512 if mes==2 & region_3==3
replace lpe_ci =  2506 if mes==3 & region_3==3
replace lpe_ci =  2538 if mes==4 & region_3==3
replace lpe_ci =  2539 if mes==5 & region_3==3
replace lpe_ci =  2539 if mes==6 & region_3==3
replace lpe_ci =  2529 if mes==7 & region_3==3
replace lpe_ci =  2539 if mes==8 & region_3==3
replace lpe_ci =  2571 if mes==9 & region_3==3
replace lpe_ci =  2604 if mes==10 & region_3==3
replace lpe_ci =  2618 if mes==11 & region_3==3
replace lpe_ci =  2626 if mes==12 & region_3==3
...
**salmm_ci***
*************
*https://www.presidencia.gub.uy/comunicacion/comunicacionnoticias/astori-pautas-consejo-salarios-oficial-2015
gen salmm_ci=12265
