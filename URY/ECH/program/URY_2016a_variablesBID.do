...
Autores: Marcela G. Rubio
 Stephanie Gonzalez E-mail: stephaniego@iadb.org 
...
*lp_ci***
*********
*http://www.ine.gub.uy/documents/10181/364159/Estimaci%C3%B3n+de+la+pobreza+por+el+M%C3%A9todo+del++2016/4b1eabd2-ac77-48ac-95c2-fc5b92f3ade8

gen lp_ci =.
replace lp_ci = 7999 if mes==1 & region_3==1
replace lp_ci = 8368 if mes==2 & region_3==1
replace lp_ci = 8486 if mes==3 & region_3==1
replace lp_ci = 8538 if mes==4 & region_3==1
replace lp_ci = 8569 if mes==5 & region_3==1
replace lp_ci = 8629 if mes==6 & region_3==1
replace lp_ci = 8647 if mes==7 & region_3==1
replace lp_ci = 8682 if mes==8 & region_3==1
replace lp_ci = 8729 if mes==9 & region_3==1
replace lp_ci = 8760 if mes==10 & region_3==1
replace lp_ci = 8767 if mes==11 & region_3==1
replace lp_ci = 8802 if mes==12 & region_3==1


replace lp_ci = 4486  if mes==1 & region_3==2
replace lp_ci = 4760  if mes==2 & region_3==2
replace lp_ci = 4829  if mes==3 & region_3==2
replace lp_ci = 4859  if mes==4 & region_3==2
replace lp_ci = 4873  if mes==5 & region_3==2
replace lp_ci = 4896  if mes==6 & region_3==2
replace lp_ci = 4909  if mes==7 & region_3==2
replace lp_ci = 4928  if mes==8 & region_3==2
replace lp_ci = 4949  if mes==9 & region_3==2
replace lp_ci = 4964  if mes==10 & region_3==2
replace lp_ci = 4978  if mes==11 & region_3==2
replace lp_ci = 4999  if mes==12 & region_3==2


replace lp_ci = 2505  if mes==1 & region_3==3
replace lp_ci = 2604  if mes==2 & region_3==3
replace lp_ci = 2639  if mes==3 & region_3==3
replace lp_ci = 2661  if mes==4 & region_3==3
replace lp_ci = 2669  if mes==5 & region_3==3
replace lp_ci = 2682  if mes==6 & region_3==3
replace lp_ci = 2686  if mes==7 & region_3==3
replace lp_ci = 2696  if mes==8 & region_3==3
replace lp_ci = 2706  if mes==9 & region_3==3
replace lp_ci = 2715  if mes==10 & region_3==3
replace lp_ci = 2722  if mes==11 & region_3==3
replace lp_ci = 2735  if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci = 2786  if mes==1 & region_3==1
replace lpe_ci = 2805  if mes==2 & region_3==1
replace lpe_ci = 2843  if mes==3 & region_3==1
replace lpe_ci = 2890  if mes==4 & region_3==1
replace lpe_ci = 2904  if mes==5 & region_3==1
replace lpe_ci = 2961  if mes==6 & region_3==1
replace lpe_ci = 2991  if mes==7 & region_3==1
replace lpe_ci = 3005  if mes==8 & region_3==1
replace lpe_ci = 3021  if mes==9 & region_3==1
replace lpe_ci = 3014  if mes==10 & region_3==1
replace lpe_ci = 3015 if mes==11 & region_3==1
replace lpe_ci = 2988  if mes==12 & region_3==1

replace lpe_ci = 2587  if mes==1 & region_3==2
replace lpe_ci = 2606  if mes==2 & region_3==2
replace lpe_ci = 2630 if mes==3 & region_3==2
replace lpe_ci = 2666  if mes==4 & region_3==2
replace lpe_ci = 2686  if mes==5 & region_3==2
replace lpe_ci = 2756  if mes==6 & region_3==2
replace lpe_ci = 2787 if mes==7 & region_3==2
replace lpe_ci = 2794  if mes==8 & region_3==2
replace lpe_ci = 2809 if mes==9 & region_3==2
replace lpe_ci = 2806 if mes==10 & region_3==2
replace lpe_ci = 2807 if mes==11 & region_3==2
replace lpe_ci = 2786 if mes==12 & region_3==2

replace lpe_ci = 2337 if mes==1 & region_3==3
replace lpe_ci = 2353 if mes==2 & region_3==3
replace lpe_ci = 2374  if mes==3 & region_3==3
replace lpe_ci = 2409 if mes==4 & region_3==3
replace lpe_ci = 2427  if mes==5 & region_3==3
replace lpe_ci = 2497 if mes==6 & region_3==3
replace lpe_ci = 2526 if mes==7 & region_3==3
replace lpe_ci = 2531 if mes==8 & region_3==3
replace lpe_ci = 2543 if mes==9 & region_3==3
replace lpe_ci = 2541  if mes==10 & region_3==3
replace lpe_ci = 2541 if mes==11 & region_3==3
replace lpe_ci = 2520 if mes==12 & region_3==3
...
*2016: https://medios.presidencia.gub.uy/legal/2016/decretos/01/mtss_82.pdf
gen salmm_ci=11150
