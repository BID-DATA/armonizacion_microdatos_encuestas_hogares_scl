...
gen lp_ci =.
replace lp_ci =  10093 if mes==1 & region_3==1
replace lp_ci =  10444 if mes==2 & region_3==1
replace lp_ci =  10505 if mes==3 & region_3==1
replace lp_ci =  10563 if mes==4 & region_3==1
replace lp_ci =  10623 if mes==5 & region_3==1
replace lp_ci =  10668 if mes==6 & region_3==1
replace lp_ci =  10702 if mes==7 & region_3==1
replace lp_ci =  10747 if mes==8 & region_3==1
replace lp_ci =  10799 if mes==9 & region_3==1
replace lp_ci =  10851 if mes==10 & region_3==1
replace lp_ci =  10894 if mes==11 & region_3==1
replace lp_ci =  10846 if mes==12 & region_3==1


replace lp_ci =   5606 if mes==1 & region_3==2
replace lp_ci =   5852 if mes==2 & region_3==2
replace lp_ci =   5873 if mes==3 & region_3==2
replace lp_ci =   5900 if mes==4 & region_3==2
replace lp_ci =   5939 if mes==5 & region_3==2
replace lp_ci =   5953 if mes==6 & region_3==2
replace lp_ci =   5972 if mes==7 & region_3==2
replace lp_ci =   5997 if mes==8 & region_3==2
replace lp_ci =   6021 if mes==9 & region_3==2
replace lp_ci =   6042 if mes==10 & region_3==2
replace lp_ci =   6068 if mes==11 & region_3==2
replace lp_ci =   6011 if mes==12 & region_3==2


replace lp_ci =   3083 if mes==1 & region_3==3
replace lp_ci =   3175 if mes==2 & region_3==3
replace lp_ci =   3185 if mes==3 & region_3==3
replace lp_ci =   3206 if mes==4 & region_3==3
replace lp_ci =   3232 if mes==5 & region_3==3
replace lp_ci =   3243 if mes==6 & region_3==3
replace lp_ci =   3254 if mes==7 & region_3==3
replace lp_ci =   3268 if mes==8 & region_3==3
replace lp_ci =   3283 if mes==9 & region_3==3
replace lp_ci =   3299 if mes==10 & region_3==3
replace lp_ci =   3317 if mes==11 & region_3==3
replace lp_ci =   3305 if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci =   3394 if mes==1 & region_3==1
replace lpe_ci =   3427 if mes==2 & region_3==1
replace lpe_ci =   3496 if mes==3 & region_3==1
replace lpe_ci =   3508 if mes==4 & region_3==1
replace lpe_ci =   3495 if mes==5 & region_3==1
replace lpe_ci =   3511 if mes==6 & region_3==1
replace lpe_ci =   3559 if mes==7 & region_3==1
replace lpe_ci =   3631 if mes==8 & region_3==1
replace lpe_ci =   3688 if mes==9 & region_3==1
replace lpe_ci =   3708 if mes==10 & region_3==1
replace lpe_ci =   3758 if mes==11 & region_3==1
replace lpe_ci =   3805 if mes==12 & region_3==1

replace lpe_ci =   3107 if mes==1 & region_3==2
replace lpe_ci =   3152 if mes==2 & region_3==2
replace lpe_ci =   3213 if mes==3 & region_3==2
replace lpe_ci =   3233 if mes==4 & region_3==2
replace lpe_ci =   3212 if mes==5 & region_3==2
replace lpe_ci =   3237 if mes==6 & region_3==2
replace lpe_ci =   3282 if mes==7 & region_3==2
replace lpe_ci =   3328 if mes==8 & region_3==2
replace lpe_ci =   3393 if mes==9 & region_3==2
replace lpe_ci =   3416 if mes==10 & region_3==2
replace lpe_ci =   3459 if mes==11 & region_3==2
replace lpe_ci =   3507 if mes==12 & region_3==2

replace lpe_ci =  2806 if mes==1 & region_3==3
replace lpe_ci =  2847 if mes==2 & region_3==3
replace lpe_ci =  2908 if mes==3 & region_3==3
replace lpe_ci =  2925 if mes==4 & region_3==3
replace lpe_ci =  2904 if mes==5 & region_3==3
replace lpe_ci =  2924 if mes==6 & region_3==3
replace lpe_ci =  2960 if mes==7 & region_3==3
replace lpe_ci =  3002 if mes==8 & region_3==3
replace lpe_ci =  3062 if mes==9 & region_3==3
replace lpe_ci =  3082 if mes==10 & region_3==3
replace lpe_ci =  3116 if mes==11 & region_3==3
replace lpe_ci =  3152 if mes==12 & region_3==3
...
**salmm_ci***
*************
*https://www.presidencia.gub.uy/comunicacion/comunicacionnoticias/salario-minimo-trabajo-decreto-gobierno
gen salmm_ci=15000
...
En la seccion laboral se creó un filtro auxiliar para identificar a las personas que 
declaran al menos un monto en esta sección.
...
*** Beneficiarios a nivel individual:
	...
	gen byte potrot_ci = (otraspens_ci == 1 | tus_ci == 1)
	replace potrot_ci = . if otraspens_ci == . &  tus_ci == .
...
*** Montos de transferencias a nivel individual:
	...
	egen double yotraspens_ci = rowtotal(g148_2_1 g148_2_2 g148_2_3) if otraspens == 1, mi	
	egen double ytus_ci = rowtotal(e560_1_1 e560_2_1) if tus_ci == 1, mi
	egen double yotrot_ci = rowtotal(yotraspens_ci ytus_ci), mi
...
*******************************************
egen double ypen_ci = rowtotal(g148_1_1 g148_1_2 g148_1_3 g148_1_4 g148_1_5 g148_1_6 g148_1_7 g148_1_8 g148_1_9 g148_1_10 g148_1_12) if f_jub != 0, mi  // Se excluyen pensiones del exterior (g148_1_11)
...
egen double aux_pnc = rowtotal(g148_2_1 g148_2_2 g148_2_3 g148_2_4 g148_2_5 g148_2_6 g148_2_7 g148_2_8 g148_2_9 g148_2_10 g148_2_12)

	foreach v in pnc otraspens {
		gen `v'_2 = y`v'_ci
		replace `v'_2 = 0 if y`v'_ci == .
	}

gen double otras_pension148 = (aux_pnc - pnc_2 - otraspens_2)
drop pnc_2 otraspens_2

// Se agrega la cascada de ingresos no laborales: transferencias del extranjero, becas, desemepleo, etc.
...
by idh_ch, sort: egen double nrylmpri_ch = total(nrylmpri_ci) if miembros_ci==1, mi
...
*aguadist_ch*
*************
** Comentarios incorporados en el codigo (dijo d13 en vez de d12)
