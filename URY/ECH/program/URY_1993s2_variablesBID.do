...
**salmm_ci***
*************
gen salmm_ci = 308 if mes_c>=1 & mes_c<=4
replace salmm_ci = 332.5 if mes_c>=5 & mes_c<=8
replace salmm_ci =365 if mes_c>=9
label var	salmm_ci	"Salario minimo legal 1993"
...
replace nempleos_ci=2 if pf07>1 & pf07<=11
