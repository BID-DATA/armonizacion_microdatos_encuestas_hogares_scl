...
*lp_ci***
*********
*https://www5.ine.gub.uy/documents/Demograf%C3%ADayEESS/HTML/ECH/Pobreza/2022/Estimaci%C3%B3n%20de%20la%20pobreza%20por%20el%20m%C3%A9todo%20del%20ingreso%202022.html

gen lp_ci =.
replace lp_ci =  12655 if mes==1 & region==1
replace lp_ci =  13058 if mes==2 & region==1
replace lp_ci =  13162 if mes==3 & region==1
replace lp_ci =  13212 if mes==4 & region==1
replace lp_ci =  13297 if mes==5 & region==1
replace lp_ci =  13417 if mes==6 & region==1
replace lp_ci =  13482 if mes==7 & region==1
replace lp_ci =  13580 if mes==8 & region==1
replace lp_ci =  13710	if mes==9 & region==1
replace lp_ci =  13745 if mes==10 & region==1
replace lp_ci =  13782 if mes==11 & region==1
replace lp_ci =  13775 if mes==12 & region==1


replace lp_ci =   6983 if mes==1 & region==2
replace lp_ci =   7262 if mes==2 & region==2
replace lp_ci =   7316 if mes==3 & region==2
replace lp_ci =   7352 if mes==4 & region==2
replace lp_ci =   7395 if mes==5 & region==2
replace lp_ci =   7438 if mes==6 & region==2
replace lp_ci =   7476 if mes==7 & region==2
replace lp_ci =   7522 if mes==8 & region==2
replace lp_ci =   7522 if mes==9 & region==2
replace lp_ci =   7594 if mes==10 & region==2
replace lp_ci =   7619 if mes==11 & region==2
replace lp_ci =   7618	 if mes==12 & region==2


replace lp_ci =   3884 if mes==1 & region==3
replace lp_ci =   3990 if mes==2 & region==3
replace lp_ci =   4021 if mes==3 & region==3
replace lp_ci =   4043 if mes==4 & region==3
replace lp_ci =   4067	if mes==5 & region==3
replace lp_ci =   4095 if mes==6 & region==3
replace lp_ci =   4114	if mes==7 & region==3
replace lp_ci =   4146	if mes==8 & region==3
replace lp_ci =   4178 if mes==9 & region==3
replace lp_ci =   4188	if mes==10 & region==3
replace lp_ci =   4202	if mes==11 & region==3
replace lp_ci =   4197	if mes==12 & region==3
...
*********
gen lpe_ci =.
replace lpe_ci =   4484 if mes==1 & region==1
replace lpe_ci =   4552 if mes==2 & region==1
replace lpe_ci =   4681 if mes==3 & region==1
replace lpe_ci =   4790 if mes==4 & region==1
replace lpe_ci =   4795 if mes==5 & region==1
replace lpe_ci =   4795 if mes==6 & region==1
replace lpe_ci =   4842 if mes==7 & region==1
replace lpe_ci =   4900 if mes==8 & region==1
replace lpe_ci =   4926 if mes==9 & region==1
replace lpe_ci =   5025 if mes==10 & region==1
replace lpe_ci =   5017 if mes==11 & region==1
replace lpe_ci =   4984 if mes==12 & region==1

replace lpe_ci =   6983 if mes==1 & region==2
replace lpe_ci =   7262 if mes==2 & region==2
replace lpe_ci =   7316 if mes==3 & region==2
replace lpe_ci =   7352 if mes==4 & region==2
replace lpe_ci =   7395 if mes==5 & region==2
replace lpe_ci =   7438 if mes==6 & region==2
replace lpe_ci =   7476 if mes==7 & region==2
replace lpe_ci =   7522 if mes==8 & region==2
replace lpe_ci =   7572 if mes==9 & region==2
replace lpe_ci =   7594 if mes==10 & region==2
replace lpe_ci =   7619 if mes==11 & region==2
replace lpe_ci =   7618 if mes==12 & region==2

replace lpe_ci =  3884 if mes==1 & region==3
replace lpe_ci =  3990 if mes==2 & region==3
replace lpe_ci =  4021 if mes==3 & region==3
replace lpe_ci =  4043 if mes==4 & region==3
replace lpe_ci =  4067 if mes==5 & region==3
replace lpe_ci =  4095 if mes==6 & region==3
replace lpe_ci =  4114 if mes==7 & region==3
replace lpe_ci =  4146 if mes==8 & region==3
replace lpe_ci =  4178 if mes==9 & region==3
replace lpe_ci =  4188 if mes==10 & region==3
replace lpe_ci =  4202 if mes==11 & region==3
replace lpe_ci =  4197 if mes==12 & region==3
...
replace pension_ci = 0 if g148_1_11 > 0 & pension_ci == 1
...
**salmm_ci***
*************
*https://www.gub.uy/presidencia/comunicacion/noticias/rige-desde-1-enero-aumento-del-salario-minimo-nacional#:~:text=Uruguay%20Presidencia,-Presidencia&text=El%20Poder%20Ejecutivo%20defini%C3%B3%20elevar,el%20presidente%20de%20la%20Rep%C3%BAblica.
gen salmm_ci = 19364
...
/*
Recibió el mes pasado por JUBILACIONES: g_it_1	
...
Recibió el mes pasado por PENSIONES: g_it_2
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen migantiguo5_ci = (e38 >= 5 & migrante_ci == 1)
