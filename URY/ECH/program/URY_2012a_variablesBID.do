...
Encuesta: ECH
Round: a
Autores: Mayra Sáenz E-mail: mayras@iadb.org / saenzmayra.a@gmail.com
...
replace civil_ci=4 	if e36==4 | e36==6
...
gen lp_ci =.
replace lp_ci = 5959.22561094811 if mes==1 & region == "01"
replace lp_ci = 6023.21066779541 if mes==2 & region == "01"
replace lp_ci = 6050.06691650148 if mes==3 & region == "01"
replace lp_ci = 6088.4720407785 if mes==4 & region == "01"
replace lp_ci = 6133.48504523408 if mes==5 & region == "01"
replace lp_ci = 6177.2047716829 if mes==6 & region == "01"
replace lp_ci = 6143.98683852885 if mes==7 & region == "01"
replace lp_ci = 6179.87361607822 if mes==8 & region == "01"
replace lp_ci = 6267.47190163871 if mes==9 & region == "01"
replace lp_ci = 6373.03970654573 if mes==10 & region == "01"
replace lp_ci = 6394.79234196521 if mes==11 & region == "01"
replace lp_ci = 6259.12005359805 if mes==12 & region == "01"

replace lp_ci = 3515.57204636011 if mes==1 & region == "02"
replace lp_ci = 3537.23362100623 if mes==2 & region == "02"
replace lp_ci = 3559.76280639181 if mes==3 & region == "02"
replace lp_ci = 3583.8268168106 if mes==4 & region == "02"
replace lp_ci = 3604.41799169594 if mes==5 & region == "02"
replace lp_ci = 3629.80042643953 if mes==6 & region == "02"
replace lp_ci = 3587.50311415841 if mes==7 & region == "02"
replace lp_ci = 3602.76503417915 if mes==8 & region == "02"
replace lp_ci = 3637.57782488843 if mes==9 & region == "02"
replace lp_ci = 3729.8583108294 if mes==10 & region == "02"
replace lp_ci = 3746.38823767324 if mes==11 & region == "02"
replace lp_ci = 3618.08809386352 if mes==12 & region == "02"

replace lp_ci = 1923.09634070145 if mes==1 & (region == "03" | region == "04")
replace lp_ci = 1933.26361009749 if mes==2 & (region == "03" | region == "04")
replace lp_ci = 1946.03844884813 if mes==3 & (region == "03" | region == "04")
replace lp_ci = 1961.10047193361 if mes==4 & (region == "03" | region == "04")
replace lp_ci = 1973.06147486645 if mes==5 & (region == "03" | region == "04")
replace lp_ci = 1991.17243361807 if mes==6 & (region == "03" | region == "04")
replace lp_ci = 1981.67203993165 if mes==7 & (region == "03" | region == "04")
replace lp_ci = 1996.39206808812 if mes==8 & (region == "03" | region == "04")
replace lp_ci = 2013.11112686137 if mes==9 & (region == "03" | region == "04")
replace lp_ci = 2039.66034037369 if mes==10 & (region == "03" | region == "04")
replace lp_ci = 2046.37019363927 if mes==11 & (region == "03" | region == "04")
replace lp_ci = 2006.43806755169 if mes==12 & (region == "03" | region == "04")
...
*********
gen lpe_ci =.
replace lpe_ci = 1912.0662824761 if mes==1 & region == "01"
replace lpe_ci = 1929.87163569067 if mes==2 & region == "01"
replace lpe_ci = 1968.26301691396 if mes==3 & region == "01"
replace lpe_ci = 1991.90425148515 if mes==4 & region == "01"
replace lpe_ci = 1980.53212458012 if mes==5 & region == "01"
replace lpe_ci = 1961.92293782404 if mes==6 & region == "01"
replace lpe_ci = 1995.66342844782 if mes==7 & region == "01"
replace lpe_ci = 2027.3653348632 if mes==8 & region == "01"
replace lpe_ci = 2058.47952750193 if mes==9 & region == "01"
replace lpe_ci = 2096.64081863032 if mes==10 & region == "01"
replace lpe_ci = 2099.43368799382 if mes==11 & region == "01"
replace lpe_ci = 2105.66721556425 if mes==12 & region == "01"

replace lpe_ci = 1774.42566781062 if mes==1 & region == "02"
replace lpe_ci = 1792.40889047328 if mes==2 & region == "02"
replace lpe_ci = 1822.38662091621 if mes==3 & region == "02"
replace lpe_ci = 1847.83367814492 if mes==4 & region == "02"
replace lpe_ci = 1847.71758528873 if mes==5 & region == "02"
replace lpe_ci = 1824.33579898309 if mes==6 & region == "02"
replace lpe_ci = 1841.53160064322 if mes==7 & region == "02"
replace lpe_ci = 1872.04880281622 if mes==8 & region == "02"
replace lpe_ci = 1910.0483710065 if mes==9 & region == "02"
replace lpe_ci = 1937.48505149962 if mes==10 & region == "02"
replace lpe_ci = 1948.39135546016 if mes==11 & region == "02"
replace lpe_ci = 1956.38176383482 if mes==12 & region == "02"

replace lpe_ci = 1595.34116317024 if mes==1 & (region == "03" | region == "04")
replace lpe_ci = 1612.10079553735 if mes==2 & (region == "03" | region == "04")
replace lpe_ci = 1639.0628683383 if mes==3 & (region == "03" | region == "04")
replace lpe_ci = 1663.04290518367 if mes==4 & (region == "03" | region == "04")
replace lpe_ci = 1663.54726570792 if mes==5 & (region == "03" | region == "04")
replace lpe_ci = 1642.16046440495 if mes==6 & (region == "03" | region == "04")
replace lpe_ci = 1657.56767447104 if mes==7 & (region == "03" | region == "04")
replace lpe_ci = 1683.83162492826 if mes==8 & (region == "03" | region == "04")
replace lpe_ci = 1716.67113799142 if mes==9 & (region == "03" | region == "04")
replace lpe_ci = 1740.76872162878 if mes==10 & (region == "03" | region == "04")
replace lpe_ci = 1751.22886320748 if mes==11 & (region == "03" | region == "04")
replace lpe_ci = 1758.78578097964 if mes==12 & (region == "03" | region == "04")
...
A partir de encuesta 2012 se ha agregado un tipo de caja más a la pregunta f83 que corresponde a opción 8 "en el exterior"*/
...
gen tamemp_o=1 if f77==1 | f77==2 | f77==3
*Empresas medianas
replace tamemp_o=2 if f77==6 | f77==7
*Empresas grandes
replace tamemp_o=3 if f77==5
...
/* Nota Marcela G. Rubio: he modificado esta sección con los códigos del CIIU revisión 4 ya que la encuesta de 2012 fué hecha con esta última revisión mientras
la encuesta de 2011 fue hecha con la CIIU revisión 3 */
*/
...
egen ylnmsec_ci=rsum(desaysec almuesec vacassec ovejasec caballosec g134_8 g135_3 g136_1 g137_2 g138_1 g139_1 g141_1) if emp_ci ==1
...
gen canasta_3 = (e247 * indapensi) if e246 ==3
gen canasta_4 = (e247 * indadiabet) if e246 ==4
gen canasta_5 = (e247 * indarenal) if e246 ==5
gen canasta_6 = (e247 * indarendia) if e246 ==6 
gen canasta_7 = (e247 * indaceliac) if e246 ==7 
gen canasta_8 = (e247 * indatuberc) if e246 ==8 
gen canasta_9 = (e247 * indaoncolo) if e246 ==9 
gen canasta_10 = (e247 * indasida) if e246 ==10

gen salvcana = (e249*mto_almue) 
...
egen transf= rsum(canasta_* salvcana hogcosnt), missing


egen ynlm_ci=rsum(inghog transf g148_1_1 g148_1_2  g148_1_3 g148_1_4  g148_1_5  g148_1_6  g148_1_7  g148_1_8  g148_1_9  g148_1_10  g148_1_11 g148_1_12 g148_2_1 g148_2_2 g148_2_3 g148_2_4 g148_2_5 g148_2_6 g148_2_7 g148_2_8 g148_2_9 g148_2_10 g148_2_11 g148_2_12 g148_3 g148_4 g148_5_1 g148_5_2 g153_1 g153_2 g154_1 )
...
/* Marcela G. Rubio - Abril 2014
Había sido generado como missing pero he modificado a utilizar la misma estimación que en 2011*/
...
* Line of code with indicator repiteult was deleted*92. Personas que asisten a centros de ensenanza públicos
...
* Modificación Marcela Rubio - Noviembre 2014
/*
gen des1_ch=.
replace des1_ch=0 if d13==3
replace des1_ch=1 if d16==1
replace des1_ch=2 if d16==2
