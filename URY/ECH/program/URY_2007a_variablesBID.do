...
gen aguafconsumo_ch =.
replace aguafconsumo_ch = 1 if d11==1 & d14_1<=2
replace aguafconsumo_ch = 2 if (d11==1 & d14_1>2) | d11==2
...
*****************
gen aguafuente_ch =.
replace aguafuente_ch = 1 if d11==1 & d14_1<=2
replace aguafuente_ch = 2 if (d11==1 & d14_1>2) | d11==2
...
e31_1	1 = Si / 2 = No           Afro o negra
e31_2	1 = Si / 2 = No           Amarilla
e31_3	1 = Si / 2 = No           Blanca
e31_4	1 = Si / 2 = No           Indígena
e31_5_1		Otro 
 */

**Puedes reportar más de una identidad por lo que hay una población afroindigena.

	*********
	*afro_ci*
	*********
	gen byte afro_ci = . 	  
	replace afro_ci = 1 if e31_1 == 1 
	replace afro_ci = 0 if e31_1 == 2
	
	*********
	*ind_ci*
	*********	
	gen byte ind_ci =. 
	replace ind_ci = 1 if e31_4 == 1 
	replace ind_ci = 0 if e31_4 == 2
...
replace afiliado_ci = 1 if ((policial==1 | militar==1 | bps==1 | iamc==1) & emp_ci==1)
replace afiliado_ci = 0 if ((policial==0 & militar==0 & bps==0 & iamc==0) & inlist(condocup_ci, 1, 2))
...
replace cotizando_ci = 1 if ((f85==1 | f99==1) & emp_ci==1)
replace cotizando_ci = 0 if ((f85==2 | f99==2) & inlist(condocup_ci, 1, 2))
...
replace desalent_ci = 1 if (f110 == 2 & f111 == 4 & condocup_ci == 3)
...
** e_52 años que cursa
** e_54 ultimo nivel educativo

gen aedu_ci = . 
replace aedu_ci=0 if e53==2 // nunca asistio

** Asisten a nivel

replace aedu_ci = 0 if e52_1 > 0 // 0 Anios cursados en preescolar 
replace aedu_ci = 0 if e52_2 > 0 // 0 Anios cursados en primaria especial 
replace aedu_ci = e52_3-1 if e52_3 > 0 // 0 Anios cursados en primaria 

// Secundaria formal
replace aedu_ci = (6 + e52_4) -1 if e52_4 > 0 // 0 Anios cursados en ciclo básico liceo 
replace aedu_ci = (6 + e52_5) -1 if e52_5 > 0 // 0 Anios cursados en ciclo UTU
replace aedu_ci = (6 + e52_6) -1 if e52_6 > 0 // 0 Anios cursados bachilerato secundaria
replace aedu_ci = (6 + e52_7) -1 if e52_7 > 0 // 0 Anios cursados Formación Profesional Básica
replace aedu_ci = (6 + e52_8) -1 if e52_8 > 0 // 0 Bachillerato Tecnológico UTU (4to a 6to)
...
replace aedu_ci = e54_1_1 if e54_1_1 > 0  // 0 Nivel mas alto en primaria 

replace aedu_ci = 6 + e54_2_1 if e54_2_1 > 0 // 0 Nivel mas alto en secundaria 
replace aedu_ci = 6 if (e54_3_1 > 0 & e54_3_3 == 3) //  Enseñanza técnica requisito primaria completa (no se computan años de enseñanza tecnica por ser no formal)
replace aedu_ci = 9 if (e54_3_1 > 0 & e54_3_3 == 2) //  Enseñanza técnica requisito secundaria primer ciclo (no se computan años de enseñaza tecnica por ser no formal)

replace aedu_ci = e54_3_1 + 12 if (e54_3_1 > 0 & e54_3_3 == 1) //  Enseñanza técnica requisito secundaria completa (esto es superior)
...
gen eduuc_ci = 0
replace eduuc_ci=1 if (e54_4_2==1 | e54_5_2==1 | e54_6_2==1 | e54_7_2!=0)
replace eduuc_ci=1 if e52_12 > 0
...
***************
gen eduac_ci=.
replace eduac_ci=0 if (e54_6_2!=0 | e54_6_2!=0)
replace eduac_ci=0 if (e52_9 > 0 | e52_11 > 0)
replace eduac_ci=1 if (e54_5_2!=0 | e54_7_2!=0)
replace eduac_ci=1 if (e52_10 > 0 | e52_12 > 0)
