...
*************
gen salmm_ci = .
replace salmm_ci = 230   if mes_c==1 | mes_c==2  | mes_c==3  | mes_c==4 
replace salmm_ci = 253   if mes_c==5 | mes_c==6  | mes_c==7  | mes_c==8
replace salmm_ci = 278.3 if mes_c==9 | mes_c==10 | mes_c==11 | mes_c==12
label var	salmm_ci	"Salario minimo legal 1992"
...
replace aedu_ci=12+ultano if nivel==5 | nivel==6
replace aedu_ci=12 if (nivel==5 & ultano==0) | (nivel==6 & ultano==0) | (nivel==7 & ultano==0)
