...
Autores: Marcela G. Rubio
 Marcela Rubio E-mail: mrubio@iadb.org / marcelarubio28@gmail.com
...
gen lp_ci =.
replace lp_ci = 6451.62986117472 if mes==1 & region_3==1
replace lp_ci = 6544.14641223683 if mes==2 & region_3==1
replace lp_ci = 6574.48564417278 if mes==3 & region_3==1
replace lp_ci = 6605.07440550401 if mes==4 & region_3==1
replace lp_ci = 6646.52356748335 if mes==5 & region_3==1
replace lp_ci = 6692.96579680844 if mes==6 & region_3==1
replace lp_ci = 6769.95507723987 if mes==7 & region_3==1
replace lp_ci = 6825.04358347196 if mes==8 & region_3==1
replace lp_ci = 6895.33592979787 if mes==9 & region_3==1
replace lp_ci = 6952.65310039316 if mes==10 & region_3==1
replace lp_ci = 6968.15290066687 if mes==11 & region_3==1
replace lp_ci = 6836.2966637663 if mes==12 & region_3==1

replace lp_ci = 3774.89068041181 if mes==1 & region_3==2
replace lp_ci = 3832.75897575207 if mes==2 & region_3==2
replace lp_ci = 3849.46291987226 if mes==3 & region_3==2
replace lp_ci = 3861.68255178389 if mes==4 & region_3==2
replace lp_ci = 3879.5401964072 if mes==5 & region_3==2
replace lp_ci = 3902.51729494095 if mes==6 & region_3==2
replace lp_ci = 3941.34524006025 if mes==7 & region_3==2
replace lp_ci = 3968.67584969406 if mes==8 & region_3==2
replace lp_ci = 4004.44980658249 if mes==9 & region_3==2
replace lp_ci = 4030.10984485197 if mes==10 & region_3==2
replace lp_ci = 4041.3863384238 if mes==11 & region_3==2
replace lp_ci = 3901.76971814431 if mes==12 & region_3==2

replace lp_ci = 2061.30363758567 if mes==1 & region_3==3
replace lp_ci = 2082.29976763805 if mes==2 & region_3==3
replace lp_ci = 2091.56670074453 if mes==3 & region_3==3
replace lp_ci = 2097.64665686485 if mes==4 & region_3==3
replace lp_ci = 2108.40889471427 if mes==5 & region_3==3
replace lp_ci = 2125.38398412564 if mes==6 & region_3==3
replace lp_ci = 2146.93678322085 if mes==7 & region_3==3
replace lp_ci = 2163.52820620119 if mes==8 & region_3==3
replace lp_ci = 2189.39969960835 if mes==9 & region_3==3
replace lp_ci = 2203.0988721229 if mes==10 & region_3==3
replace lp_ci = 2208.04158774929 if mes==11 & region_3==3
replace lp_ci = 2168.6798096937 if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci = 2140.61058681401 if mes==1 & region_3==1
replace lpe_ci = 2161.07503742024 if mes==2 & region_3==1
replace lpe_ci = 2187.84964099862 if mes==3 & region_3==1
replace lpe_ci = 2199.27319571995 if mes==4 & region_3==1
replace lpe_ci = 2194.21097191424 if mes==5 & region_3==1
replace lpe_ci = 2189.17708039318 if mes==6 & region_3==1
replace lpe_ci = 2201.20744478015 if mes==7 & region_3==1
replace lpe_ci = 2232.65528930963 if mes==8 & region_3==1
replace lpe_ci = 2274.29294716142 if mes==9 & region_3==1
replace lpe_ci = 2301.1953526746 if mes==10 & region_3==1
replace lpe_ci = 2303.63697445178 if mes==11 & region_3==1
replace lpe_ci = 2301.01891067681 if mes==12 & region_3==1

replace lpe_ci = 1988.21010846963 if mes==1 & region_3==2
replace lpe_ci = 2011.94215430778 if mes==2 & region_3==2
replace lpe_ci = 2037.79632888844 if mes==3 & region_3==2
replace lpe_ci = 2055.72074545764 if mes==4 & region_3==2
replace lpe_ci = 2046.39540751099 if mes==5 & region_3==2
replace lpe_ci = 2031.22807738064 if mes==6 & region_3==2
replace lpe_ci = 2037.10836696796 if mes==7 & region_3==2
replace lpe_ci = 2075.84666759301 if mes==8 & region_3==2
replace lpe_ci = 2125.05979455786 if mes==9 & region_3==2
replace lpe_ci = 2130.88648941578 if mes==10 & region_3==2
replace lpe_ci = 2135.46466641291 if mes==11 & region_3==2
replace lpe_ci = 2127.41099980878 if mes==12 & region_3==2

replace lpe_ci = 1787.66513657414 if mes==1 & region_3==3
replace lpe_ci = 1811.41872524246 if mes==2 & region_3==3
replace lpe_ci = 1836.74050356708 if mes==3 & region_3==3
replace lpe_ci = 1855.23431769613 if mes==4 & region_3==3
replace lpe_ci = 1847.55129125795 if mes==5 & region_3==3
replace lpe_ci = 1832.5325680725 if mes==6 & region_3==3
replace lpe_ci = 1836.17985637367 if mes==7 & region_3==3
replace lpe_ci = 1871.40735008379 if mes==8 & region_3==3
replace lpe_ci = 1917.38587866508 if mes==9 & region_3==3
replace lpe_ci = 1921.73866460172 if mes==10 & region_3==3
replace lpe_ci = 1926.1618057503 if mes==11 & region_3==3
replace lpe_ci = 1920.2850635382 if mes==12 & region_3==3
...
egen aux1=rowtotal(g148_1_1 g148_1_2 g148_1_3 g148_1_4 g148_1_5 g148_1_6 g148_1_7 g148_1_8 g148_1_9 g148_1_b), mis /*Se excluyen pensiones recibidas del exterior*/
egen aux2=rowtotal(g148_2_1 g148_2_2 g148_2_3 g148_2_4 g148_2_5 g148_2_6 g148_2_7 g148_2_8 g148_2_9 g148_2_b), mis /*Se excluyen pensiones recibidas del exterior*/
...
Variables de mto_ han cambiado el nombre de encuesta 2012 a encuesta 2013*/

gen desay=(g127_1*mto_desa)
gen almue= (g127_2*mto_almu)
...
gen vacas = (g132_1*mto_vaca)
gen oveja = (g132_2*mto_ovej)
gen caballo = (g132_3*mto_caba)
...
gen desaysec=(g135_1*mto_desa)
gen almuesec= (g135_2*mto_almu)
*gen cuota = En este año no se pregunta acerca de la cuota mutual.

gen vacassec = (g140_1*mto_vaca)
gen ovejasec = (g140_2*mto_ovej)
gen caballosec = (g140_3*mto_caba)
...
gen canasta_2 = (e247 * indaplom) if e246 ==2
gen canasta_3 = (e247 * indadiab) if e246 ==4
gen canasta_4 = (e247 * indarena) if e246 ==5
gen canasta_5 = (e247 * indarend) if e246 ==6 
gen canasta_6 = (e247 * indaceli) if e246 ==7 
gen canasta_7 = (e247 * indatube) if e246 ==8 
gen canasta_8 = (e247 * indaonco) if e246 ==9 
gen canasta_9 = (e247 * indasida) if e246 ==10

gen salvcana = (e249*mto_almu) 
...
gen hogcosnt = mto_hogc if g149==1 & g149_1==2
...
egen ynlm_ci=rsum(inghog transf g148_1_1 g148_1_2  g148_1_3 g148_1_4  g148_1_5  g148_1_6  g148_1_7  g148_1_8  g148_1_9  g148_1_b  g148_1_c g148_1_a g148_2_1 g148_2_2 g148_2_3 g148_2_4 g148_2_5 g148_2_6 g148_2_7 g148_2_8 g148_2_9 g148_2_b g148_2_c g148_2_a g148_3 g148_4 g148_5_1 g148_5_2 g153_1 g153_2 g154_1 )
