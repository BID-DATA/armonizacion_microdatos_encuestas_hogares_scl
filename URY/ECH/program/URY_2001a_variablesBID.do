...
gen lp_ci =.
replace lp_ci = 2377.91780207644 if mes==1 & aux_reg==1
replace lp_ci = 2401.05973394262 if mes==2 & aux_reg==1
replace lp_ci = 2410.96848906688 if mes==3 & aux_reg==1
replace lp_ci = 2415.58764888506 if mes==4 & aux_reg==1
replace lp_ci = 2433.44127139416 if mes==5 & aux_reg==1
replace lp_ci = 2430.68477360617 if mes==6 & aux_reg==1
replace lp_ci = 2455.44499103831 if mes==7 & aux_reg==1
replace lp_ci = 2453.56737430208 if mes==8 & aux_reg==1
replace lp_ci = 2456.66334510096 if mes==9 & aux_reg==1
replace lp_ci = 2469.23606594405 if mes==10 & aux_reg==1
replace lp_ci = 2473.01192126914 if mes==11 & aux_reg==1
replace lp_ci = 2482.45179958658 if mes==12 & aux_reg==1

replace lp_ci = 1403.77787991006 if mes==1 & aux_reg==2
replace lp_ci = 1415.83276303736 if mes==2 & aux_reg==2
replace lp_ci = 1421.74006253559 if mes==3 & aux_reg==2
replace lp_ci = 1424.95045577713 if mes==4 & aux_reg==2
replace lp_ci = 1434.07709844837 if mes==5 & aux_reg==2
replace lp_ci = 1432.72160360797 if mes==6 & aux_reg==2
replace lp_ci = 1446.84711341403 if mes==7 & aux_reg==2
replace lp_ci = 1445.11953726489 if mes==8 & aux_reg==2
replace lp_ci = 1446.91914641289 if mes==9 & aux_reg==2
replace lp_ci = 1454.71623901508 if mes==10 & aux_reg==2
replace lp_ci = 1457.30769327047 if mes==11 & aux_reg==2
replace lp_ci = 1463.08135926117 if mes==12 & aux_reg==2
...
*********
gen lpe_ci =.
replace lpe_ci = 647.33657526246  if mes==1 & aux_reg==1
replace lpe_ci = 639.354210785489 if mes==2 & aux_reg==1
replace lpe_ci = 642.197267618123 if mes==3 & aux_reg==1
replace lpe_ci = 664.172480381834 if mes==4 & aux_reg==1
replace lpe_ci = 665.12493596675  if mes==5 & aux_reg==1
replace lpe_ci = 651.656286112962 if mes==6 & aux_reg==1
replace lpe_ci = 658.790375464268 if mes==7 & aux_reg==1
replace lpe_ci = 651.288148063596 if mes==8 & aux_reg==1
replace lpe_ci = 658.341748046648 if mes==9 & aux_reg==1
replace lpe_ci = 651.704627835505 if mes==10 & aux_reg==1
replace lpe_ci = 650.041455648355 if mes==11 & aux_reg==1
replace lpe_ci = 649.648271723848 if mes==12 & aux_reg==1

replace lpe_ci = 608.863543461692 if mes==1 & aux_reg==2
replace lpe_ci = 600.750329638932 if mes==2 & aux_reg==2
replace lpe_ci = 603.491082018505 if mes==3 & aux_reg==2
replace lpe_ci = 625.312656295922 if mes==4 & aux_reg==2
replace lpe_ci = 626.045489597144 if mes==5 & aux_reg==2
replace lpe_ci = 612.444704478404 if mes==6 & aux_reg==2
replace lpe_ci = 619.456192903766 if mes==7 & aux_reg==2
replace lpe_ci = 611.948726854678 if mes==8 & aux_reg==2
replace lpe_ci = 619.116287686869 if mes==9 & aux_reg==2
replace lpe_ci = 612.630314812195 if mes==10 & aux_reg==2
replace lpe_ci = 610.954835810132 if mes==11 & aux_reg==2
replace lpe_ci = 610.461073272002 if mes==12 & aux_reg==2
...
*************
gen salmm_ci= 1092
label var	salmm_ci	"Salario minimo legal 2001"
************
***emp_ci***
************
...
replace ocupa_ci=9 if (f5_2>=13 & f5_2<=43) & emp_ci==1

****************
*** rama_ci  ***
****************
gen rama_ci=.
replace rama_ci=1 if (f6_2>0 & f6_2<=5) & emp_ci==1
...
***Generar las dos variables para 2001***
...
replace ylmpri_ci=ylmpri_ci2 if (f7==3|f7==4|f7==5|f39==6) & emp_ci==1 
drop ylmpri_ci2
...
/*
gen aedu_ci=.
replace aedu_ci=0 if (e11_1>0 & e11_2==0 & e11_3==0 & e11_4==0 & e11_5==0 & e11_6==0)
replace aedu_ci=e11_2 if (e11_2>0 & e11_3==0 & e11_4==0 & e11_5==0 & e11_6==0)
replace aedu_ci=6+e11_2 if (e11_3>0 & e11_4==0 & e11_5==0 & e11_6==0)
replace aedu_ci=12+e11_5 if (e11_5>0 & e11_6==0)
replace aedu_ci=12+e11_6 if (e11_6>0)
replace aedu_ci=12+e11_5+e11_6 if (e11_5>0 & e11_6>0)
replace aedu_ci=6+e11_3+e11_4 if (e11_3>=0 & e11_4>0 & e11_5==0 & e11_6==0)
replace aedu_ci=12+e11_4+e11_5+e11_6 if (e11_3>=6 & e11_4>=0 & e11_5>=0 & e11_6>=0)
*/
...
* Line of code with indicator repite_ci was deletedgen edupub_ci=(e14==1)
