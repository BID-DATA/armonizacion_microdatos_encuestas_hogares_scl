...
Última versión: Alvaro Altamirano E-mail: alvaroal@iadb.org - Mayo 15 de 2019
...
gen lp_ci =.
replace lp_ci =  9303 if mes==1 & region_3==1
replace lp_ci =  9679 if mes==2 & region_3==1
replace lp_ci =  9764 if mes==3 & region_3==1
replace lp_ci =  9785 if mes==4 & region_3==1
replace lp_ci =  9805 if mes==5 & region_3==1
replace lp_ci =  9870 if mes==6 & region_3==1
replace lp_ci =  9927 if mes==7 & region_3==1
replace lp_ci =  9974 if mes==8 & region_3==1
replace lp_ci =  10014 if mes==9 & region_3==1
replace lp_ci =  10089 if mes==10 & region_3==1
replace lp_ci =  10136 if mes==11 & region_3==1
replace lp_ci =  10242 if mes==12 & region_3==1


replace lp_ci =   5195 if mes==1 & region_3==2
replace lp_ci =   5461 if mes==2 & region_3==2
replace lp_ci =   5513 if mes==3 & region_3==2
replace lp_ci =   5528 if mes==4 & region_3==2
replace lp_ci =   5537 if mes==5 & region_3==2
replace lp_ci =   5563 if mes==6 & region_3==2
replace lp_ci =   5582 if mes==7 & region_3==2
replace lp_ci =   5603 if mes==8 & region_3==2
replace lp_ci =   5621 if mes==9 & region_3==2
replace lp_ci =   5652 if mes==10 & region_3==2
replace lp_ci =   5673 if mes==11 & region_3==2
replace lp_ci =   5734 if mes==12 & region_3==2


replace lp_ci =   2863 if mes==1 & region_3==3
replace lp_ci =   2961 if mes==2 & region_3==3
replace lp_ci =   2984 if mes==3 & region_3==3
replace lp_ci =   2994 if mes==4 & region_3==3
replace lp_ci =   3000 if mes==5 & region_3==3
replace lp_ci =   3018 if mes==6 & region_3==3
replace lp_ci =   3033 if mes==7 & region_3==3
replace lp_ci =   3049 if mes==8 & region_3==3
replace lp_ci =   3060 if mes==9 & region_3==3
replace lp_ci =   3082 if mes==10 & region_3==3
replace lp_ci =   3096 if mes==11 & region_3==3
replace lp_ci =   3133 if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci =   3160 if mes==1 & region_3==1
replace lpe_ci =   3200 if mes==2 & region_3==1
replace lpe_ci =   3225 if mes==3 & region_3==1
replace lpe_ci =   3224 if mes==4 & region_3==1
replace lpe_ci =   3214 if mes==5 & region_3==1
replace lpe_ci =   3264 if mes==6 & region_3==1
replace lpe_ci =   3334 if mes==7 & region_3==1
replace lpe_ci =   3375 if mes==8 & region_3==1
replace lpe_ci =   3414 if mes==9 & region_3==1
replace lpe_ci =   3403 if mes==10 & region_3==1
replace lpe_ci =   3390 if mes==11 & region_3==1
replace lpe_ci =   3377 if mes==12 & region_3==1

replace lpe_ci =   2921 if mes==1 & region_3==2
replace lpe_ci =   2972 if mes==2 & region_3==2
replace lpe_ci =   2997 if mes==3 & region_3==2
replace lpe_ci =   3002 if mes==4 & region_3==2
replace lpe_ci =   2987 if mes==5 & region_3==2
replace lpe_ci =   3009 if mes==6 & region_3==2
replace lpe_ci =   3081 if mes==7 & region_3==2
replace lpe_ci =   3096 if mes==8 & region_3==2
replace lpe_ci =   3129 if mes==9 & region_3==2
replace lpe_ci =   3136 if mes==10 & region_3==2
replace lpe_ci =   3125 if mes==11 & region_3==2
replace lpe_ci =   3091 if mes==12 & region_3==2

replace lpe_ci =  2642 if mes==1 & region_3==3
replace lpe_ci =  2689 if mes==2 & region_3==3
replace lpe_ci =  2714 if mes==3 & region_3==3
replace lpe_ci =  2717 if mes==4 & region_3==3
replace lpe_ci =  2702 if mes==5 & region_3==3
replace lpe_ci =  2720 if mes==6 & region_3==3
replace lpe_ci =  2787 if mes==7 & region_3==3
replace lpe_ci =  2801 if mes==8 & region_3==3
replace lpe_ci =  2832 if mes==9 & region_3==3
replace lpe_ci =  2837 if mes==10 & region_3==3
replace lpe_ci =  2825 if mes==11 & region_3==3
replace lpe_ci =  2793 if mes==12 & region_3==3
