...
****************************
	...
	***********
	...
	replace desalent_ci = 0 if f108 != 4 & condocup_ci == 3 & f108 != .
...
****************************
	...
	**********
	...
	replace pension_ci = 0 if (g_it_1 == 2 | g_it_2 == 2) & pension_ci == .

	***************
	*** pensionsub_ci ***
	***************
	gen byte pensionsub_ci = ((f125 == 1) | (f125 == 3 & edad_ci > 69))
	replace pensionsub_ci = . if pension_ci == .
...
****************************
	...
	*** ynlm_ci ***
	*********
	egen double ynlm_ci = rowtotal(g148_3 g148_4 g148_5_1 g148_5_2 g257 g153_1 g153_2 g154_1 g258_1), missing
	...
	*** remesas_ch ***
	******************
	gen double remesas_ch = h172_1

	**********
	*** ypen_ci ***
	**********
	egen double ypen_ci = rowtotal(g148_1_1 g148_1_2 g148_1_3 g148_1_5 g148_1_6 g148_1_7 g148_1_8 g148_1_9 g148_1_10 g148_1_11 g148_1_12 ///
	                               g148_2_1 g148_2_2 g148_2_3 g148_2_5 g148_2_6 g148_2_7 g148_2_8 g148_2_9 g148_2_10 g148_2_11 g148_2_12) if pension_ci == 1, missing

	******************
	*** ypensub_ci ***
	******************
	gen double ypensub_ci = . if pensionsub_ci == 1
