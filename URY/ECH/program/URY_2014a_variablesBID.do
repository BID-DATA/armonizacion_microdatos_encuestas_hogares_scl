...
gen lp_ci =.
replace lp_ci = 6836  if mes==1 & region_3==1
replace lp_ci = 7151  if mes==2 & region_3==1
replace lp_ci = 7224  if mes==3 & region_3==1
replace lp_ci = 7228  if mes==4 & region_3==1
replace lp_ci = 7217  if mes==5 & region_3==1
replace lp_ci = 7265  if mes==6 & region_3==1
replace lp_ci = 7300  if mes==7 & region_3==1
replace lp_ci = 7328  if mes==8 & region_3==1
replace lp_ci = 7379  if mes==9 & region_3==1
replace lp_ci = 7430  if mes==10 & region_3==1
replace lp_ci = 7469  if mes==11 & region_3==1
replace lp_ci = 7499  if mes==12 & region_3==1

replace lp_ci = 3902  if mes==1 & region_3==2
replace lp_ci = 4158  if mes==2 & region_3==2
replace lp_ci = 4197  if mes==3 & region_3==2
replace lp_ci = 4192  if mes==4 & region_3==2
replace lp_ci = 4181  if mes==5 & region_3==2
replace lp_ci = 4197  if mes==6 & region_3==2
replace lp_ci = 4208  if mes==7 & region_3==2
replace lp_ci = 4208  if mes==8 & region_3==2
replace lp_ci = 4230  if mes==9 & region_3==2
replace lp_ci = 4254  if mes==10 & region_3==2
replace lp_ci = 4277  if mes==11 & region_3==2
replace lp_ci = 4295  if mes==12 & region_3==2

replace lp_ci = 2169  if mes==1 & region_3==3
replace lp_ci = 2259  if mes==2 & region_3==3
replace lp_ci = 2284  if mes==3 & region_3==3
replace lp_ci = 2288  if mes==4 & region_3==3
replace lp_ci = 2280  if mes==5 & region_3==3
replace lp_ci = 2290  if mes==6 & region_3==3
replace lp_ci = 2295  if mes==7 & region_3==3
replace lp_ci = 2305  if mes==8 & region_3==3
replace lp_ci = 2318  if mes==9 & region_3==3
replace lp_ci = 2334  if mes==10 & region_3==3
replace lp_ci = 2347  if mes==11 & region_3==3
replace lp_ci = 2356  if mes==12 & region_3==3
...
*********
gen lpe_ci =.
replace lpe_ci = 2301  if mes==1 & region_3==1
replace lpe_ci = 2330  if mes==2 & region_3==1
replace lpe_ci = 2385  if mes==3 & region_3==1
replace lpe_ci = 2421  if mes==4 & region_3==1
replace lpe_ci = 2419  if mes==5 & region_3==1
replace lpe_ci = 2417  if mes==6 & region_3==1
replace lpe_ci = 2425  if mes==7 & region_3==1
replace lpe_ci = 2458  if mes==8 & region_3==1
replace lpe_ci = 2475  if mes==9 & region_3==1
replace lpe_ci = 2519  if mes==10 & region_3==1
replace lpe_ci = 2542  if mes==11 & region_3==1
replace lpe_ci = 2531  if mes==12 & region_3==1

replace lpe_ci = 2127  if mes==1 & region_3==2
replace lpe_ci = 2157  if mes==2 & region_3==2
replace lpe_ci = 2229  if mes==3 & region_3==2
replace lpe_ci = 2264  if mes==4 & region_3==2
replace lpe_ci = 2268  if mes==5 & region_3==2
replace lpe_ci = 2259  if mes==6 & region_3==2
replace lpe_ci = 2255  if mes==7 & region_3==2
replace lpe_ci = 2287  if mes==8 & region_3==2
replace lpe_ci = 2316  if mes==9 & region_3==2
replace lpe_ci = 2357  if mes==10 & region_3==2
replace lpe_ci = 2365  if mes==11 & region_3==2
replace lpe_ci = 2357  if mes==12 & region_3==2

replace lpe_ci = 1920  if mes==1 & region_3==3
replace lpe_ci = 1948  if mes==2 & region_3==3
replace lpe_ci = 2020  if mes==3 & region_3==3
replace lpe_ci = 2053  if mes==4 & region_3==3
replace lpe_ci = 2055  if mes==5 & region_3==3
replace lpe_ci = 2045  if mes==6 & region_3==3
replace lpe_ci = 2041  if mes==7 & region_3==3
replace lpe_ci = 2070  if mes==8 & region_3==3
replace lpe_ci = 2098  if mes==9 & region_3==3
replace lpe_ci = 2134  if mes==10 & region_3==3
replace lpe_ci = 2139  if mes==11 & region_3==3
replace lpe_ci = 2131  if mes==12 & region_3==3
...
**salmm_ci***
*************
*http://www.presidencia.gub.uy/comunicacion/comunicacionnoticias/monto-salario-minimo-nacional.2014
gen salmm_ci=8960
...
egen inghog1 = rsum(h155_1 h157_1 h160_1m h160_2m h163_1m h163_2m h164m h165m h166m h167_1_1m h167_1_2m h170_1m h170_2m h171_1m h172_1m h173_1m), missing
