...
*************
gen salmm_ci = .
replace salmm_ci = 670   if mes_c==1 | mes_c==2  | mes_c==3  
replace salmm_ci = 690   if mes_c==4
replace salmm_ci = 720   if mes_c==5 | mes_c==6  | mes_c==7  | mes_c==8
replace salmm_ci = 760   if mes_c==9 | mes_c==10 | mes_c==11 | mes_c==12
label var	salmm_ci	"Salario minimo legal 1996"
