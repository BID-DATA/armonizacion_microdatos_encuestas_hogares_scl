...
**** Nuclear: conformado por el jefe(a) y cónyuge; jefe(a) e hijos(as); jefe(a), cónyuge e hijos(as).
replace clasehog_ch=2 if (nhijos_ch>0| nconyuges_ch>0) & (notropari_ch==0 & notronopari_ch==0)
**** Ampliado: conformado por un hogar nuclear y al menos otro pariente, o por un jefe(a) y al menos otro pariente.
replace clasehog_ch=3 if ((clasehog_ch ==2 & notropari_ch>0) & notronopari_ch==0) |(notropari_ch>0 & notronopari_ch==0)  
**** Compuesto: conformado por un hogar nuclear o ampliado y al menos un integrante sin parentesco.
replace clasehog_ch= 4 if ((nconyuges_ch>0 | nhijos_ch>0 | notropari_ch>0) & (notronopari_ch>0))
**** Corresidente: Hogar formado por dos o más integrantes sin parentesco con el jefe(a) del hogar.
...
gen lp_ci =.
replace lp_ci = 2504.82483172433 if mes==1 & aux_reg==1
replace lp_ci = 2535.43110524073 if mes==2 & aux_reg==1
replace lp_ci = 2557.95449237402 if mes==3 & aux_reg==1
replace lp_ci = 2582.16787311953 if mes==4 & aux_reg==1
replace lp_ci = 2612.24028967878 if mes==5 & aux_reg==1
replace lp_ci = 2653.21485710031 if mes==6 & aux_reg==1
replace lp_ci = 2758.24575410471 if mes==7 & aux_reg==1
replace lp_ci = 2910.44980076966 if mes==8 & aux_reg==1
replace lp_ci = 2990.90174492656 if mes==9 & aux_reg==1
replace lp_ci = 2998.70167053365 if mes==10 & aux_reg==1
replace lp_ci = 3027.41947650815 if mes==11 & aux_reg==1
replace lp_ci = 3073.30561477922 if mes==12 & aux_reg==1

replace lp_ci = 1476.14424599035 if mes==1 & aux_reg==2
replace lp_ci = 1493.47771585075 if mes==2 & aux_reg==2
replace lp_ci = 1506.00081057889 if mes==3 & aux_reg==2
replace lp_ci = 1521.62698496709 if mes==4 & aux_reg==2
replace lp_ci = 1539.53664271502 if mes==5 & aux_reg==2
replace lp_ci = 1562.90669847991 if mes==6 & aux_reg==2
replace lp_ci = 1626.6290226432  if mes==7 & aux_reg==2
replace lp_ci = 1717.56791379901 if mes==8 & aux_reg==2
replace lp_ci = 1766.52163836884 if mes==9 & aux_reg==2
replace lp_ci = 1772.59450186681 if mes==10 & aux_reg==2
replace lp_ci = 1791.68077694232 if mes==11 & aux_reg==2
replace lp_ci = 1814.72490006828 if mes==12 & aux_reg==2
...
*********
gen lpe_ci =.
replace lpe_ci = 654.258962966195 if mes==1 & aux_reg==1
replace lpe_ci = 649.584404615721 if mes==2 & aux_reg==1
replace lpe_ci = 655.124620938135 if mes==3 & aux_reg==1
replace lpe_ci = 681.188515217047 if mes==4 & aux_reg==1
replace lpe_ci = 691.440585727818 if mes==5 & aux_reg==1
replace lpe_ci = 709.237770065037 if mes==6 & aux_reg==1
replace lpe_ci = 755.052071411157 if mes==7 & aux_reg==1
replace lpe_ci = 805.885657741013 if mes==8 & aux_reg==1
replace lpe_ci = 835.906043806967 if mes==9 & aux_reg==1
replace lpe_ci = 861.217085816193 if mes==10 & aux_reg==1
replace lpe_ci = 855.926804164326 if mes==11 & aux_reg==1
replace lpe_ci = 851.617309265338 if mes==12 & aux_reg==1

replace lpe_ci = 614.575018329896 if mes==1 & aux_reg==2
replace lpe_ci = 609.275449699785 if mes==2 & aux_reg==2
replace lpe_ci = 614.526566003954 if mes==3 & aux_reg==2
replace lpe_ci = 640.129066638187 if mes==4 & aux_reg==2
replace lpe_ci = 649.796991618475 if mes==5 & aux_reg==2
replace lpe_ci = 666.558615449087 if mes==6 & aux_reg==2
replace lpe_ci = 709.306631184258 if mes==7 & aux_reg==2
replace lpe_ci = 756.041353396931 if mes==8 & aux_reg==2
replace lpe_ci = 784.432479612424 if mes==9 & aux_reg==2
replace lpe_ci = 807.860089244143 if mes==10 & aux_reg==2
replace lpe_ci = 801.945896612956 if mes==11 & aux_reg==2
replace lpe_ci = 797.137150796579 if mes==12 & aux_reg==2
...
* Line of code with indicator repiteult was deletedgen edupub_ci=(e14==1)
