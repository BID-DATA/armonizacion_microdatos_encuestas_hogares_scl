...
replace afiliado_ci = 0 if ((msp==. & iamc==. & spm==. & hpm==. & bps==.) & inlist(condocup_ci, 1, 2))
label var afiliado_ci "Afiliado a la Seguridad Social"
label define afiliado_ci 0 "No"  1 "Si"
label value afiliado_ci afiliado_ci

drop msp iamc spm hpm bps
*Nota: seguridad social comprende solo los que en el futuro me ofrecen una pension. */"Cotizante a la Seguridad Social"
...
replace rama_ci=3 if (pf40>=15 & pf40<=37) & emp_ci==1
replace rama_ci=4 if (pf40>=40 & pf40<=42) & emp_ci==1
replace rama_ci=5 if pf40==45 & emp_ci==1
replace rama_ci=6 if (pf40>=50 & pf40<=58) & emp_ci==1
...
******************************
* Line of code with indicator repiteult was deleted* Line of code with indicator repiteult was deletedlabel var  aedu_ci "Anios de Educacion"
