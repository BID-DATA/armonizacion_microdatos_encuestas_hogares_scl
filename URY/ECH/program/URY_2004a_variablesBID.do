...
gen lp_ci =.
replace lp_ci = 3469.62146575479 if mes==1 & aux_reg==1
replace lp_ci = 3488.25241907838 if mes==2 & aux_reg==1
replace lp_ci = 3513.83848984112 if mes==3 & aux_reg==1
replace lp_ci = 3536.75540843126 if mes==4 & aux_reg==1
replace lp_ci = 3549.54081698214 if mes==5 & aux_reg==1
replace lp_ci = 3569.69292513549 if mes==6 & aux_reg==1
replace lp_ci = 3604.60638375277 if mes==7 & aux_reg==1
replace lp_ci = 3632.74456136712 if mes==8 & aux_reg==1
replace lp_ci = 3635.4542203732  if mes==9 & aux_reg==1
replace lp_ci = 3630.78470222062 if mes==10 & aux_reg==1
replace lp_ci = 3633.9788139175  if mes==11 & aux_reg==1
replace lp_ci = 3643.86133725675 if mes==12 & aux_reg==1

replace lp_ci = 2049.84168205288 if mes==1 & aux_reg==2
replace lp_ci = 2059.24232902981 if mes==2 & aux_reg==2
replace lp_ci = 2074.0785522684  if mes==3 & aux_reg==2
replace lp_ci = 2088.84700536029 if mes==4 & aux_reg==2
replace lp_ci = 2096.90091513928 if mes==5 & aux_reg==2
replace lp_ci = 2109.39460573359 if mes==6 & aux_reg==2
replace lp_ci = 2129.82532213134 if mes==7 & aux_reg==2
replace lp_ci = 2143.174693286   if mes==8 & aux_reg==2
replace lp_ci = 2145.23628712949 if mes==9 & aux_reg==2
replace lp_ci = 2143.39623363142 if mes==10 & aux_reg==2
replace lp_ci = 2145.868071928   if mes==11 & aux_reg==2
replace lp_ci = 2152.07036324438 if mes==12 & aux_reg==2
...
gen lpe_ci =.
replace lpe_ci = 971.15643845393 if mes==1 & aux_reg==1
replace lpe_ci = 959.042872640831 if mes==2 & aux_reg==1
replace lpe_ci = 964.405901772366 if mes==3 & aux_reg==1
replace lpe_ci = 992.080058436657 if mes==4 & aux_reg==1
replace lpe_ci = 1025.18995580648 if mes==5 & aux_reg==1
replace lpe_ci = 1028.72618793766 if mes==6 & aux_reg==1
replace lpe_ci = 1047.73103258481 if mes==7 & aux_reg==1
replace lpe_ci = 1056.12191741468 if mes==8 & aux_reg==1
replace lpe_ci = 1063.82470353157 if mes==9 & aux_reg==1
replace lpe_ci = 1053.28682726985 if mes==10 & aux_reg==1
replace lpe_ci = 1038.04643829205 if mes==11 & aux_reg==1
replace lpe_ci = 1032.45046464423 if mes==12 & aux_reg==1

replace lpe_ci = 911.621919470939 if mes==1 & aux_reg==2
replace lpe_ci = 899.128765619123 if mes==2 & aux_reg==2
replace lpe_ci = 903.988680692107 if mes==3 & aux_reg==2
replace lpe_ci = 931.438245479623 if mes==4 & aux_reg==2
replace lpe_ci = 963.774063191657 if mes==5 & aux_reg==2
replace lpe_ci = 966.754519333351 if mes==6 & aux_reg==2
replace lpe_ci = 984.938971481957 if mes==7 & aux_reg==2
replace lpe_ci = 993.148107584524 if mes==8 & aux_reg==2
replace lpe_ci = 1000.60015550907 if mes==9 & aux_reg==2
replace lpe_ci = 990.158267480006 if mes==10 & aux_reg==2
replace lpe_ci = 975.37962875146  if mes==11 & aux_reg==2
replace lpe_ci = 969.873982366378 if mes==12 & aux_reg==2
...
*************
gen salmm_ci = .
replace salmm_ci = 1242   if mes_c==1 | mes_c==2  | mes_c==3  | mes_c==4 | mes_c==5 | mes_c==6 
replace salmm_ci = 1310   if mes_c==7 | mes_c==8  | mes_c==9 | mes_c==10 | mes_c==11 | mes_c==12
label var salmm_ci	"Salario minimo legal 2004"
************
***emp_ci***
************
