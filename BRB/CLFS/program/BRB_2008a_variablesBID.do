...
sum wtfactor
scalar pob=r(sum)
gen pop=wtfactor*(279946/pob) // población BRB 2008
sum pop
ret list
gen factor_ch=pop 
drop pop
...
******************************
recode rndno (30=1) (31=2) (32=3) (33=4)
...
********************************************
* NOs e pregunta a menores de edad.
...
label define desemp_ci 0"No " 1"Si
...
replace desalent_ci = 1 if (inlist(reasnsk, 2, 3) & condocup_ci == 3)
...
g rama_ci1=.
replace rama_ci1=1 if ((indus>=1 & indus<=3) | indus==21) & condocup_ci==1
replace rama_ci1=2 if (indus==11 | indus==51)  & condocup_ci==1
replace rama_ci1=3 if (indus==32 | indus==41)  & condocup_ci==1
replace rama_ci1=6 if ((indus>=61 & indus<=71) | indus==73)  & condocup_ci==1
replace rama_ci1=7 if (indus==72 | indus==75)  & condocup_ci==1
replace rama_ci1=8 if (indus>=81 & indus<=87)  & condocup_ci==1
replace rama_ci1=9 if (indus>=91 & indus<99)  & condocup_ci==1
...
*******************************
*******************************
/*NO es posible saber cuantos años de educación tienen los individuos 
pero si definir cual es el nivel mas alto alcanzado*/
...
**************
gen eduac_ci=.
replace eduac_ci=1 if educlev==3
...
g tcylmpri_ch=.
g instcot_ci=.
* Line of code with indicator edus1c_ci was deletedrename x1 x_1
rename x2 x_2
rename x3 x_3
