...
Encuesta: BSLC 2022
Round: 
Autores: Lina Arias linarias8@gmail.com
Modificación 2026: 
Última modificación:
...
*******************************
egen idp_ci = concat(RNDNO EDNO PARNO STRATUM HHNO LIDNO)
...
****************************
	...
	*******************
	gen civil_ci = .
	replace civil_ci = 1 if MARSTAT == 0                // Soltero (Never Married)
	replace civil_ci = 2 if inlist(MARSTAT, 1)       // Unión formal (Married) o informal (Common-law)
	replace civil_ci = 3 if inlist(MARSTAT, 3, 4)       // Divorciado o Separado
	replace civil_ci = 4 if MARSTAT == 2               // Viudo
...
*******************************************************
	...
	**************************
	...
	replace condocup_ci = 3 if inlist(actvstat, 31, 32 33, 34, 35)
	...
	**********************************************
	...
	replace horaspri_ci = 12   if condocup_ci == 1 & HRSWRKD == 4  & TWOJOBS==2 // 10-14
	replace horaspri_ci = 17   if condocup_ci == 1 & HRSWRKD == 5 & TWOJOBS==2  // 15-19
	replace horaspri_ci = 22   if condocup_ci == 1 & HRSWRKD == 6  & TWOJOBS==2 // 20-24
	replace horaspri_ci = 27   if condocup_ci == 1 & HRSWRKD == 7  & TWOJOBS==2 // 25-29
	replace horaspri_ci = 32   if condocup_ci == 1 & HRSWRKD == 8  & TWOJOBS==2 // 30-34
	replace horaspri_ci = 37   if condocup_ci == 1 & HRSWRKD == 9  & TWOJOBS==2 // 35-39
	replace horaspri_ci = 42   if condocup_ci == 1 & HRSWRKD == 10 & TWOJOBS==2 // 40-44
	replace horaspri_ci = 48   if condocup_ci == 1 & HRSWRKD == 11  & TWOJOBS==2 // 45+ (conservative)
	...
	**************************
	gen horastot_ci = .
	replace horastot_ci = 0    if condocup_ci == 1 & HRSWRKD == 1   // None
	replace horastot_ci = 2.5  if condocup_ci == 1 & HRSWRKD == 2   // Under 5
	replace horastot_ci = 7    if condocup_ci == 1 & HRSWRKD == 3   // 5-9
	replace horastot_ci = 12   if condocup_ci == 1 & HRSWRKD == 4   // 10-14
	replace horastot_ci = 17   if condocup_ci == 1 & HRSWRKD == 5   // 15-19
	replace horastot_ci = 22   if condocup_ci == 1 & HRSWRKD == 6   // 20-24
	replace horastot_ci = 27   if condocup_ci == 1 & HRSWRKD == 7   // 25-29
	replace horastot_ci = 32   if condocup_ci == 1 & HRSWRKD == 8   // 30-34
	replace horastot_ci = 37   if condocup_ci == 1 & HRSWRKD == 9   // 35-39
	replace horastot_ci = 42   if condocup_ci == 1 & HRSWRKD == 10  // 40-44
	replace horastot_ci = 48   if condocup_ci == 1 & HRSWRKD == 11  // 45+ (conservative)
...
****************************
	...
	* Weekly bracket midpoint, then monthlyize
	replace ylmsec_ci = 140    *(52/12) if condocup_ci == 1 & EARNGS2 == 1
	replace ylmsec_ci = 249.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 2
	replace ylmsec_ci = 349.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 3
	replace ylmsec_ci = 449.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 4
	replace ylmsec_ci = 549.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 5
	replace ylmsec_ci = 649.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 6
	replace ylmsec_ci = 749.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 7
	replace ylmsec_ci = 849.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 8
	replace ylmsec_ci = 949.5  *(52/12) if condocup_ci == 1 & EARNGS2 == 9
	replace ylmsec_ci = 1150   *(52/12) if condocup_ci == 1 & EARNGS2 == 10
	replace ylmsec_ci = 1625   *(52/12) if condocup_ci == 1 & EARNGS2 == 11

	* Missing for not stated
	replace ylmsec_ci = . if condocup_ci == 1 & EARNGS == 99

	* Non-remunerated workers
	replace ylmsec_ci = 0 if categopri_ci == 4

	* Non-employed PET
	replace ylmsec_ci = 0 if condocup_ci != 1 & condocup_ci != .
...
*/
	...
	* proxy
	gen byte eduuc_ci = .
	replace eduuc_ci =(inlist(EDUCLEV, 3, 4) & (QUALLEV==5 | QUALLEV==6 | QUALLEV==7 | QUALLEV==8))
