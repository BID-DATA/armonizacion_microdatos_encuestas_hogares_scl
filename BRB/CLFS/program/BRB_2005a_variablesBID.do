...
sum wtfactor
scalar pob=r(sum)
gen pop=wtfactor*(276320/pob) // población BRB 2005
sum pop
ret list
gen factor_ch=pop 
drop pop
...
******************************
recode rndno (18=1) (19=2) (20=3) (21=4)
...
tab dup // hay 51 obs duplicadas (0.54%)
drop if dup==2
drop dup
...
*********************************
gen rama_ci=.
replace rama_ci=1 if ((indus>=1 & indus<=3) | indus==21) & condocup_ci==1
replace rama_ci=2 if (indus==11 | indus==51)  & condocup_ci==1
replace rama_ci=3 if (indus==32 | indus==41)  & condocup_ci==1
replace rama_ci=6 if ((indus>=61 & indus<=71) | indus==73)  & condocup_ci==1
replace rama_ci=7 if (indus==72 | indus==74 | indus==75)  & condocup_ci==1
replace rama_ci=8 if (indus>=81 & indus<=87)  & condocup_ci==1
replace rama_ci=9 if (indus>=91 & indus<=98)  & condocup_ci==1
