...
/* beneficios para obreros, empleados y jornaleros provenientes en activ princ (a partir del 2004 es para act princ y secun)*/
...
replace cotizando_ci = 1 if (((presta1>=1 & presta1<=5) | (presta1==22)) & emp_ci==1)
