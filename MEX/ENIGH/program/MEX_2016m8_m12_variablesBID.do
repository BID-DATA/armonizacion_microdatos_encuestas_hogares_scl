...
replace afiliado_ci = 1 if ((pres_141==14 | pres_142==14) & emp_ci==1)  /* inscrito en prestaciones de salud por trabajo*/
...
replace afiliado_ci1=1 if (pres_141==14) | (inscr_1 == 1  & (servmed_3==3 | servmed_5==5 | servmed_6==6 | servmed_7==7))  /* inscripto en prestaciones de salud por trabajo*/
...
*********
gen lp_ci =.
replace lp_ci=2660.40 if zona_c==1
replace lp_ci=1715.57 if zona_c==0
...
*********
gen lpe_ci =.
replace lpe_ci= 1310.94 if zona_c==1
replace lpe_ci= 933.20 if zona_c==0
