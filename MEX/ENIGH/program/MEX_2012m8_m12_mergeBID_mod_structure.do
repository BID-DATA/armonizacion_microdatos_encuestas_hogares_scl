...
merge 1:1 folioviv foliohog numren using "$ruta\edu_gtosmp.dta", keep(match master)
...
egen double ict = rsum(ing_monh nomon)                 if parentesco=="101" | parentesco=="102"
egen double gct = rsum(gasmon nomon)                   if parentesco=="101" | parentesco=="102"
egen double gnt = rsum(gasmon nomon redan reg_espn)    if parentesco=="101" | parentesco=="102"
egen double intt = rsum(ing_monh nomon redan reg_espn) if parentesco=="101" | parentesco=="102"
