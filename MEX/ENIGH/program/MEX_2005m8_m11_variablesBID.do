...
gen zona_c=0 if (estrato>2 & estrato!=.)
replace zona_c=1 if estrato<=2
label define zona_c 0 "Rural" 1 "Urbano"
...
*lpe_ci***
*********
generat lpe_ci =790.74 if zona_c==1
replace lpe_ci =584.34  if zona_c==0
label var lpe_ci "linea de pobreza alimentaria"

*********
*lp2_ci***
*********
generat lp2_ci =969.84 if zona_c==1
replace lp2_ci =690.87  if zona_c==0
label var lp2_ci "linea de pobreza de capacidades"

*********
*lp_ci***
*********
generat lp_ci =1586.54 if zona_c==1
replace lp_ci =1060.34 if zona_c==0
label var lp_ci "linea de pobreza de patrimonio"

*************
**salmm_ci***
*************
/*La encuesta fue levantada entre los meses de agosto y noviembre 2005,
...
abril-septiembre, y mayo-octubre 2005;
*/
...
generat salmm_ci=46.80*30 if zona_salmm==1
replace salmm_ci=45.35*30 if zona_salmm==2
replace salmm_ci=44.05*30 if zona_salmm==3
...
gen contrato_ci=.
replace contrato_ci=1 if contr171=="1" | contr171=="2"
replace contrato_ci=0 if contr171=="3"
*/
...
gen nempleos_ci=.
replace nempleos_ci=1 if emp_ci==1 &  otro_tra19=="4"
replace nempleos_ci=2 if emp_ci==1 &  (otro_tra19>="1" & otro_tra19<="324")
...
replace aguared_ch=0 if agua15 >=3
...
replace aguafuente_ch = 10 if (agua15==6 | agua15==8 | agua15==4)|(agua15 ==. & jefe_ci ==1)
...
replace aguadist_ch= 3 if agua15 ==3
...
destring agua16, replace
gen aguadisp2_ch = .
replace aguadisp2_ch = 1 if (agua16==1 | agua16==2 | agua16==3)
replace aguadisp2_ch = 2 if (agua16==4 | agua16==5 | agua16==6)  
replace aguadisp2_ch = 3 if (agua16==7 | agua16==8)
...
replace bano_ch=6 if drenaje21==5 & bano17==1|(bano17 ==. & jefe_ci ==1)| missing(bano17)
...
gen banoex_ch=.
replace banoex_ch=1 if bano18==2
replace banoex_ch=0 if bano18==1
...
gen luz_ch=.
replace luz_ch=0 if luz22=="4"
replace luz_ch=1 if luz22>="1" & luz22<="3" 
...
replace des1_ch=3 if drenaje21==3| drenaje21==4
...
* MGR Aug, 2015: corrección sintaxis
/*
gen pared_ch=.
...
gen pared_ch=.
replace pared_ch=0 if muros01=="01" | muros01=="02"  | muros01=="04"  | muros01=="05"
replace pared_ch=1 if muros01=="03" | (muros01>="06" & muros01<="11")
...
*/
gen techo_ch=.
replace techo_ch=0 if techos02=="01" | techos02=="02" | techos02=="04" 
replace techo_ch=1 if techos02=="03" | (techos02>="05" & techos02<="09")
...
rename cmo121  codocupa
rename scian151 codindustria
